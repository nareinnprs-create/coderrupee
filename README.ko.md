...
mise use -g coderrupee               # 어떤 OS든
nix run nixpkgs#coderrupee           # 또는 github:coderrupee/coderrupee 로 최신 dev 브랜치
```
...
CoderRupee 는 데스크톱 앱으로도 제공됩니다. [releases page](https://github.com/coderrupee/coderrupee/releases) 에서 직접 다운로드하거나 [coderrupee.ai/download](https://coderrupee.ai/download) 를 이용하세요.
...
CoderRupee 에는 내장 에이전트 2개가 있으며 `Tab` 키로 전환할 수 있습니다.
...
[agents](https://coderrupee.ai/docs/agents) 에 대해 더 알아보세요.

### 문서

CoderRupee 설정에 대한 자세한 내용은 [**문서**](https://coderrupee.ai/docs) 를 참고하세요.

### 기여하기

CoderRupee 에 기여하고 싶다면, Pull Request 를 제출하기 전에 [contributing docs](./CONTRIBUTING.md) 를 읽어주세요.

### CoderRupee 기반으로 만들기

CoderRupee 와 관련된 프로젝트를 진행하면서 이름에 "coderrupee"(예: "coderrupee-dashboard" 또는 "coderrupee-mobile") 를 포함한다면, README 에 해당 프로젝트가 CoderRupee 팀이 만든 것이 아니며 어떤 방식으로도 우리와 제휴되어 있지 않다는 점을 명시해 주세요.

---

**커뮤니티에 참여하기** [Discord](https://discord.gg/coderrupee) | [X.com](https://x.com/coderrupee)
