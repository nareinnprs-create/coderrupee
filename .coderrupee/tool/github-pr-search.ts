...
This tool searches PRs in the nareinnprs-create/coderrupee repository and returns LLM-friendly results including:
- PR number and title
- Author
...
Use the query parameter to search for keywords that might appear in PR titles or descriptions.`,
  ...
  async execute(args) {
    const owner = "nareinnprs-create"
    const repo = "coderrupee"
