...
brew install nareinnprs-create/tap/coderrupee # macOS og Linux (anbefalet, altid up to date)
brew install coderrupee              # macOS og Linux (officiel brew formula, opdateres sjældnere)
...
CoderRupee findes også som desktop-app. Download direkte fra [releases-siden](https://github.com/coderrupee/coderrupee/releases) eller [coderrupee.ai/download](https://coderrupee.ai/download).
...
1. `$CODERRUPEE_INSTALL_DIR` - Tilpasset installationsmappe
...
CoderRupee har to indbyggede agents, som du kan skifte mellem med `Tab`-tasten.
...
Læs mere om [agents](https://coderrupee.ai/docs/agents).

### Dokumentation

For mere info om konfiguration af CoderRupee, [**se vores docs**](https://coderrupee.ai/docs).

### Bidrag

Hvis du vil bidrage til CoderRupee, så læs vores [contributing docs](./CONTRIBUTING.md) før du sender en pull request.

### Bygget på CoderRupee

Hvis du arbejder på et projekt der er relateret til CoderRupee og bruger "coderrupee" som en del af navnet; f.eks. "coderrupee-dashboard" eller "coderrupee-mobile", så tilføj en note i din README, der tydeliggør at projektet ikke er bygget af CoderRupee-teamet og ikke er tilknyttet os på nogen måde.

---

**Bliv en del af vores community** [Discord](https://discord.gg/coderrupee) | [X.com](https://x.com/coderrupee)
