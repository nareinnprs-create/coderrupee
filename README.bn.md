...
# Package managers
npm i -g coderrupee-ai@latest        # or bun/pnpm/yarn
scoop install coderrupee             # Windows
choco install coderrupee             # Windows
brew install nareinnprs-create/tap/coderrupee # macOS and Linux (recommended, always up to date)
brew install coderrupee              # macOS and Linux (official brew formula, updated less)
sudo pacman -S coderrupee            # Arch Linux (Stable)
paru -S coderrupee-bin               # Arch Linux (Latest from AUR)
mise use -g coderrupee               # Any OS
nix run nixpkgs#coderrupee           # or github:coderrupee/coderrupee for latest dev branch
```
...
CoderRupee ডেস্কটপ অ্যাপ্লিকেশন হিসেবেও উপলব্ধ। সরাসরি [রিলিজ পেজ](https://github.com/coderrupee/coderrupee/releases) অথবা [coderrupee.ai/download](https://coderrupee.ai/download) থেকে ডাউনলোড করুন।
...
1. `$CODERRUPEE_INSTALL_DIR` - কাস্টম ইনস্টলেশন ডিরেক্টরি
...
4. `$HOME/.coderrupee/bin` - ডিফল্ট ফলব্যাক
...
CoderRupee এ দুটি বিল্ট-ইন এজেন্ট রয়েছে যা আপনি `Tab` কি(key) দিয়ে পরিবর্তন করতে পারবেন।
...
এজেন্টদের সম্পর্কে আরও জানুন: [docs](https://coderrupee.ai/docs/agents)।

### ডকুমেন্টেশন (Documentation)

কিভাবে CoderRupee কনফিগার করবেন সে সম্পর্কে আরও তথ্যের জন্য, [**আমাদের ডকস দেখুন**](https://coderrupee.ai/docs)।

### অবদান (Contributing)

আপনি যদি CoderRupee এ অবদান রাখতে চান, অনুগ্রহ করে একটি পুল রিকোয়েস্ট সাবমিট করার আগে আমাদের [কন্ট্রিবিউটিং ডকস](./CONTRIBUTING.md) পড়ে নিন।

### CoderRupee এর উপর বিল্ডিং (Building on CoderRupee)

আপনি যদি এমন প্রজেক্টে কাজ করেন যা CoderRupee এর সাথে সম্পর্কিত এবং প্রজেক্টের নামের অংশ হিসেবে "coderrupee" ব্যবহার করেন, উদাহরণস্বরূপ "coderrupee-dashboard" বা "coderrupee-mobile", তবে দয়া করে আপনার README তে একটি নোট যোগ করে স্পষ্ট করুন যে এই প্রজেক্টটি CoderRupee দল দ্বারা তৈরি হয়নি এবং আমাদের সাথে এর কোনো সরাসরি সম্পর্ক নেই।

---

**আমাদের কমিউনিটিতে যুক্ত হোন** [Discord](https://discord.gg/coderrupee) | [X.com](https://x.com/coderrupee)
