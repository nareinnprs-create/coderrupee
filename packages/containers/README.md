...
```
REGISTRY=ghcr.io/nareinnprs-create TAG=24.04 bun ./packages/containers/script/build.ts
REGISTRY=ghcr.io/nareinnprs-create TAG=24.04 bun ./packages/containers/script/build.ts --push
```
...
jobs:
  build-cli:
    ...
    container:
      image: ghcr.io/nareinnprs-create/build/bun-node:24.04
```
