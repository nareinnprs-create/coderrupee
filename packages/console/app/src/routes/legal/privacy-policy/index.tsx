...
export default function PrivacyPolicy() {
  ...
  return (
    <main data-page="legal">
      <Title>CoderRupee | Privacy Policy</Title>
      <LocaleLinks path="/legal/privacy-policy" />
      <Meta name="description" content="CoderRupee privacy policy" />
        ...
        <div data-component="content">
          <section data-component="brand-content">
            <article data-component="privacy-policy">
              ...
              <p>
                At CoderRupee, we take your privacy seriously. Please read this Privacy Policy to learn how we treat your
                personal data.{" "}
                <strong>
              ...
              <p>
                Remember that your use of CoderRupee is at all times subject to our Terms of Use,{" "}
                <a href={language.route("/legal/terms-of-service")}>https://coderrupee.ai/legal/terms-of-service</a>,
              ...
              <p>
                ...
                time. We will alert you of material changes by placing a notice on the CoderRupee website, by sending you
              ...
              <ul>
                <li>
                  ...
                  sending you information about CoderRupee.
                </li>
              ...
              <p>
                ...
                you, CoderRupee or another party; enforcing any agreements with you; responding to claims that any posting
