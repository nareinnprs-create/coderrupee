      ...
      <div data-component="container">
        ...
        <div data-component="content">
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button
                ...
                onClick={handleCopyClick("curl -fsSL https://coderrupee.ai/install | bash")}
              >
                <code>
                  curl -fsSL https://<strong>coderrupee.ai/install</strong> | bash
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("npm i -g coderrupee-ai")}>
                <code>
                  npm i -g <strong>coderrupee-ai</strong>
                </code>
                <CopyStatus />
              </button>
              <button data-component="cli-row" onClick={handleCopyClick("bun add -g coderrupee-ai")}>
                <code>
                  bun add -g <strong>coderrupee-ai</strong>
                </code>
                <CopyStatus />
              </button>
              ...
              <button data-component="cli-row" onClick={handleCopyClick("paru -S coderrupee")}>
                <code>
                  paru -S <strong>coderrupee</strong>
                </code>
                <CopyStatus />
              </button>
            </div>
          ...
          <section data-component="download-section">
            ...
            <div data-component="section-content">
              <button data-component="cli-row" onClick={handleCopyClick("brew install --cask coderrupee-desktop")}>
                <code>
                  brew install --cask <strong>coderrupee-desktop</strong>
                </code>
                <CopyStatus />
              </button>
