...
import compareVideo from "../../asset/lander/coderrupee-comparison-min.mp4"
import compareVideoPoster from "../../asset/lander/coderrupee-comparison-poster.png"
...
export default function Home() {
  ...
  return (
    <main data-page="zen">
      ...
      <Meta name="coderrupee:auth" content={loggedin() ? "true" : "false"} />
