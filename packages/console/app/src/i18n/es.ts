...
export const dict = {
  ...
  "notFound.title": "No encontrado | coderrupee",
  "notFound.heading": "404 - Página no encontrada",
  "notFound.home": "Inicio",
  "notFound.docs": "Documentación",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "coderrupee logo claro",
  "notFound.logoDarkAlt": "coderrupee logo oscuro",
  ...
  "app.meta.description": "CoderRupee - El agente de codificación de código abierto.",

  "home.title": "CoderRupee | El agente de codificación IA de código abierto",

  "temp.title": "coderrupee | Agente de codificación IA creado para la terminal",
  "temp.hero.title": "El agente de codificación IA creado para la terminal",
  "temp.zen": "coderrupee zen",
  ...
  "temp.feature.zen.afterLink": "proporcionada por coderrupee",
  ...
  "temp.screenshot.caption": "coderrupee TUI con el tema tokyonight",
  "temp.screenshot.alt": "coderrupee TUI con tema tokyonight",
  "temp.logoLightAlt": "logo de coderrupee claro",
  "temp.logoDarkAlt": "logo de coderrupee oscuro",
  ...
  "home.what.title": "¿Qué es CoderRupee?",
  "home.what.body":
    "CoderRupee es un agente de código abierto que te ayuda a escribir código en tu terminal, IDE o escritorio.",
  ...
  "home.growth.body":
    "Con más de <strong>{{stars}}</strong> estrellas en GitHub, <strong>{{contributors}}</strong> colaboradores y más de <strong>{{commits}}</strong> commits, CoderRupee es usado y confiado por más de <strong>{{monthlyUsers}}</strong> desarrolladores cada mes.",
  ...
  "home.privacy.body":
    "CoderRupee no almacena tu código ni datos de contexto, para que pueda operar en entornos sensibles a la privacidad.",
  "home.privacy.learnMore": "Más información sobre",
  "home.privacy.link": "privacidad",

  "home.faq.q1": "¿Qué es CoderRupee?",
  "home.faq.a1":
    "CoderRupee es un agente de código abierto que te ayuda a escribir y ejecutar código con cualquier modelo de IA. Está disponible como interfaz de terminal, aplicación de escritorio o extensión de IDE.",
  "home.faq.q2": "¿Cómo uso CoderRupee?",
  "home.faq.a2.before": "La forma más fácil de empezar es leer la",
  "home.faq.a2.link": "introducción",
  "home.faq.q3": "¿Necesito suscripciones extra de IA para usar CoderRupee?",
  "home.faq.a3.p1":
    "No necesariamente, CoderRupee viene con un conjunto de modelos gratuitos que puedes usar sin crear una cuenta.",
  ...
  "home.faq.a3.p3":
    "Aunque animamos a los usuarios a usar Zen, CoderRupee también funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",
  "home.faq.a3.p4.beforeLocal": "Incluso puedes conectar tus",
  "home.faq.a3.p4.localLink": "modelos locales",
  "home.faq.q4": "¿Puedo usar mis suscripciones de IA existentes con CoderRupee?",
  "home.faq.a4.p1":
    "Sí, CoderRupee soporta planes de suscripción de los principales proveedores. Puedes usar tus suscripciones de Claude Pro/Max, ChatGPT Plus/Pro o GitHub Copilot.",
  "home.faq.q5": "¿Solo puedo usar CoderRupee en la terminal?",
  "home.faq.a5.beforeDesktop": "¡Ya no! CoderRupee ahora está disponible como una aplicación para tu",
  "home.faq.a5.desktop": "escritorio",
  "home.faq.a5.and": "y",
  "home.faq.a5.web": "web",
  "home.faq.q6": "¿Cuánto cuesta CoderRupee?",
  "home.faq.a6":
    "CoderRupee es 100% gratuito de usar. También viene con un conjunto de modelos gratuitos. Puede haber costos adicionales si conectas cualquier otro proveedor.",
  ...
  "home.faq.q8": "¿Es CoderRupee de código abierto?",
  "home.faq.a8.p1": "Sí, CoderRupee es totalmente de código abierto. El código fuente es público en",
  ...
  "home.zenCta.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que CoderRupee ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes entre proveedores, usa modelos validados que funcionan.",
  "home.zenCta.link": "Aprende sobre Zen",

  "zen.title":
    "CoderRupee Zen | Un conjunto seleccionado de modelos optimizados y confiables para agentes de codificación",
  "zen.hero.title": "Modelos optimizados y confiables para agentes de codificación",
  "zen.hero.body":
    "Zen te da acceso a un conjunto seleccionado de modelos de IA que CoderRupee ha probado y evaluado específicamente para agentes de codificación. No necesitas preocuparte por el rendimiento y la calidad inconsistentes, usa modelos validados que funcionan.",

  "zen.faq.q1": "¿Qué es CoderRupee Zen?",
  "zen.faq.a1":
    "Zen es un conjunto seleccionado de modelos de IA probados y evaluados para agentes de codificación, creado por el equipo detrás de CoderRupee.",
  ...
  "zen.faq.a3":
    "Zen no tiene fines de lucro. Zen te transfiere los costos de los proveedores de modelos. Cuanto mayor sea el uso de Zen, más podrá CoderRupee negociar mejores tarifas y transferírtelas.",
  ...
  "zen.faq.a4.p3":
    "Para cubrir costos, CoderRupee añade solo una pequeña tarifa de procesamiento de pagos de $1.23 por cada recarga de saldo de $20.",
  ...
  "zen.faq.a8":
    "Aunque Zen funciona genial con CoderRupee, puedes usar Zen con cualquier agente. Sigue las instrucciones de configuración en tu agente de codificación preferido.",
  ...
  "zen.problem.subtitle": "Estamos arreglando esto para todos, no solo para usuarios de CoderRupee.",
  ...
  "zen.how.body": "Aunque sugerimos usar Zen con CoderRupee, puedes usar Zen con cualquier agente.",
  ...
  "go.title": "CoderRupee Go | Modelos de programación de bajo coste para todos",
  ...
  "go.testimonials.handle": "@CoderRupee",
  ...
  "go.problem.body":
    "Nos enfocamos en llevar la experiencia de CoderRupee a tantas personas como sea posible. CoderRupee Go es una suscripción de bajo coste de 10 $/mes. Proporciona límites generosos y acceso fiable a los modelos de código abierto más capaces.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go cuesta 10 $/mes. Puedes usarlo con CoderRupee o cualquier agente.",
  ...
  "go.faq.q1": "¿Qué es CoderRupee Go?",
  "go.faq.a1":
  ...
  "zen.api.error.trialEnded":
    "La promoción gratuita de {{model}} ha finalizado. Puedes seguir usando el modelo suscribiéndote a CoderRupee Go - {{link}}",

  "black.meta.title": "CoderRupee Black | Accede a los mejores modelos de codificación del mundo",
  "black.meta.description": "Obtén acceso a Claude, GPT, Gemini y más con los planes de suscripción de CoderRupee Black.",
  ...
  "black.title": "CoderRupee Black | Precios",
  ...
  "black.workspace.title": "CoderRupee Black | Seleccionar Espacio de Trabajo",
  "black.workspace.selectPlan": "Selecciona un espacio de trabajo para este plan",
  "black.workspace.name": "Espacio de trabajo {{n}}",
  "black.subscribe.title": "Suscribirse a CoderRupee Black",
  ...
  "black.subscribe.success.title": "Estás en la lista de espera de CoderRupee Black",
  "black.subscribe.success.subscriptionPlan": "Plan de suscripción",
  "black.subscribe.success.planName": "CoderRupee Black {{plan}}",
  ...
  "workspace.newUser.feature.lockin.body":
    "Usa Zen con cualquier agente de codificación, y continúa usando otros proveedores con coderrupee cuando quieras.",
  ...
  "workspace.newUser.step.login.after": "y selecciona coderrupee",
  "workspace.newUser.step.pasteKey": "Pega tu clave API",
  "workspace.newUser.step.models.before": "Inicia coderrupee y ejecuta",
  ...
  "workspace.keys.subtitle": "Gestiona tus claves API para acceder a los servicios de coderrupee.",
  "workspace.keys.create": "Crear Clave API",
  "workspace.keys.placeholder": "Introduce nombre de la clave",
  "workspace.keys.empty": "Crea una clave API de coderrupee Gateway",
  ...
  "workspace.black.subscription.message": "Estás suscrito a CoderRupee Black por ${{plan}} al mes.",
  ...
  "workspace.black.waitlist.joined": "Estás en la lista de espera para el plan CoderRupee Black de ${{plan}} al mes.",
  "workspace.black.waitlist.ready": "Estamos listos para inscribirte en el plan CoderRupee Black de ${{plan}} al mes.",
  ...
  "workspace.lite.subscription.message": "Estás suscrito a CoderRupee Go.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Selecciona "CoderRupee Go" como proveedor en tu configuración de coderrupee para usar los modelos Go.',
  ...
  "workspace.lite.black.message":
    "Actualmente estás suscrito a CoderRupee Black o estás en la lista de espera. Por favor, cancela la suscripción primero si deseas cambiar a Go.",
  "workspace.lite.other.message":
    "Otro miembro de este espacio de trabajo ya está suscrito a CoderRupee Go. Solo un miembro por espacio de trabajo puede suscribirse.",
  "workspace.lite.promo.description":
    "CoderRupee Go cuesta {{price}} y ofrece acceso confiable a modelos de codificación abiertos populares con límites de uso generosos.",
  ...
  "download.title": "CoderRupee | Descargar",
  "download.meta.description": "Descarga CoderRupee para macOS, Windows y Linux",
  "download.hero.title": "Descargar CoderRupee Desktop",
  "download.hero.subtitle": "Disponible en Beta para macOS, Windows y Linux",
  "download.hero.button": "Descargar para {{os}}",
  "download.section.terminal": "CoderRupee Terminal",
  "download.section.desktop": "CoderRupee Desktop",
  "download.section.extensions": "Extensiones CoderRupee",
  "download.section.integrations": "Integraciones CoderRupee",
  ...
  "download.faq.a3.beforeLocal":
    "No necesariamente, pero probablemente. Necesitarás una suscripción de IA si quieres conectar CoderRupee a un proveedor de pago, aunque puedes trabajar con",
  ...
  "download.faq.a3.afterZen":
    ", CoderRupee funciona con todos los proveedores populares como OpenAI, Anthropic, xAI, etc.",

  "download.faq.a5.p1": "CoderRupee es 100% gratuito de usar.",
  "download.faq.a5.p2.beforeZen":
    "Cualquier costo adicional vendrá de tu suscripción a un proveedor de modelos. Aunque CoderRupee funciona con cualquier proveedor de modelos, recomendamos usar",
  "download.faq.a5.p2.afterZen": ".",

  "download.faq.a6.p1": "Tus datos e información solo se almacenan cuando creas enlaces compartibles en CoderRupee.",
  "download.faq.a6.p2.beforeShare": "Más información sobre",
  "download.faq.a6.shareLink": "páginas compartidas",

  "enterprise.title": "CoderRupee | Soluciones empresariales para tu organización",
  "enterprise.meta.description": "Contacta a CoderRupee para soluciones empresariales",
  "enterprise.hero.title": "Tu código es tuyo",
  "enterprise.hero.body1":
    "CoderRupee opera de forma segura dentro de tu organización sin almacenar datos ni contexto, y sin restricciones de licencia ni reclamaciones de propiedad. Inicia una prueba con tu equipo, luego despliégalo en toda tu organización integrándolo con tu SSO y pasarela de IA interna.",
  ...
  "enterprise.faq.q1": "¿Qué es CoderRupee Enterprise?",
  "enterprise.faq.a1":
    "CoderRupee Enterprise es para organizaciones que quieren asegurar que su código y datos nunca salgan de su infraestructura. Puede hacer esto usando una configuración centralizada que se integra con tu SSO y pasarela de IA interna.",
  "enterprise.faq.q2": "¿Cómo empiezo con CoderRupee Enterprise?",
  "enterprise.faq.a2":
    "Simplemente empieza con una prueba interna con tu equipo. CoderRupee por defecto no almacena tu código ni datos de contexto, haciendo fácil empezar. Luego contáctanos para discutir precios y opciones de implementación.",
  ...
  "enterprise.faq.q4": "¿Están mis datos seguros con CoderRupee Enterprise?",
  "enterprise.faq.a4":
    "Sí. CoderRupee no almacena tu código ni datos de contexto. Todo el procesamiento ocurre localmente o a través de llamadas directas a la API de tu proveedor de IA. Con configuración central y integración SSO, tus datos permanecen seguros dentro de la infraestructura de tu organización.",

  "brand.title": "CoderRupee | Marca",
  "brand.meta.description": "Guías de marca de CoderRupee",
  "brand.heading": "Guías de marca",
  "brand.subtitle": "Recursos y activos para ayudarte a trabajar con la marca CoderRupee.",
  "brand.downloadAll": "Descargar todos los activos",

  "changelog.title": "CoderRupee | Registro de cambios",
  "changelog.meta.description": "Notas de versión y registro de cambios de CoderRupee",
  "changelog.hero.title": "Registro de cambios",
  "changelog.hero.subtitle": "Nuevas actualizaciones y mejoras para CoderRupee",
