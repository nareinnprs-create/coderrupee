...
export const dict = {
  ...
  "notFound.title": "Bulunamadı | coderrupee",
  "notFound.heading": "404 - Sayfa bulunamadı",
  "notFound.home": "Ana sayfa",
  "notFound.docs": "Dokümantasyon",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "coderrupee açık logo",
  "notFound.logoDarkAlt": "coderrupee koyu logo",
  ...
  "app.meta.description": "CoderRupee - Açık kaynaklı kodlama ajanı.",

  "home.title": "CoderRupee | Açık kaynaklı yapay zeka kodlama ajanı",

  "temp.title": "coderrupee | Terminal için geliştirilmiş yapay zeka kodlama ajanı",
  ...
  "temp.feature.zen.beforeLink": "coderrupee tarafından sağlanan ",
  ...
  "temp.screenshot.caption": "coderrupee TUI ve tokyonight teması",
  "temp.screenshot.alt": "tokyonight temalı coderrupee TUI",
  "temp.logoLightAlt": "coderrupee açık logo",
  "temp.logoDarkAlt": "coderrupee koyu logo",
  ...
  "home.what.title": "CoderRupee nedir?",
  "home.what.body":
    "CoderRupee, terminalinizde, IDE'nizde veya masaüstünde kod yazmanıza yardım eden açık kaynaklı bir ajandır.",
  ...
  "home.growth.body":
    "GitHub'da <strong>{{stars}}</strong>+ yıldız, <strong>{{contributors}}</strong> katılımcı ve <strong>{{commits}}</strong>+ commit ile CoderRupee, her ay <strong>{{monthlyUsers}}</strong>+ geliştirici tarafından kullanılıyor ve güveniliyor.",
  ...
  "home.privacy.body":
    "CoderRupee kodunuzu veya bağlam verilerinizi saklamaz; bu sayede gizliliğe duyarlı ortamlarda çalışabilir.",
  "home.privacy.learnMore": "Hakkında daha fazla bilgi:",
  "home.privacy.link": "gizlilik",

  "home.faq.q1": "CoderRupee nedir?",
  "home.faq.a1":
    "CoderRupee, herhangi bir AI modeliyle kod yazmanıza ve çalıştırmanıza yardım eden açık kaynaklı bir ajandır. Terminal arayüzü, masaüstü uygulaması veya IDE uzantısı olarak kullanılabilir.",
  "home.faq.q2": "CoderRupee'u nasıl kullanırım?",
  "home.faq.a2.before": "Başlamanın en kolay yolu",
  "home.faq.a2.link": "girişi okumaktır",
  "home.faq.q3": "CoderRupee için ek AI aboneliklerine ihtiyacım var mı?",
  "home.faq.a3.p1": "Şart değil. CoderRupee, hesap açmadan kullanabileceğiniz ücretsiz modellerle gelir.",
  ...
  "home.faq.a3.p3": "Zen'i öneriyoruz, ancak CoderRupee OpenAI, Anthropic, xAI gibi popüler sağlayıcılarla da çalışır.",
  "home.faq.a3.p4.beforeLocal": "Hatta",
  "home.faq.a3.p4.localLink": "yerel modellerinizi bağlayabilirsiniz",
  "home.faq.q4": "Mevcut AI aboneliklerimi CoderRupee ile kullanabilir miyim?",
  "home.faq.a4.p1":
    "Evet. CoderRupee tüm büyük sağlayıcıların aboneliklerini destekler. Claude Pro/Max, ChatGPT Plus/Pro veya GitHub Copilot kullanabilirsiniz.",
  "home.faq.q5": "CoderRupee'u sadece terminalde mi kullanabilirim?",
  "home.faq.a5.beforeDesktop": "Artık hayır! CoderRupee artık sizin bu cihazlarınıza",
  "home.faq.a5.desktop": "masaüstü",
  "home.faq.a5.and": "ve",
  "home.faq.a5.web": "web",
  "home.faq.q6": "CoderRupee ne kadar?",
  "home.faq.a6":
    "CoderRupee %100 ücretsizdir. Ayrıca ücretsiz model setiyle gelir. Başka bir sağlayıcı bağlarsanız ek maliyetler olabilir.",
  ...
  "home.faq.q8": "CoderRupee açık kaynak mı?",
  "home.faq.a8.p1": "Evet, CoderRupee tamamen açık kaynaktır. Kaynak kodu",
  "home.faq.a8.p2": "'da",
  ...
  "home.zenCta.body":
    "Zen, CoderRupee'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",
  "home.zenCta.link": "Zen hakkında",

  "zen.title": "CoderRupee Zen | Kodlama ajanları için güvenilir, optimize edilmiş modellerin seçilmiş seti",
  "zen.hero.title": "Kodlama ajanları için güvenilir, optimize modeller",
  "zen.hero.body":
    "Zen, CoderRupee'un kodlama ajanları için özel olarak test edip benchmark ettiği seçilmiş AI modellerine erişim sağlar. Sağlayıcılar arasında tutarsız performans ve kalite konusunda endişelenmeyin; çalışan, doğrulanmış modelleri kullanın.",

  "zen.faq.q1": "CoderRupee Zen nedir?",
  "zen.faq.a1":
    "Zen, CoderRupee ekibi tarafından oluşturulan ve kodlama ajanları için test edilip benchmark edilen seçilmiş bir AI model setidir.",
  ...
  "zen.faq.a3":
    "Zen kâr amaçlı değildir. Zen, model sağlayıcılarının maliyetlerini size yansıtır. Zen'in kullanımı arttıkça CoderRupee daha iyi fiyatlar pazarlayabilir ve bunları size yansıtabilir.",
  ...
  "zen.faq.a4.p3":
    "Maliyetleri karşılamak için CoderRupee, $20 bakiye yüklemesi başına yalnızca $1.23 tutarında küçük bir ödeme işleme ücreti ekler.",
  ...
  "zen.faq.a8":
    "Zen CoderRupee ile harika çalışır, ama Zen'i herhangi bir ajan ile kullanabilirsiniz. Tercih ettiğiniz kodlama ajanında kurulum talimatlarını izleyin.",
  ...
  "zen.problem.subtitle": "Bu sorunu yalnızca CoderRupee kullanıcıları için değil, herkes için düzeltiyoruz.",
  ...
  "zen.how.body": "Zen'i CoderRupee ile kullanmanızı önersek de, Zen'i herhangi bir ajan ile kullanabilirsiniz.",
  ...
  "go.title": "CoderRupee Go | Herkes için düşük maliyetli kodlama modelleri",
  ...
  "go.problem.body":
    "CoderRupee deneyimini mümkün olduğunca çok kişiye ulaştırmaya odaklandık. CoderRupee Go, ayda 10$ olan düşük maliyetli bir aboneliktir. Cömert limitler ve en yetenekli açık kaynak modellere güvenilir erişim sağlar.",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go ayda 10$'dır. CoderRupee veya herhangi bir ajanla kullanabilirsiniz.",
  ...
  "zen.api.error.trialEnded":
    "{{model}} için ücretsiz promosyon sona erdi. CoderRupee Go'ya abone olarak modeli kullanmaya devam edebilirsiniz - {{link}}",

  "black.meta.title": "CoderRupee Black | Dünyanın en iyi kodlama modellerine erişin",
  "black.meta.description": "CoderRupee Black abonelik planlarıyla Claude, GPT, Gemini ve daha fazlasına erişin.",
  "black.hero.title": "Dünyanın en iyi kodlama modellerine erişin",
  "black.hero.subtitle": "Claude, GPT, Gemini ve daha fazlası dahil",
  "black.title": "CoderRupee Black | Fiyatlandırma",
  ...
  "black.workspace.title": "CoderRupee Black | Çalışma Alanı Seç",
  "black.workspace.selectPlan": "Bu plan için bir çalışma alanı seçin",
  "black.workspace.name": "Çalışma Alanı {{n}}",
  "black.subscribe.title": "CoderRupee Black'e Abone Ol",
  ...
  "black.subscribe.success.title": "CoderRupee Black bekleme listesindesiniz",
  ...
  "workspace.newUser.feature.lockin.body":
    "Zen'i herhangi bir kodlama ajanıyla kullanın ve istediğiniz zaman coderrupee ile diğer sağlayıcıları kullanmaya devam edin.",
  ...
  "workspace.newUser.step.login.after": "ve coderrupee seçeneğini seçin",
  "workspace.newUser.step.pasteKey": "API anahtarınızı yapıştırın",
  "workspace.newUser.step.models.before": "coderrupee'u başlatın ve çalıştırın",
  ...
  "workspace.keys.subtitle": "coderrupee hizmetlerine erişim için API anahtarlarınızı yönetin.",
  "workspace.keys.create": "API Anahtarı Oluştur",
  "workspace.keys.placeholder": "Anahtar adını girin",
  "workspace.keys.empty": "Bir coderrupee Gateway API anahtarı oluşturun",
  ...
  "workspace.black.subscription.message": "Aylık ${{plan}} karşılığında CoderRupee Black'e abonesiniz.",
  ...
  "workspace.black.waitlist.joined": "Aylık ${{plan}} CoderRupee Black planı için bekleme listesindesiniz.",
  "workspace.black.waitlist.ready": "Sizi ayda {{plan}} $ tutarındaki CoderRupee Black planına kaydetmeye hazırız.",
  ...
  "workspace.lite.subscription.message": "CoderRupee Go abonesisiniz.",
  ...
  "workspace.lite.subscription.selectProvider":
    'Go modellerini kullanmak için coderrupee yapılandırmanızda "CoderRupee Go"\'yu sağlayıcı olarak seçin.',
  ...
  "workspace.lite.black.message":
    "Şu anda CoderRupee Black abonesisiniz veya bekleme listesindesiniz. Go'ya geçmek istiyorsanız lütfen önce aboneliğinizi iptal edin.",
  "workspace.lite.other.message":
    "Bu çalışma alanındaki başka bir üye zaten CoderRupee Go abonesi. Çalışma alanı başına yalnızca bir üye abone olabilir.",
  "workspace.lite.promo.description":
    "CoderRupee Go {{price}} fiyatıyla cömert kullanım limitleri ve popüler açık kodlama modellerine güvenilir erişim sağlar.",
  ...
  "download.title": "CoderRupee | İndir",
  "download.meta.description": "CoderRupee'u macOS, Windows ve Linux için indirin",
  "download.hero.title": "CoderRupee Desktop'u İndir",
  ...
  "download.section.extensions": "CoderRupee Eklentileri",
  "download.section.integrations": "CoderRupee Entegrasyonları",
  ...
  "download.faq.a3.beforeLocal":
    "Tam olarak değil, ama muhtemelen. CoderRupee'u ücretli bir sağlayıcıya bağlamak istiyorsanız bir AI aboneliği gerekir, ancak",
  ...
  "download.faq.a3.afterZen":
    " kullanmaya teşvik ediyoruz, ancak CoderRupee OpenAI, Anthropic, xAI vb. gibi tüm popüler sağlayıcılarla çalışır.",

  "download.faq.a5.p1": "CoderRupee %100 ücretsizdir.",
  "download.faq.a5.p2.beforeZen":
    "Ek maliyetler, bir model sağlayıcısına olan aboneliğinizden gelir. CoderRupee herhangi bir model sağlayıcısıyla çalışır, ancak",
  "download.faq.a5.p2.afterZen": " kullanmanızı öneririz.",

  "download.faq.a6.p1":
    "Verileriniz ve bilginiz yalnızca CoderRupee'da paylaşılabilir bağlantılar oluşturduğunuzda saklanır.",
  "download.faq.a6.p2.beforeShare": "Daha fazla bilgi:",
  "download.faq.a6.shareLink": "paylaşım sayfaları",

  "enterprise.title": "CoderRupee | Kurumunuz için kurumsal çözümler",
  "enterprise.meta.description": "Kurumsal çözümler için CoderRupee ile iletişime geçin",
  "enterprise.hero.title": "Kodunuz size aittir",
  "enterprise.hero.body1":
    "CoderRupee, hiçbir veri veya bağlam saklamadan ve lisans kısıtlamaları ya da sahiplik iddiaları olmadan kuruluşunuzun içinde güvenli şekilde çalışır. Ekibinizle bir deneme başlatın, ardından SSO'nuz ve dahili AI geçidiniz ile entegre ederek tüm kuruluşunuzda devreye alın.",
  ...
  "enterprise.faq.q1": "CoderRupee Enterprise nedir?",
  "enterprise.faq.a1":
    "CoderRupee Enterprise, kodunuzun ve verilerinizin asla altyapınızı terk etmemesini sağlamak isteyen kurumlar içindir. Bunu, SSO'nuz ve dahili AI geçidiniz ile entegre olan merkezileştirilmiş bir konfigürasyonla sağlar.",
  "enterprise.faq.q2": "CoderRupee Enterprise'a nasıl başlarım?",
  "enterprise.faq.a2":
    "Ekibinizle dahili bir deneme ile başlayın. CoderRupee varsayılan olarak kodunuzu veya bağlam verilerinizi saklamaz, bu da başlamayı kolaylaştırır. Ardından fiyatlandırma ve uygulama seçeneklerini görüşmek için bize ulaşın.",
  ...
  "enterprise.faq.q4": "CoderRupee Enterprise ile verilerim güvende mi?",
  "enterprise.faq.a4":
    "Evet. CoderRupee kodunuzu veya bağlam verilerinizi saklamaz. Tüm işleme yerel olarak ya da AI sağlayıcınıza doğrudan API çağrıları ile gerçekleştirilir. Merkezileştirilmiş konfigürasyon ve SSO entegrasyonu ile verileriniz kurumunuzun altyapısı içinde güvende kalır.",

  "brand.title": "CoderRupee | Marka",
  "brand.meta.description": "CoderRupee marka kılavuzu",
  "brand.heading": "Marka kılavuzu",
  "brand.subtitle": "CoderRupee markası ile çalışmanıza yardımcı olacak kaynaklar ve varlıklar.",
  "brand.downloadAll": "Tüm varlıkları indir",

  "changelog.title": "CoderRupee | Değişiklik günlüğü",
  "changelog.meta.description": "CoderRupee sürüm notları ve değişiklik günlüğü",
  "changelog.hero.title": "Değişiklik günlüğü",
  "changelog.hero.subtitle": "CoderRupee için yeni güncellemeler ve iyileştirmeler",
