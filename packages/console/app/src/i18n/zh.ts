...
export const dict = {
  ...
  "notFound.title": "未找到页面 | CoderRupee",
  "notFound.heading": "404 - 页面未找到",
  "notFound.home": "首页",
  "notFound.docs": "文档",
  "notFound.github": "GitHub",
  "notFound.discord": "Discord",
  "notFound.logoLightAlt": "coderrupee logo 亮色",
  "notFound.logoDarkAlt": "coderrupee logo 暗色",
  ...
  "app.meta.description": "CoderRupee - 开源编程代理。",

  "home.title": "CoderRupee | 开源 AI 编程代理",

  "temp.title": "CoderRupee | 专为终端打造的 AI 编程代理",
  ...
  "temp.feature.zen.beforeLink": "由 CoderRupee 提供的",
  ...
  "temp.screenshot.caption": "使用 Tokyonight 主题的 CoderRupee TUI",
  "temp.screenshot.alt": "使用 Tokyonight 主题的 CoderRupee TUI",
  "temp.logoLightAlt": "coderrupee logo 亮色",
  "temp.logoDarkAlt": "coderrupee logo 暗色",
  ...
  "home.what.title": "什么是 CoderRupee？",
  "home.what.body": "CoderRupee 是一个开源代理，帮助您在终端、IDE 或桌面端编写代码。",
  ...
  "home.growth.body":
    "拥有超过 <strong>{{stars}}</strong> 颗 GitHub Star，<strong>{{contributors}}</strong> 位贡献者，以及超过 <strong>{{commits}}</strong> 次提交，CoderRupee 每月被超过 <strong>{{monthlyUsers}}</strong> 名开发者使用并信赖。",
  "home.growth.githubStars": "GitHub Stars",
  "home.growth.contributors": "贡献者",
  "home.growth.monthlyDevs": "月活开发者",

  "home.privacy.title": "隐私优先的设计",
  "home.privacy.body": "CoderRupee 不存储您的任何代码或上下文数据，确保可以在对隐私敏感的环境中运行。",
  "home.privacy.learnMore": "了解更多关于",
  "home.privacy.link": "隐私",

  "home.faq.q1": "什么是 CoderRupee？",
  "home.faq.a1": "CoderRupee 是一个开源代理，帮助您使用任意 AI 模型编写和运行代码。它提供终端界面、桌面应用及 IDE 扩展。",
  "home.faq.q2": "如何使用 CoderRupee？",
  "home.faq.a2.before": "最简单的入门方式是阅读",
  "home.faq.a2.link": "介绍",
  "home.faq.q3": "使用 CoderRupee 需要额外的 AI 订阅吗？",
  "home.faq.a3.p1": "不一定。CoderRupee 自带一组免费模型，无需创建账户即可使用。",
  "home.faq.a3.p2.beforeZen": "此外，您可以通过创建",
  "home.faq.a3.p2.afterZen": "账户来使用流行的编程模型。",
  "home.faq.a3.p3": "虽然我们鼓励使用 Zen，但 CoderRupee 也支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",
  "home.faq.a3.p4.beforeLocal": "您甚至可以连接您的",
  "home.faq.a3.p4.localLink": "本地模型",
  "home.faq.q4": "我可以使用现有的 AI 订阅吗？",
  "home.faq.a4.p1":
    "可以，CoderRupee 支持所有主流提供商的订阅计划。您可以使用您的 Claude Pro/Max, ChatGPT Plus/Pro, 或 GitHub Copilot 订阅。",
  "home.faq.q5": "CoderRupee 只能在终端使用吗？",
  "home.faq.a5.beforeDesktop": "不再是了！CoderRupee 现在也提供",
  "home.faq.a5.desktop": "桌面端应用",
  "home.faq.a5.and": "和",
  "home.faq.a5.web": "网页端",
  "home.faq.q6": "CoderRupee 多少钱？",
  "home.faq.a6": "CoderRupee 是 100% 免费使用的。它还自带一组免费模型。如果您连接其他提供商，可能会产生额外费用。",
  "home.faq.q7": "数据和隐私如何？",
  ...
  "home.faq.q8": "CoderRupee 是开源的吗？",
  "home.faq.a8.p1": "是的，CoderRupee 是完全开源的。源代码公开在",
  "home.faq.a8.p2": "遵循",
  ...
  "home.zenCta.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 CoderRupee 专门针对编程代理的测试和基准测试。无需担心不同提供商之间不稳定的性能和质量，直接使用行之有效的验证模型。",
  "home.zenCta.link": "了解 Zen",

  "zen.title": "CoderRupee Zen | 为编程代理精选的可靠、优化模型",
  "zen.hero.title": "为编程代理打造的可靠、优化模型",
  "zen.hero.body":
    "Zen 为您提供一组精选的 AI 模型，这些模型经过 CoderRupee 专门针对编程代理的测试和基准测试。无需担心不稳定的性能和质量，直接使用行之有效的验证模型。",

  "zen.faq.q1": "什么是 CoderRupee Zen？",
  "zen.faq.a1": "Zen 是一组由 CoderRupee 团队创建的，专门针对编程代理进行测试和基准测试的 AI 模型精选集。",
  "zen.faq.q2": "为什么 Zen 更准确？",
  "zen.faq.a2":
    "Zen 仅提供经过专门针对编程代理测试和基准测试的模型。正如你不会用黄油刀切牛排一样，也不要用糟糕的模型来写代码。",
  "zen.faq.q3": "Zen 更便宜吗？",
  "zen.faq.a3":
    "Zen 不以盈利为目的。Zen 将模型提供商的成本直接传递给您。Zen 的使用量越高，CoderRupee 就越能协商出更好的费率并回馈给您。",
  "zen.faq.q4": "Zen 多少钱？",
  ...
  "zen.faq.a4.p3": "为覆盖成本，CoderRupee 仅收取少量支付处理费，每充值 $20 收取 $1.23。",
  "zen.faq.q5": "数据和隐私如何？",
  ...
  "zen.faq.a8":
    "虽然 Zen 与 CoderRupee 配合效果极佳，但您可以在任何代理中使用 Zen。请按照您首选编程代理中的设置说明进行操作。",
  ...
  "go.title": "CoderRupee Go | 人人可用的低成本编程模型",
  ...
  "go.problem.body":
    "我们致力于将 CoderRupee 体验带给尽可能多的人。CoderRupee Go 是一款每月 $10 的低成本订阅服务。它提供充裕的额度，并让您能可靠地使用最强大的开源模型。",
  "go.problem.subtitle": " ",
  ...
  "go.how.body": "Go 每月 $10。您可以将其与 CoderRupee 或任何代理搭配使用。",
  ...
  "zen.api.error.trialEnded": "{{model}} 的限免活动已结束。您可以订阅 CoderRupee Go 继续使用该模型 - {{link}}",

  "black.meta.title": "CoderRupee Black | 访问全球顶尖编程模型",
  "black.meta.description": "通过 CoderRupee Black 订阅计划使用 Claude, GPT, Gemini 等模型。",
  "black.hero.title": "访问全球顶尖编程模型",
  "black.hero.subtitle": "包括 Claude, GPT, Gemini 等",
  "black.title": "CoderRupee Black | 定价",
  ...
  "black.workspace.title": "CoderRupee Black | 选择工作区",
  "black.workspace.selectPlan": "为此计划选择一个工作区",
  "black.workspace.name": "工作区 {{n}}",
  "black.subscribe.title": "订阅 CoderRupee Black",
  ...
  "black.subscribe.success.title": "您已加入 CoderRupee Black 候补名单",
  ...
  "workspace.newUser.feature.lockin.body":
    "将 Zen 与任何编程代理结合使用，并在需要时继续在 CoderRupee 中使用其他提供商。",
  ...
  "workspace.newUser.step.login.after": "并选择 CoderRupee",
  "workspace.newUser.step.pasteKey": "粘贴您的 API 密钥",
  "workspace.newUser.step.models.before": "启动 CoderRupee 并运行",
  ...
  "workspace.keys.subtitle": "管理访问 CoderRupee 服务的 API 密钥。",
  "workspace.keys.create": "创建 API 密钥",
  "workspace.keys.placeholder": "输入密钥名称",
  "workspace.keys.empty": "创建 CoderRupee 网关 API 密钥",
  ...
  "workspace.black.subscription.message": "您已订阅 CoderRupee Black，价格为每月 ${{plan}}。",
  ...
  "workspace.black.waitlist.joined": "您已加入每月 ${{plan}} 的 CoderRupee Black 计划候补名单。",
  "workspace.black.waitlist.ready": "我们已准备好将您加入每月 ${{plan}} 的 CoderRupee Black 计划。",
  ...
  "workspace.lite.subscription.message": "您已订阅 CoderRupee Go。",
  ...
  "workspace.lite.subscription.selectProvider":
    "在你的 coderrupee 配置中选择「CoderRupee Go」作为提供商，即可使用 Go 模型。",
  ...
  "workspace.lite.black.message": "您当前已订阅 CoderRupee Black 或在候补名单中。如需切换到 Go，请先取消订阅。",
  "workspace.lite.other.message": "此工作区中的另一位成员已经订阅了 CoderRupee Go。每个工作区只有一名成员可以订阅。",
  "workspace.lite.promo.description":
    "CoderRupee Go 每月 {{price}}，并提供对流行开放编码模型的可靠访问，同时享有充裕的使用限额。",
  ...
  "download.title": "CoderRupee | 下载",
  "download.meta.description": "下载适用于 macOS, Windows, 和 Linux 的 CoderRupee",
  "download.hero.title": "下载 CoderRupee 桌面版",
  "download.hero.subtitle": "适用于 macOS, Windows, 和 Linux 的 Beta 版",
  "download.hero.button": "下载 {{os}} 版",
  "download.section.terminal": "CoderRupee 终端",
  "download.section.desktop": "CoderRupee 桌面版",
  "download.section.extensions": "CoderRupee 扩展",
  "download.section.integrations": "CoderRupee 集成",
  ...
  "download.faq.a3.beforeLocal":
    "不一定，但可能需要。如果您想将 CoderRupee 连接到付费提供商，您需要 AI 订阅，尽管您可以配合",
  "download.faq.a3.localLink": "本地模型",
  "download.faq.a3.afterLocal.beforeZen": "免费使用。虽然我们鼓励用户使用",
  "download.faq.a3.afterZen": "，但 CoderRupee 支持所有主流提供商，如 OpenAI, Anthropic, xAI 等。",

  "download.faq.a5.p1": "CoderRupee 是 100% 免费使用的。",
  "download.faq.a5.p2.beforeZen":
    "任何额外费用都来自您对模型提供商的订阅。虽然 CoderRupee 支持任何模型提供商，但我们建议使用",
  "download.faq.a5.p2.afterZen": "。",

  "download.faq.a6.p1": "只有当您在 CoderRupee 中创建分享链接时，您的数据和信息才会被存储。",
  "download.faq.a6.p2.beforeShare": "了解更多关于",
  "download.faq.a6.shareLink": "分享页面",

  "enterprise.title": "CoderRupee | 面向组织的 CoderRupee 企业版解决方案",
  "enterprise.meta.description": "联系 CoderRupee 获取企业版解决方案",
  "enterprise.hero.title": "您的代码属于您",
  "enterprise.hero.body1":
    "CoderRupee 在您的组织内部安全运行，不存储任何数据或上下文，也没有许可限制或所有权主张。您可以先与团队开始试用，然后通过集成 SSO 和内部 AI 网关将其部署到整个组织。",
  ...
  "enterprise.faq.q1": "什么是 CoderRupee 企业版？",
  "enterprise.faq.a1":
    "CoderRupee 企业版专为那些希望确保代码和数据永远不离开其基础设施的组织而设计。它通过使用集中式配置，与您的 SSO 和内部 AI 网关集成来实现这一点。",
  "enterprise.faq.q2": "如何开始使用 CoderRupee 企业版？",
  "enterprise.faq.a2":
    "只需从您的团队内部试用开始即可。CoderRupee 默认不存储您的代码或上下文数据，使得入门非常容易。然后联系我们讨论定价和实施选项。",
  "enterprise.faq.q3": "企业版定价如何运作？",
  "enterprise.faq.a3":
    "我们提供按席位计费的企业定价。如果您拥有自己的 LLM 网关，我们不收取 token 使用费。如需了解更多详情，请联系我们获取基于您组织需求的定制报价。",
  "enterprise.faq.q4": "CoderRupee 企业版安全吗？",
  "enterprise.faq.a4":
    "是的。CoderRupee 不存储您的代码或上下文数据。所有处理均在本地进行，或通过直接 API 调用您的 AI 提供商。通过集中配置和 SSO 集成，您的数据始终保留在您组织的基础设施内。",

  "brand.title": "CoderRupee | 品牌",
  "brand.meta.description": "CoderRupee 品牌指南",
  "brand.heading": "品牌指南",
  "brand.subtitle": "帮助您使用 CoderRupee 品牌的资源和资产。",
  "brand.downloadAll": "下载所有资产",

  "changelog.title": "CoderRupee | 更新日志",
  "changelog.meta.description": "CoderRupee 发布说明和更新日志",
  "changelog.hero.title": "更新日志",
  "changelog.hero.subtitle": "CoderRupee 的新更新和改进",
