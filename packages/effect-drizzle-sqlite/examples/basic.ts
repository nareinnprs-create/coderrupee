...
class Database extends Context.Service<Database, DatabaseShape>()("@coderrupee/example/Database") {
...
class UserStore extends Context.Service<UserStore, UserStoreShape>()("@coderrupee/example/UserStore") {
