...
import {
  ...
  type StatsLabData,
} from "@coderrupee/stats-core/domain/home"
...
export default function StatsLab() {
  ...
  return (
    <main data-page="stats" data-theme={themePreference()}>
      ...
      <Meta property="og:site_name" content="CoderRupee" />
  ...
  return (
    ...
    >
      <div data-slot="lab-model-tooltip-summary">
        ...
        <p>{props.state.model.description ?? "Recent CoderRupee usage, share, context, and output limits."}</p>
      </div>
      <div data-slot="tooltip-divider" />
