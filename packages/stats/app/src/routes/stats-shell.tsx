import coderrupeeWordmarkDark from "../asset/logo-ornate-dark.svg"
...
export const githubLink = {
  ...
  apiHref: "https://api.github.com/repos/coderrupee/coderrupee",
  fallbackStars: "195K",
}
export const themePreferences = ["dark", "light", "system"] as const
export const themeStorageKey = "coderrupee:stats-theme"
    ...
    <header data-component="top" data-menu-open={menuOpen() ? "true" : undefined}>
      <div data-slot="header-bar">
        ...
        <div data-slot="header-actions">
          ...
          <a data-slot="header-button" data-variant="contrast" href="https://coderrupee.ai/">
            <strong>{i18n.t("header.tryCoderRupee")}</strong>
          </a>
          <button
...
function CoderRupeeMark() {
  return (
    <svg data-slot="coderrupee-mark" width="40" height="40" viewBox="0 0 40 40" fill="none" aria-hidden="true">
...
export function Footer(props: {
  ...
  const legal = [
    { href: "https://coderrupee.ai/legal/terms-of-service", label: i18n.t("footer.terms") },
    { href: "https://coderrupee.ai/legal/privacy-policy", label: i18n.t("footer.privacy") },
  ]
  const connect = [
    { href: "mailto:hello@coderrupee.ai", label: i18n.t("footer.contact") },
    { href: "https://coderrupee.ai/discord", label: i18n.t("footer.community") },
    { href: "https://x.com/coderrupee", label: "X" },
    { href: githubLink.href, label: i18n.t("header.github") },
    { href: "https://www.youtube.com/@coderrupee", label: i18n.t("footer.youtube") },
  ]
  const bridge = () =>
  ...
  return (
    <footer data-component="footer">
      ...
      <div data-slot="footer-grid">
        <a data-slot="footer-mark" href="https://coderrupee.ai" aria-label={i18n.t("footer.homeAria")}>
          <CoderRupeeMark />
        </a>
    ...
    <div data-component="subscribe-modal" role="dialog" aria-modal="true" aria-labelledby="subscribe-title">
      ...
      <div data-slot="modal-panel">
        <div data-slot="modal-brand">
          <img data-slot="modal-logo" src={coderrupeeWordmarkDark} alt="CoderRupee" />
          <button
