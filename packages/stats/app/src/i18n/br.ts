export const dict = {
  "app.title": "Ranking de uso de modelos de IA | CoderRupee Data",
  "app.description":
    "Explore o uso do CoderRupee em modelos de IA, incluindo volume de tokens, rankings, participação de mercado, preço por token, custo por sessão, taxa de cache e distribuição geográfica.",
  "app.unfurlAlt": "Logotipo do CoderRupee Data sobre um fundo escuro padronizado",
  ...
  "header.githubAria": "Dar estrela ao CoderRupee no GitHub",
  "header.github": "GitHub",
  "header.tryCoderRupee": "Experimente o CoderRupee",
  ...
  "footer.homeAria": "Início do CoderRupee",
  ...
  "modal.title": "Newsletter do CoderRupee",
  ...
  "home.usageTitle": "Uso",
  "home.topModelsDescription": "Uso de modelos no CoderRupee.",
  ...
  "home.uniqueUsersDescription": "Usuários únicos diários do CoderRupee por modelo.",
  ...
  "lab.title": "Uso e ranking de modelos de IA da {{lab}} | CoderRupee Data",
  "lab.description":
    "Compare modelos da {{lab}} usados no CoderRupee, incluindo uso de tokens, ranking de modelos, janelas de contexto, datas de lançamento, custos e dados específicos de cada modelo.",
  "lab.loadingTitle": "Laboratório de modelos",
  "lab.loadingDescription": "Lendo disponibilidade de modelos e uso recente do CoderRupee.",
  "lab.notFound": "Nenhum modelo correspondeu a este laboratório.",
  "lab.heroPrefix": "Explore {{count}} modelos da {{lab}} usados no CoderRupee",
  ...
  "lab.shareOfUsage": "{{share}} do uso recente do CoderRupee",
  "lab.usageTitle": "Uso de tokens da {{lab}}",
  "lab.usageDescription": "Volume diário de tokens do CoderRupee nos últimos dois meses.",
  ...
  "model.title": "Uso, custo e posição de {{model}} | CoderRupee Data",
  "model.description":
    "Veja dados de uso de {{model}} no CoderRupee, incluindo volume de tokens, ranking semanal, combinação de tokens, custos, taxa de cache, sessões, distribuição geográfica e modelos pares.",
  ...
  "model.catalogFallback":
    "Fatos do modelo do índice compartilhado de modelos. O uso no CoderRupee aparece quando este modelo tiver atividade.",
  "model.unranked": "Sem classificação no uso do CoderRupee da última semana",
  "model.ranked": "Classificado em #{{rank}} no uso do CoderRupee da última semana",
  ...
  "model.noCurrentUsage": "Sem uso do CoderRupee na janela de dados atual.",
  ...
  "model.overviewDescription": "Tokens recentes do CoderRupee, usuários únicos e posição de mercado.",
  "model.noSummaryTitle": "Sem resumo de uso",
  "model.noSummaryDescription": "Este modelo ainda não tem linhas de uso do CoderRupee.",
  "model.tokens": "Tokens",
  ...
  "model.usageDescription": "Volume diário de tokens do CoderRupee na janela recente de dois meses.",
  ...
  "model.usersDescription": "Usuários únicos diários do CoderRupee na janela recente de dois meses.",
  ...
  "model.efficiencyDescription": "Custo, comportamento de cache e formato médio da sessão do CoderRupee.",
  ...
  "model.noGeoDescription": "Nenhuma linha geográfica do CoderRupee correspondeu a este modelo.",
  "model.peersDescription": "Modelos próximos por volume recente de tokens do CoderRupee.",
