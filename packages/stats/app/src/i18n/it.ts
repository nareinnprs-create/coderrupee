export const dict = {
  "app.title": "Classifiche di utilizzo dei modelli IA | CoderRupee Data",
  "app.description":
    "Esplora l'utilizzo di CoderRupee nei modelli IA, inclusi volume di token, classifiche, quota di mercato, prezzi dei token, costo per sessione, rapporto cache e ripartizioni geografiche.",
  "app.unfurlAlt": "Logotipo CoderRupee Data su uno sfondo scuro con motivo",
  ...
  "header.githubAria": "Aggiungi una stella a CoderRupee su GitHub",
  "header.github": "GitHub",
  "header.tryCoderRupee": "Prova CoderRupee",
  ...
  "footer.homeAria": "Home CoderRupee",
  ...
  "home.topModelsDescription": "Utilizzo dei modelli in CoderRupee.",
  ...
  "home.uniqueUsersDescription": "Utenti unici giornalieri di CoderRupee per modello.",
  ...
  "lab.title": "Utilizzo e classifiche dei modelli IA {{lab}} | CoderRupee Data",
  "lab.description":
    "Confronta i modelli {{lab}} usati in CoderRupee, inclusi utilizzo dei token, classifiche dei modelli, finestre di contesto, date di rilascio, costi e dati specifici del modello.",
  "lab.loadingTitle": "Laboratorio modelli",
  "lab.loadingDescription": "Lettura della disponibilità dei modelli e dell'utilizzo recente di CoderRupee.",
  "lab.notFound": "Nessun modello corrispondeva a questo laboratorio.",
  "lab.heroPrefix": "Esplora {{count}} modelli {{lab}} usati in CoderRupee",
  ...
  "lab.shareOfUsage": "{{share}} dell'utilizzo recente di CoderRupee",
  "lab.usageTitle": "Utilizzo token {{lab}}",
  "lab.usageDescription": "Volume giornaliero di token CoderRupee negli ultimi due mesi.",
  ...
  "lab.usage": "Utilizzo",
  "lab.share": "Quota",
  "model.title": "Utilizzo, costo e posizione di {{model}} | CoderRupee Data",
  "model.description":
    "Visualizza i dati di utilizzo di {{model}} in CoderRupee, inclusi volume di token, rango settimanale, mix di token, costi, rapporto cache, sessioni, ripartizioni geografiche e modelli simili.",
  ...
  "model.catalogFallback":
    "Fatti del modello dall'indice condiviso dei modelli. L'utilizzo di CoderRupee appare quando questo modello ha attività.",
  "model.unranked": "Non classificato nell'utilizzo CoderRupee della scorsa settimana",
  "model.ranked": "Posizione #{{rank}} nell'utilizzo CoderRupee della scorsa settimana",
  ...
  "model.noCurrentUsage": "Nessun utilizzo di CoderRupee nella finestra dati attuale.",
  ...
  "model.inputs": "Input",
  "model.overviewDescription": "Token recenti di CoderRupee, utenti unici e posizione di mercato.",
  "model.noSummaryTitle": "Nessun riepilogo di utilizzo",
  "model.noSummaryDescription": "Questo modello non ha ancora righe di utilizzo di CoderRupee.",
  "model.tokens": "Token",
  ...
  "model.usageDescription": "Volume giornaliero di token CoderRupee nella recente finestra di due mesi.",
  ...
  "model.usersDescription": "Utenti unici giornalieri di CoderRupee nella recente finestra di due mesi.",
  ...
  "model.efficiencyDescription": "Costi, comportamento della cache e forma media della sessione CoderRupee.",
  ...
  "model.noGeoDescription": "Nessuna riga geografica CoderRupee corrispondeva a questo modello.",
  "model.peersDescription": "Modelli vicini per volume recente di token CoderRupee.",
