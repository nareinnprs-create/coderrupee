export const dict = {
  "app.title": "Rankingi użycia modeli AI | CoderRupee Data",
  "app.description":
    "Przeglądaj użycie CoderRupee w modelach AI, w tym wolumen tokenów, rankingi, udział w rynku, ceny tokenów, koszt sesji, współczynnik cache i podziały geograficzne.",
  "app.unfurlAlt": "Znak słowny CoderRupee Data na ciemnym wzorzystym tle",
  ...
  "header.githubAria": "Dodaj gwiazdkę CoderRupee na GitHub",
  "header.github": "GitHub",
  "header.tryCoderRupee": "Wypróbuj CoderRupee",
  ...
  "footer.homeAria": "Strona główna CoderRupee",
  ...
  "home.topModelsDescription": "Użycie modeli w CoderRupee.",
  ...
  "home.uniqueUsersDescription": "Dzienni unikalni użytkownicy CoderRupee według modelu.",
  ...
  "lab.title": "Użycie i rankingi modeli AI {{lab}} | CoderRupee Data",
  "lab.description":
    "Porównaj modele {{lab}} używane w CoderRupee, w tym użycie tokenów, rankingi modeli, okna kontekstu, daty wydań, koszty i dane specyficzne dla modeli.",
  "lab.loadingTitle": "Laboratorium modeli",
  "lab.loadingDescription": "Odczytywanie dostępności modeli i ostatniego użycia CoderRupee.",
  "lab.notFound": "Żadne modele nie pasowały do tego laboratorium.",
  "lab.heroPrefix": "Przeglądaj {{count}} modeli {{lab}} używanych w CoderRupee",
  ...
  "lab.shareOfUsage": "{{share}} ostatniego użycia CoderRupee",
  "lab.usageTitle": "Użycie tokenów {{lab}}",
  "lab.usageDescription": "Dzienny wolumen tokenów CoderRupee z ostatnich dwóch miesięcy.",
  ...
  "lab.usage": "Użycie",
  "lab.share": "Udział",
  "model.title": "Użycie, koszt i pozycja {{model}} | CoderRupee Data",
  "model.description":
    "Zobacz dane użycia {{model}} w CoderRupee, w tym wolumen tokenów, tygodniową pozycję, miks tokenów, koszty, współczynnik cache, sesje, podziały geograficzne i podobne modele.",
  ...
  "model.catalogFallback":
    "Fakty modelu ze wspólnego indeksu modeli. Użycie CoderRupee pojawi się, gdy ten model będzie mieć aktywność.",
  "model.unranked": "Bez pozycji w użyciu CoderRupee z zeszłego tygodnia",
  "model.ranked": "Pozycja #{{rank}} w użyciu CoderRupee z zeszłego tygodnia",
  ...
  "model.noCurrentUsage": "Brak użycia CoderRupee w bieżącym oknie danych.",
  ...
  "model.overviewDescription": "Ostatnie tokeny CoderRupee, unikalni użytkownicy i pozycja rynkowa.",
  "model.noSummaryTitle": "Brak podsumowania użycia",
  "model.noSummaryDescription": "Ten model nie ma jeszcze wierszy użycia CoderRupee.",
  "model.tokens": "Tokeny",
  ...
  "model.usageDescription": "Dzienny wolumen tokenów CoderRupee w ostatnim dwumiesięcznym oknie.",
  ...
  "model.usersDescription": "Dzienni unikalni użytkownicy CoderRupee w ostatnim dwumiesięcznym oknie.",
  ...
  "model.efficiencyDescription": "Koszt, zachowanie cache i średni kształt sesji CoderRupee.",
  ...
  "model.noGeoDescription": "Żadne wiersze geograficzne CoderRupee nie pasowały do tego modelu.",
  "model.peersDescription": "Pobliskie modele według ostatniego wolumenu tokenów CoderRupee.",
