...
const en = {
  "app.title": "AI Model Usage Rankings | CoderRupee Data",
  "app.description":
    "Explore CoderRupee usage across AI models, including token volume, rankings, market share, token pricing, session cost, cache ratio, and geo breakdowns.",
  "app.unfurlAlt": "CoderRupee Data wordmark on a dark patterned background",
  ...
  "header.githubAria": "Star CoderRupee on GitHub",
  "header.github": "GitHub",
  "header.tryCoderRupee": "Try CoderRupee",
  ...
  "footer.homeAria": "CoderRupee home",
  ...
  "home.topModelsDescription": "Usage of models across CoderRupee.",
  ...
  "home.uniqueUsersDescription": "Daily unique CoderRupee users by model.",
  ...
  "lab.title": "{{lab}} AI Model Usage & Rankings | CoderRupee Data",
  "lab.description":
    "Compare {{lab}} models used in CoderRupee, including token usage, model rankings, context windows, release dates, costs, and model-specific data.",
  "lab.loadingTitle": "Model Lab",
  "lab.loadingDescription": "Reading model availability and recent CoderRupee usage.",
  "lab.notFound": "No models matched this lab.",
  "lab.heroPrefix": "Explore {{count}} {{lab}} models used in CoderRupee",
  ...
  "lab.shareOfUsage": "{{share}} of recent CoderRupee usage",
  ...
  "lab.usage": "Usage",
  "lab.share": "Share",
  "model.title": "{{model}} Usage, Cost & Rank | CoderRupee Data",
  "model.description":
    "View {{model}} CoderRupee usage data, including token volume, weekly rank, token mix, costs, cache ratio, sessions, geo breakdowns, and peer models.",
  ...
  "model.catalogFallback":
    "Model facts from the shared model index. CoderRupee usage appears once this model has activity.",
  "model.unranked": "Unranked across last week's CoderRupee usage",
  "model.ranked": "Ranked #{{rank}} across last week's CoderRupee usage",
  "model.observedVolume": "with {{share}} of observed 2M volume.",
  "model.weights": "Model weights: {{label}}",
  "model.rank": "7D Rank",
  "model.profile": "Model Profile",
  "model.listed": "Listed",
  "model.noCurrentUsage": "No CoderRupee usage in the current data window.",
  ...
  "model.noSummaryDescription": "This model has no CoderRupee usage rows yet.",
  "model.tokens": "Tokens",
  ...
  "model.noGeoDescription": "No CoderRupee geo rows matched this model.",
  "model.peersDescription": "Nearby models by recent CoderRupee token volume.",
