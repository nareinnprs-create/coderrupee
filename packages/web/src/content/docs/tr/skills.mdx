...
Ajan becerileri, coderrupee'un deponuzdan veya ev dizininizden tekrar kullanilabilir talimatlari kesfetmesini saglar.
...
coderrupee su konumlari tarar:

- Proje konfigurasyonu: `.coderrupee/skills/<name>/SKILL.md`
- Genel konfigurasyon: `~/.config/coderrupee/skills/<name>/SKILL.md`
...
Proje yerel yollarinda coderrupee, mevcut calisma dizininizden baslayip git worktree kokune kadar yukari cikar.
Bu sirada `skills/*/SKILL.md` altindaki eslesen `.coderrupee/` dosyalarini ve `.claude/skills/*/SKILL.md` ya da `.agents/skills/*/SKILL.md` dosyalarini yukler.

Genel tanimlar da `~/.config/coderrupee/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` ve `~/.agents/skills/*/SKILL.md` yollarindan yuklenir.
...
`.coderrupee/skills/git-release/SKILL.md` dosyasini soyle olusturun:
...
coderrupee, `skill` araci aciklamasinda mevcut becerileri listeler.
...
`coderrupee.json` icinde pattern tabanli izinlerle ajanlarin hangi becerilere erisecegini kontrol edin:
...
**Yerlesik ajanlar icin** (`coderrupee.json` icinde):
