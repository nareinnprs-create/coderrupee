---
title: Paylasim
description: coderrupee konusmalarini genel baglantilarla paylasin.
---

coderrupee'un paylasim ozelligi, konusmalariniz icin genel baglantilar olusturmanizi saglar. Boylece ekip arkadaslarinizla birlikte calisabilir veya diger kisilerden yardim alabilirsiniz.
...
Bir konusmayi paylastiginizda coderrupee:
...
coderrupee, konusmalarin nasil paylasilacagini kontrol eden uc farkli paylasim modu sunar:

---

### Manuel (varsayilan)

Varsayilan olarak coderrupee manuel paylasim modunu kullanir. Oturumlar otomatik paylasilmaz, ancak `/share` komutuyla manuel olarak paylasabilirsiniz:
...
Bunu belirli bir projede tum ekip icin zorunlu kilmak icin proje icindeki `coderrupee.json` dosyasina ekleyip Git'e commit edin.
...
Kurulusunuzda coderrupee kullanimi icin [daha fazla bilgi alin](/docs/enterprise).
