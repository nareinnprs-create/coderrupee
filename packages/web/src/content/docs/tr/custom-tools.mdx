---
title: Özel Araçlar
description: LLM'un coderrupee'da çağırabileceği araçları birleştirebilir.
---

Özel araçlar, LLM'un konuşmalar sırasında arayabileceği, oluşturduğunuz işlevlerdir. coderrupee'un [built-in tools](/docs/tools) ile birlikte `read`, `write` ve `bash` gibi çalışırlar.
...
- Yerel olarak bunları projenizin `.coderrupee/tools/` dizinine yerleştirerek.
- Veya küresel olarak bunları `~/.config/coderrupee/tools/` içine yerleştirerek.
