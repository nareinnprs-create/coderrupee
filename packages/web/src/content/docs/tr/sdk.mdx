---
title: SDK
description: coderrupee sunucusu için type-safe JS istemcisi.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

coderrupee JS/TS SDK, sunucu ile etkileşmek için type-safe bir istemci sağlar.
coderrupee'u programatik olarak kontrol etmek ve entegrasyonlar oluşturmak için kullanabilirsiniz.
...
Bir coderrupee örneği oluşturun:
...
Davranışı özelleştirmek için bir yapılandırma nesnesi iletebilirsiniz. Örnek yine de `coderrupee.json` dosyanızı alır, ancak yapılandırmayı satır içi olarak geçersiz kılabilir veya ekleyebilirsiniz:
...
Halihazırda çalışan bir coderrupee örneğiniz varsa, ona bağlanmak için bir istemci örneği oluşturabilirsiniz:
