...
description: coderrupee dile özgü biçimlendiriciler kullanır.
---

coderrupee, dosyaları dile özgü formatlayıcılar kullanılarak yazıldıktan veya düzenlendikten sonra otomatik olarak formatlar. Bu, oluşturulan kodun projenizin kod stillerine uymasını sağlar.

---

## Yerleşik

coderrupee, popüler diller ve çerçeveler için çeşitli yerleşik biçimlendiricilerle birlikte gelir. Aşağıda ihtiyaç duyduğu biçimlendiricilerin, desteklenen dosya uzantılarının ve komutların veya yapılandırma seçeneklerinin bir listesi bulunmaktadır.
...
Yani eğer projenizin `package.json` dosyasında `prettier` varsa, coderrupee bunu otomatik olarak kullanacaktır.

---

## Nasıl çalışır?

coderrupee bir dosyayı yazdığında veya düzenlediğinde:
...
Biçimlendiricileri coderrupee yapılandırmanızdaki `formatter` bölümü aracılığıyla özelleştirebilirsiniz.
