...
`.coderrupee/commands/test.md` oluştur:
...
coderrupee işlemleri aracılığıyla veya `commands/` dizininde işaretleme dosyalarının oluşturulması özel komutlar ile yapılabilir.

---

### JSON

coderrupee [config](/docs/config)'deki `command` seçeneğini kullanın:
...
- Küresel: `~/.config/coderrupee/commands/`
- Proje başına: `.coderrupee/commands/`
...
coderrupee, `/init`, `/undo`, `/redo`, `/share`, `/help` gibi çeşitli yerleşik komutlar içerir; [learn more](/docs/tui#commands).
