...
CoderRupee Go คือการสมัครสมาชิกในราคาประหยัด **$10/เดือน** ซึ่งให้คุณเข้าถึงโมเดลโอเพนซอร์สยอดนิยมสำหรับการเขียนโค้ดได้อย่างเสถียร

Go ทำงานเหมือนกับผู้ให้บริการ (provider) รายอื่นๆ ใน CoderRupee คุณสามารถสมัครสมาชิก CoderRupee Go และรับ API key ของคุณ บริการนี้เป็น**ทางเลือกเพิ่มเติม** และคุณไม่จำเป็นต้องใช้มันเพื่อใช้งาน CoderRupee
...
:::tip
เราได้ทดสอบกลุ่มโมเดลและผู้ให้บริการที่คัดเลือกมาเพื่อให้ทำงานร่วมกับ CoderRupee ได้เป็นอย่างดี
:::
...
CoderRupee Go ให้คุณเข้าถึงโมเดลเหล่านี้ได้ในราคา **$10/เดือน**

---

## How it works

CoderRupee Go ทำงานเหมือนกับผู้ให้บริการรายอื่นๆ ใน CoderRupee

1. ลงชื่อเข้าใช้ที่ **<a href={console}>CoderRupee Zen</a>**, สมัครสมาชิก Go และคัดลอก API key ของคุณ
2. รันคำสั่ง `/connect` ใน TUI, เลือก `CoderRupee Go`, และวาง API key ของคุณ
3. รัน `/models` ใน TUI เพื่อดูรายชื่อโมเดลที่ใช้งานได้ผ่าน Go

:::note
มีเพียงสมาชิกหนึ่งคนต่อ workspace เท่านั้นที่สามารถสมัครสมาชิก CoderRupee Go ได้
:::
...
CoderRupee Go มีขีดจำกัดดังต่อไปนี้:
...
[model id](/docs/config/#models) ใน CoderRupee config ของคุณจะใช้รูปแบบ `coderrupee-go/<model-id>` ตัวอย่างเช่น สำหรับ Kimi K3 คุณจะใช้ `coderrupee-go/kimi-k3` ใน config ของคุณ
...
4. **ไม่ผูกขาดการใช้งาน (no lock-in)** โดยอนุญาตให้คุณใช้งานผู้ให้บริการรายอื่นๆ ร่วมกับ CoderRupee ได้เช่นกัน
