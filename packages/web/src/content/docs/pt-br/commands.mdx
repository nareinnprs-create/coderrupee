...
Crie `.coderrupee/commands/test.md`:
...
Você pode adicionar comandos personalizados através da configuração do coderrupee ou criando arquivos markdown no diretório `commands/`.

---

### JSON

Use a opção `command` na sua [configuração](/docs/config) do coderrupee:
...
- Por projeto: `.coderrupee/commands/`
...
coderrupee inclui vários comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [saiba mais](/docs/tui#commands).
