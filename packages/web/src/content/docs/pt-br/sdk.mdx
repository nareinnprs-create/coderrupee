---
title: SDK
description: Cliente JS seguro em tipos para o servidor coderrupee.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

O SDK JS/TS do coderrupee fornece um cliente seguro em tipos para interagir com o servidor.
Use-o para construir integrações e controlar o coderrupee programaticamente.
...
Crie uma instância do coderrupee:
...
Você pode passar um objeto de configuração para personalizar o comportamento. A instância ainda pega seu `coderrupee.json`, mas você pode substituir ou adicionar configuração inline:
...
Se você já tem uma instância do coderrupee em execução, pode criar uma instância de cliente para se conectar a ela:
