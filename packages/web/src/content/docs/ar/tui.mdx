---
title: TUI
description: استخدام واجهة المستخدم TUI في CoderRupee.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

يوفّر CoderRupee واجهة terminal تفاعلية (TUI) للعمل على مشاريعك باستخدام LLM.

يؤدي تشغيل CoderRupee إلى بدء واجهة TUI للدليل الحالي.
...
عند استخدام واجهة CoderRupee في terminal، يمكنك كتابة `/` متبوعة باسم أمر لتنفيذ الإجراءات بسرعة. مثلا:
...
أضف موفّرا إلى CoderRupee. يتيح لك اختيار أحد الموفّرين المتاحين وإضافة مفاتيح API الخاصة بهم.
...
اخرج من CoderRupee. _الأسماء المستعارة_: `/quit`, `/q`
...
هذا منفصل عن `coderrupee.json`، الذي يضبط سلوك الخادم ووقت التشغيل.
...
- `leader_timeout` - يتحكم في مدة انتظار CoderRupee بعد الضغط على leader key. القيمة الافتراضية `2000`.
...
- `sound_pack` - sound pack ID المراد استخدامه. القيمة الافتراضية `coderrupee.default`.
