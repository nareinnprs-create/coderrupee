...
مع CoderRupee يمكنك الاختيار من بين عدة سمات مدمجة، أو استخدام سمة تتكيّف مع سمة terminal لديك، أو تعريف سمة مخصصة خاصة بك.

افتراضيًا، يستخدم CoderRupee سمتنا `coderrupee`.
...
يأتي CoderRupee مع عدة سمات مدمجة.
...
- يريدون أن يطابق CoderRupee مظهر terminal لديهم
...
يدعم CoderRupee نظام سمات مرنًا قائمًا على JSON يتيح للمستخدمين إنشاء السمات وتخصيصها بسهولة.
...
2. **مجلد ضبط المستخدم** - معرّف في `~/.config/coderrupee/themes/*.json` أو `$XDG_CONFIG_HOME/coderrupee/themes/*.json`
3. **مجلد جذر المشروع** - معرّف في `<project-root>/.coderrupee/themes/*.json`
4. **مجلد العمل الحالي** - معرّف في `./.coderrupee/themes/*.json`
