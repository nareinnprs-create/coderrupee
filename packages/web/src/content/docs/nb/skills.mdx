...
Agentferdigheter lar CoderRupee oppdage gjenbrukbare instruksjoner fra repo- eller hjemmekatalogen din.
...
coderrupee søker etter disse stedene:

- Prosjektkonfigurasjon: `.coderrupee/skills/<name>/SKILL.md`
- Global konfigurasjon: `~/.config/coderrupee/skills/<name>/SKILL.md`
...
For prosjektlokale stier går coderrupee opp fra din nåværende arbeidskatalog til den når git-arbeidstreet.
Den laster alle matchende `skills/*/SKILL.md` i `.coderrupee/` og alle matchende `.claude/skills/*/SKILL.md` eller `.agents/skills/*/SKILL.md` underveis.

Globale definisjoner lastes også inn fra `~/.config/coderrupee/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` og `~/.agents/skills/*/SKILL.md`.
...
Lag `.coderrupee/skills/git-release/SKILL.md` slik:
...
coderrupee viser tilgjengelige ferdigheter i `skill`-verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved å bruke mønsterbaserte tillatelser i `coderrupee.json`:
...
**For innebygde agenter** (i `coderrupee.json`):
