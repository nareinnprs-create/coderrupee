---
title: TUI
description: Bruke coderrupee-terminalbrukergrensesnittet.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CoderRupee gir et interaktivt terminalgrensesnitt (TUI) for å jobbe med prosjektene dine med en LLM.

Å kjøre CoderRupee starter TUI for gjeldende katalog.
...
Når du bruker CoderRupee TUI, kan du skrive `/` etterfulgt av et kommandonavn for raskt å utføre handlinger. For eksempel:
...
Legg til en leverandør til CoderRupee. Lar deg velge fra tilgjengelige leverandører og legge til deres API-nøkler.
...
Avslutt CoderRupee. _Aliaser_: `/quit`, `/q`
...
Dette er atskilt fra `coderrupee.json`, som konfigurerer server-/kjøretidsoppførsel.
...
- `leader_timeout` - Styrer hvor lenge CoderRupee venter etter leader key. Standard er `2000`.
...
- `sound_pack` - Sound pack-ID som skal brukes. Standard er `coderrupee.default`.
