...
Opprett `.coderrupee/commands/test.md`:
...
Du kan legge til egendefinerte kommandoer gjennom CoderRupee-konfigurasjonen eller ved å lage markdown-filer i katalogen `commands/`.

---

### JSON

Bruk alternativet `command` i CoderRupee [config](/docs/config):
...
- Per prosjekt: `.coderrupee/commands/`
...
CoderRupee inkluderer flere innebygde kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [finn ut mer](/docs/tui#commands).
