...
CoderRupee har en liste over tastebindinger som du kan tilpasse gjennom `tui.json`.
...
CoderRupee bruker en `leader`-tast for de fleste tastebindinger. Dette unngår konflikter i terminalen din.
...
Prompt-feltet for CoderRupee-skrivebordsappen støtter vanlige snarveier i Readline/Emacs-stil for redigering av tekst. Disse er innebygd og foreløpig ikke konfigurerbare via `coderrupee.json`.
