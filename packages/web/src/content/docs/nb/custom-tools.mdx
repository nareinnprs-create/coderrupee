...
description: Lag verktøy som LLM kan kalle inn CoderRupee.
---

Egendefinerte verktøy er funksjoner du oppretter som LLM kan kalle under samtaler. De fungerer sammen med CoderRupee sine [innebygde verktøy](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved å plassere dem i `.coderrupee/tools/`-katalogen til prosjektet ditt.
- Eller globalt, ved å plassere dem i `~/.config/coderrupee/tools/`.
