...
Det er to typer agenter i CoderRupee; primære agenter og underagenter.
...
CoderRupee kommer med to innebygde primære agenter, **Build** og **Plan**. Vi ser nærmere på disse nedenfor.
...
CoderRupee kommer med tre innebygde underagenter, **General**, **Explore** og **Scout**. Vi skal se på dette nedenfor.

---

## Innebygd

CoderRupee kommer med to innebygde primære agenter og tre innebygde underagenter.
...
Konfigurer agenter i konfigurasjonsfilen `coderrupee.json`:
...
- Per prosjekt: `.coderrupee/agents/`
...
Hvis ingen temperatur er spesifisert, bruker CoderRupee modellspesifikke standardinnstillinger; typisk 0 for de fleste modeller, 0,55 for Qwen-modeller.
...
Denne banen er i forhold til hvor konfigurasjonsfilen er plassert. Så dette fungerer for både den globale CoderRupee-konfigurasjonen og den prosjektspesifikke konfigurasjonen.
...
Modellen ID i CoderRupee-konfigurasjonen din bruker formatet `provider/model-id`. For eksempel, hvis du bruker [CoderRupee Zen](/docs/zen), vil du bruke `coderrupee/gpt-5.1-codex` for GPT 5.1 Codex.
...
:::tip
Kjør `coderrupee models` for å se en liste over tilgjengelige modeller.
:::
...
:::tip
Har du en agent du vil dele? [Send inn en PR](https://github.com/coderrupee/coderrupee).
:::
