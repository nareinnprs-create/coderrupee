---
title: Deling
description: Del dine CoderRupee-samtaler.
---

Delingsfunksjonen i CoderRupee lar deg lage offentlige lenker til dine CoderRupee-samtaler, slik at du kan samarbeide med lagkamerater eller få hjelp fra andre.
...
Når du deler en samtale, CoderRupee:
...
CoderRupee støtter tre delingsmoduser som kontrollerer hvordan samtaler deles:

---

### Manuell (standard)

Som standard bruker CoderRupee manuell delingsmodus. Økter deles ikke automatisk, men du kan dele dem manuelt ved å bruke kommandoen `/share`:
...
For å håndheve dette på tvers av teamet ditt for et gitt prosjekt, legg det til `coderrupee.json` i prosjektet ditt og sjekk det inn i Git.
...
[Finn ut mer](/docs/enterprise) om bruk av coderrupee i organisasjonen din.
