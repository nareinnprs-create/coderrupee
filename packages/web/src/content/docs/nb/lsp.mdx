---
title: LSP-servere
description: coderrupee integreres med LSP-serverne dine.
---

CoderRupee kan integreres med Language Server Protocol (LSP)-servere for å bruke diagnostikk som tilbakemelding til agenten.

---

## Innebygde servere

CoderRupee kommer med flere innebygde LSP-servere for populære språk:
...
:::note
Du kan deaktivere automatiske LSP-servernedlastinger ved å sette miljøvariabelen `CODERRUPEE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktivert og coderrupee åpner en fil, gjør den:
...
Du kan aktivere og tilpasse LSP-servere gjennom `lsp`-delen i CoderRupee-konfigurasjonen.
