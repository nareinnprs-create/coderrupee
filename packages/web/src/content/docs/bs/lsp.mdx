---
title: LSP serveri
description: CoderRupee se integriše sa vašim LSP serverima.
---

CoderRupee se može integrisati sa Language Server Protocol (LSP) serverima kako bi koristio dijagnostiku kao feedback za agenta.

## Ugrađeni

CoderRupee dolazi sa nekoliko ugrađenih LSP servera za popularne jezike:
...
:::note
Možete onemogućiti automatska preuzimanja LSP servera tako što ćete postaviti varijablu okruženja `CODERRUPEE_DISABLE_LSP_DOWNLOAD` na `true`.
:::
...
Kada je LSP omogućen i coderrupee otvori fajl, on:
...
Možete omogućiti i prilagoditi LSP servere kroz `lsp` odjeljak u vašoj coderrupee konfiguraciji.
