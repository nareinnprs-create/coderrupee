...
Kreiraj `.coderrupee/commands/test.md`:
...
Možete dodati prilagođene komande kroz CoderRupee konfiguraciju ili kreiranjem markdown datoteka u direktoriju `commands/`.

---

### JSON

Koristite opciju `command` u svom CoderRupee [config](/docs/config):
...
- Globalno: `~/.config/coderrupee/commands/`
- Po projektu: `.coderrupee/commands/`
...
CoderRupee uključuje nekoliko ugrađenih naredbi kao što su `/init`, `/undo`, `/redo`, `/share`, `/help`; [saznaj više](/docs/tui#commands).
:::note
