...
Agent skills omogucavaju CoderRupee da pronade uputstva koja se mogu ponovo koristiti iz repozitorija ili home direktorija.
...
CoderRupee pretrazuje ove lokacije:

- Konfiguracija projekta: `.coderrupee/skills/<name>/SKILL.md`
- Globalna konfiguracija: `~/.config/coderrupee/skills/<name>/SKILL.md`
...
Za projektne lokalne putanje, CoderRupee ide prema gore od trenutnog radnog direktorija dok ne dode do git worktree-ja.
Usput ucitava sve odgovarajuce `skills/*/SKILL.md` u `.coderrupee/` i odgovarajuce `.claude/skills/*/SKILL.md` ili `.agents/skills/*/SKILL.md`.

Globalne definicije se takoder ucitavaju iz `~/.config/coderrupee/skills/*/SKILL.md`, `~/.claude/skills/*/SKILL.md` i `~/.agents/skills/*/SKILL.md`.
...
Kreirajte `.coderrupee/skills/git-release/SKILL.md` ovako:
...
CoderRupee navodi dostupne skills u opisu `skill` alata.
...
Kontrolisite kojim skills agenti mogu pristupiti pomocu dozvola baziranih na obrascima u `coderrupee.json`:
...
**Za ugradene agente** (u `coderrupee.json`):
