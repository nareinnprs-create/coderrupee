...
Utwórz `.coderrupee/commands/test.md`:
...
Możesz zdefiniować polecenia w `coderrupee.json` lub w plikach w katalogu `commands/`.

---

### JSON

Użyj opcji `command` w swojej konfiguracji coderrupee:
...
- Globalnie: `~/.config/coderrupee/commands/`
- Na projekt: `.coderrupee/commands/`
...
coderrupee zawiera kilka wbudowanych poleceń, takich jak `/init`, `/undo`, `/redo`, `/share`, `/help`; [dowiedz się więcej](/docs/tui#commands).
