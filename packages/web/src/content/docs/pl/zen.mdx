---
title: Zen
description: Wyselekcjonowana lista modeli dostarczonych przez CoderRupee.
---
...
CoderRupee Zen to lista przetestowanych i zweryfikowanych modeli udostępniana przez zespół CoderRupee.

Zen działa jak każdy inny dostawca w CoderRupee. Logujesz się do CoderRupee Zen i otrzymujesz
...
:::tip
Przetestowaliśmy wybraną grupę modeli i dostawców, którzy dobrze współpracują z CoderRupee.
:::
...
CoderRupee Zen to brama AI, która daje dostęp do tych modeli.

---

## Jak to działa

CoderRupee Zen działa jak każdy inny dostawca w CoderRupee.

1. Logujesz się do **<a href={console}>CoderRupee Zen</a>**, dodajesz dane
   rozliczeniowe i kopiujesz swój klucz API.
2. Uruchamiasz polecenie `/connect` w TUI, wybierasz CoderRupee Zen i wklejasz swój klucz API.
...
[ID modelu](/docs/config/#models) w Twojej konfiguracji CoderRupee używa formatu
`coderrupee/<model-id>`. Na przykład dla GPT 5.5 użyjesz w konfiguracji
`coderrupee/gpt-5.5`.
...
W historii użycia możesz zauważyć [niedrogie modele](/docs/config/#models), takie jak Haiku, Nano lub Flash. CoderRupee używa tych modeli do generowania tytułów sesji.
...
- MiMo-V2.5 Free jest dostępny w CoderRupee przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Ling 3.0 Flash Fin Free jest dostępny w CoderRupee przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3 Ultra Free jest dostępny w CoderRupee przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Nemotron 3.5 Lightning Free jest dostępny w CoderRupee przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Big Pickle to stealth model, który jest darmowy w CoderRupee przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
- Muse Spark 1.2 Contributor Free jest dostępny w CoderRupee przez ograniczony czas. Zespół wykorzystuje ten czas do zbierania opinii i ulepszania modelu.
...
Stworzyliśmy CoderRupee Zen, aby:
...
4. Nie tworzyć **lock-in**, pozwalając używać tego z dowolnym innym agentem kodującym. I zawsze pozwalać Ci używać w CoderRupee także dowolnego innego dostawcy.
