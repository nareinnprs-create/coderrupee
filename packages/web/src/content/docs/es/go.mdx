...
CoderRupee Go es una suscripción de bajo costo de **$10/mes** que te brinda acceso confiable a modelos abiertos de programación populares.

Go funciona como cualquier otro proveedor en CoderRupee. Te suscribes a CoderRupee Go y
...
CoderRupee Go te da acceso a estos modelos por **$10/mes**.

---

## Cómo funciona

CoderRupee Go funciona como cualquier otro proveedor en CoderRupee.

1. Inicias sesión en **<a href={console}>CoderRupee Zen</a>**, te suscribes a Go y
   copias tu API key.
2. Ejecutas el comando `/connect` en la TUI, seleccionas `CoderRupee Go` y pegas
   tu API key.
3. Ejecutas `/models` en la TUI para ver la lista de modelos disponibles a través de Go.

:::note
Solo un miembro por espacio de trabajo puede suscribirse a CoderRupee Go.
:::
...
CoderRupee Go incluye los siguientes límites:
...
El [ID del modelo](/docs/config/#models) en tu configuración de CoderRupee
usa el formato `coderrupee-go/<model-id>`. Por ejemplo, para Kimi K3, usarías
`coderrupee-go/kimi-k3` en tu configuración.
...
4. Evitar la **dependencia (lock-in)** al permitirte usar también cualquier otro proveedor con CoderRupee.
