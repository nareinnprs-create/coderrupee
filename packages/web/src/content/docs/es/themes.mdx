...
Con CoderRupee puede seleccionar uno de varios temas integrados, usar un tema que se adapte al tema de su terminal o definir su propio tema personalizado.

De forma predeterminada, CoderRupee usa nuestro propio tema `coderrupee`.
...
CoderRupee viene con varios temas integrados.
...
- Quiere que CoderRupee coincida con la apariencia de su terminal
...
CoderRupee admite un sistema de temas flexible basado en JSON que permite a los usuarios crear y personalizar temas fácilmente.
...
2. **Directorio de configuración de usuario**: definido en `~/.config/coderrupee/themes/*.json` o `$XDG_CONFIG_HOME/coderrupee/themes/*.json`
3. **Directorio raíz del proyecto**: definido en `<project-root>/.coderrupee/themes/*.json`
4. **Directorio de trabajo actual** - Definido en `./.coderrupee/themes/*.json`
