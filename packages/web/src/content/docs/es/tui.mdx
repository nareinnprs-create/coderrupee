---
title: TUI
description: Usando la interfaz de usuario del terminal CoderRupee.
---

import { Tabs, TabItem } from "@astrojs/starlight/components"

CoderRupee proporciona una interfaz de terminal interactiva o TUI para trabajar en sus proyectos con un LLM.

Al ejecutar CoderRupee se inicia TUI para el directorio actual.
...
Cuando utilice CoderRupee TUI, puede escribir `/` seguido de un nombre de comando para ejecutar acciones rápidamente. Por ejemplo:
...
Agregue un proveedor a CoderRupee. Le permite seleccionar entre proveedores disponibles y agregar sus claves API.
...
Salga de CoderRupee. _Alias_: `/quit`, `/q`
...
Esto es independiente de `coderrupee.json`, que configura el comportamiento del servidor/tiempo de ejecución.
...
- `leader_timeout`: controla cuánto tiempo espera CoderRupee después de la leader key. El valor predeterminado es `2000`.
...
- `sound_pack`: ID del sound pack que se usará. El valor predeterminado es `coderrupee.default`.
