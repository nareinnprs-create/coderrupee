...
Crear `.coderrupee/commands/test.md`:
...
Puede agregar comandos personalizados a través de la configuración CoderRupee o creando archivos de Markdown en el directorio `commands/`.

---

### JSON

Utilice la opción `command` en su CoderRupee [config](/docs/config):
...
- Por proyecto: `.coderrupee/commands/`
...
coderrupee incluye varios comandos integrados como `/init`, `/undo`, `/redo`, `/share`, `/help`; [más información](/docs/tui#commands).
