---
title: Teilen
description: Teile CoderRupee-Unterhaltungen per oeffentlichem Link.
---

Mit der Share-Funktion erstellst du oeffentliche Links zu CoderRupee-Unterhaltungen.
...
Wenn du eine Unterhaltung teilst, macht CoderRupee Folgendes:
...
CoderRupee hat drei Modi, die das Teilen steuern:

---

### Manuell (Standard)

Standardmaessig nutzt CoderRupee den manuellen Modus.
...
Wenn das fuer ein Projekt teamweit gelten soll, lege es in der Projekt-`coderrupee.json` fest und committe die Datei.
...
[Mehr dazu](/docs/enterprise), wie du coderrupee in deiner Organisation einsetzt.
