---
title: SDK
description: Typsicherer JS-Client fuer den coderrupee-Server.
---

import config from "../../../../config.mjs"
export const typesUrl = `${config.github}/blob/dev/packages/sdk/js/src/gen/types.gen.ts`

Das coderrupee JS/TS SDK bietet einen typsicheren Client fuer die Server-API.
Damit kannst du Integrationen bauen und coderrupee programmatisch steuern.
...
Erstelle eine coderrupee-Instanz:
...
`coderrupee.json` wird weiterhin geladen, kann aber inline ueberschrieben oder erweitert werden:
...
Wenn coderrupee bereits laeuft, kannst du nur einen Client erstellen und verbinden:
