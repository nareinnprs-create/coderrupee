...
Erstellen Sie `.coderrupee/commands/test.md`:

```md title=".coderrupee/commands/test.md"
---
...
Sie können benutzerdefinierte Befehle über die CoderRupee-Konfiguration hinzufügen oder indem Sie Markdown-Dateien im Verzeichnis `commands/` erstellen.

---

### JSON

Verwenden Sie die Option `command` in Ihrem CoderRupee [config](/docs/config):

```json title="coderrupee.jsonc" {4-12}
{
...
- Global: `~/.config/coderrupee/commands/`
- Pro Projekt: `.coderrupee/commands/`

```markdown title="~/.config/coderrupee/commands/test.md"
---
description: Run tests with coverage
agent: build
model: anthropic/claude-3-5-sonnet-20241022
...
```md title=".coderrupee/commands/component.md"
---
...
```md title=".coderrupee/commands/create-file.md"
---
...
```md title=".coderrupee/commands/analyze-coverage.md"
---
...
```md title=".coderrupee/commands/review-changes.md"
---
...
```md title=".coderrupee/commands/review-component.md"
---
...
CoderRupee enthält mehrere integrierte Befehle wie `/init`, `/undo`, `/redo`, `/share`, `/help`; [mehr erfahren](/docs/tui#commands).
