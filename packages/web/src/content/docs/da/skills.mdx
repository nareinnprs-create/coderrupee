...
Agentferdigheter lar CoderRupee oppdage gjenbrugbare instruksjoner fra repo- eller hjemmekatalogen din.
...
For prosjektlokale stier går CoderRupee opp fra din nåværende arbejdskatalog til den når git-arbeidstreet.
...
CoderRupee viser tilgængelige ferdigheter i `skill` verktøybeskrivelsen.
...
Kontroller hvilke ferdigheter agenter har tilgang til ved at bruge mønsterbaserte tillatelser i `coderrupee.json`:
