...
CoderRupee Go er et lavprisabonnement til **$10/måned**, der giver dig pålidelig adgang til populære åbne kodningsmodeller.

Go fungerer som enhver anden udbyder i CoderRupee. Du abonnerer på CoderRupee Go og
...
:::tip
Vi testede en udvalgt gruppe af modeller og udbydere, der fungerer godt med CoderRupee.
:::
...
CoderRupee Go giver dig adgang til disse modeller for **$10/måned**.

---

## Sådan fungerer det

CoderRupee Go fungerer som enhver anden udbyder i CoderRupee.

1. Du logger ind på **<a href={console}>CoderRupee Zen</a>**, abonnerer på Go, og
   kopierer din API-nøgle.
2. Du kører kommandoen `/connect` i TUI'en, vælger `CoderRupee Go`, og indsætter
   din API-nøgle.
3. Kør `/models` i TUI'en for at se listen over tilgængelige modeller gennem Go.

:::note
Kun ét medlem per arbejdsområde kan abonnere på CoderRupee Go.
:::
...
CoderRupee Go inkluderer følgende grænser:
...
Dit [model id](/docs/config/#models) i din CoderRupee config
bruger formatet `coderrupee-go/<model-id>`. For eksempel for Kimi K3, vil du
bruge `coderrupee-go/kimi-k3` i din config.
...
Vi skabte CoderRupee Go for at:
...
4. Undgå **lock-in** ved også at lade dig bruge enhver anden udbyder med CoderRupee.
