...
description: Opret værktøjer, som LLM kan kalde coderrupee ind.
---

Brugerdefinerede værktøjer er funktioner, du opretter, som LLM kan kalde under samtaler. De arbejder sammen med coderrupees [built-in tools](/docs/tools) som `read`, `write` og `bash`.
...
- Lokalt ved at placere dem i biblioteket `.coderrupee/tools/` i dit projekt.
- Eller globalt ved at placere dem i `~/.config/coderrupee/tools/`.
