---
title: LSP-servere
description: CoderRupee integreres med dine LSP-servere.
---

CoderRupee kan integreres med Language Server Protocol (LSP)-servere for at bruge diagnostik som feedback til agenten.

---

## Indbyggede

CoderRupee leveres med flere indbyggede LSP-servere til populære sprog:
...
:::note
Du kan deaktivere automatisk LSP-serverdownloads ved at indstille miljøvariablen `CODERRUPEE_DISABLE_LSP_DOWNLOAD` til `true`.
:::
...
Når LSP er aktiveret, og coderrupee åbner en fil, vil den:
...
Du kan aktivere og tilpasse LSP-servere gennem sektionen `lsp` i din coderrupee-konfiguration.
