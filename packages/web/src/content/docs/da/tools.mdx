...
Her er alle de innebygde verktøyene som er tilgængelige i CoderRupee.
...
:::note
Dette verktøyet er bare tilgængelig når `CODERRUPEE_EXPERIMENTAL_LSP_TOOL=true` (eller `CODERRUPEE_EXPERIMENTAL=true`).
:::
...
:::note
Dette verktøyet er bare tilgængelig når du bruger CoderRupee-leverandøren eller når miljøvariabelen `CODERRUPEE_ENABLE_EXA` er satt til en sannverdi (f.eks. `true` eller `1`).
