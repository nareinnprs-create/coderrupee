...
Brug den til at bygge integrasjoner og kontrollere coderrupee programmatisk.
...
Opret en forekomst av coderrupee:
...
Du kan sende et konfigurasjonsobjekt for at tilpasse virkemåten. Forekomsten henter fortsatt din `coderrupee.json`, men du kan overstyre eller tilføje til konfigurasjon inline:
...
Hvis du allerede har en kjørende forekomst av coderrupee, kan du oprete en klientforekomst for at koble til den:
