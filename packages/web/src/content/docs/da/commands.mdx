...
Opret `.coderrupee/commands/test.md`:
...
Du kan tilføje brugerdefinerede kommandoer gennem CoderRupee-konfigurationen eller ved at oprette markdown-filer i `commands/`-mappen.

---

### JSON

Brug indstillingerne `command` i din CoderRupee [config](/docs/config):
...
- Globalt: `~/.config/coderrupee/commands/`
- Pr. projekt: `.coderrupee/commands/`
...
coderrupee indeholder flere indbyggede kommandoer som `/init`, `/undo`, `/redo`, `/share`, `/help`; [learn more](/docs/tui#commands).
