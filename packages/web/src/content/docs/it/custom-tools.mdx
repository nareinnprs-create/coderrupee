...
description: Crea strumenti che l'LLM puo chiamare in coderrupee.
---

Gli strumenti personalizzati sono funzioni che crei e che l'LLM puo chiamare durante le conversazioni. Funzionano insieme agli [strumenti integrati](/docs/tools) di coderrupee come `read`, `write` e `bash`.
...
- In locale, mettendoli nella directory `.coderrupee/tools/` del progetto.
- Oppure in globale, mettendoli in `~/.config/coderrupee/tools/`.
