...
Crea `.coderrupee/commands/test.md`:
...
Puoi aggiungere comandi personalizzati tramite la config di CoderRupee o creando file markdown nella directory `commands/`.

---

### JSON

Usa l'opzione `command` nella [config](/docs/config) di CoderRupee:
...
- Globale: `~/.config/coderrupee/commands/`
- Per progetto: `.coderrupee/commands/`
...
coderrupee include diversi comandi integrati come `/init`, `/undo`, `/redo`, `/share`, `/help`; [scopri di piu](/docs/tui#commands).
