...
import { isSessionNotFoundError, isUnauthorizedError, CoderRupee } from "../src"

test("exposes every standard HTTP API group", () => {
  const client = CoderRupee.make({ baseUrl: "http://localhost:3000" })
