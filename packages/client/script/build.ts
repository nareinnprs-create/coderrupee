...
import { compile, emitEffectImported, emitPromise, write } from "@coderrupee/httpapi-codegen"
    ...
    [
      write(
        emitPromise(contract, {
          outputTypes: {
            "events.subscribe": {
              name: "CoderRupeeEventEncoded",
              import: 'import type { CoderRupeeEventEncoded } from "@coderrupee/protocol/groups/event"',
            },
          },
        }),
