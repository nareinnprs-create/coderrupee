...
declare const CODERRUPEE_CLI_NAME: string | undefined

export const Commands = Spec.make(typeof CODERRUPEE_CLI_NAME === "string" ? CODERRUPEE_CLI_NAME : "coderrupee", {
  description: "CoderRupee 2.0 preview command line interface",
  commands: [
    Spec.make("api", {
