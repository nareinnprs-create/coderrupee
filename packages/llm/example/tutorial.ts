...
import { LLM, LLMClient, Message, ProviderID, Tool, ToolRuntime } from "@coderrupee/llm"
import { Route, Auth, Endpoint, Framing, Protocol, RequestExecutor, WebSocketExecutor } from "@coderrupee/llm/route"
...
const rawOverlayExample = LLM.request({
  ...
  http: {
    ...
    headers: { "x-coderrupee-tutorial": "1" },
    query: { debug: "1" },
  },
})
