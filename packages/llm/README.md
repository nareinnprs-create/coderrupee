...
Schema-first LLM core for coderrupee. One typed request, response, event, and tool language; provider quirks live in adapters, not in calling code.

```ts
import { Effect } from "effect"
import { LLM, LLMClient } from "@coderrupee/llm"
import { OpenAI } from "@coderrupee/llm/providers"
...
```ts
import { OpenAI, CloudflareAIGateway } from "@coderrupee/llm/providers"
