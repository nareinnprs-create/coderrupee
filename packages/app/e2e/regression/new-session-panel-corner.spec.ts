...
const directory = "C:/CoderRupee/NewSessionPanelCorner"
...
test("matches the rounded panel corners to the dark new-session background", async ({ page }, testInfo) => {
  ...
  await page.addInitScript(
    ({ directory, draftID, server }) => {
      ...
      localStorage.setItem("coderrupee-theme-id", "coderrupee")
      localStorage.setItem("coderrupee-color-scheme", "dark")
