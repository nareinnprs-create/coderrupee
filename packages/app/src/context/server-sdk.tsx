import type { CoderRupeeEvent } from "@coderrupee/client/promise"
import type { Event } from "@coderrupee/sdk/v2/client"
...
export type ServerEvent = Event & { current?: CoderRupeeEvent }
...
export function adaptServerEvent(event: CoderRupeeEvent): ServerEvent {
...
function currentDelta(event: CoderRupeeEvent | undefined): CurrentDelta | undefined {
  if (
