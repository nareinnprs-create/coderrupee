import type { CoderRupeeEvent, SessionMessageInfo, SessionPendingMessage } from "@coderrupee/client/promise"
...
export function createV2SessionReducer() {
  ...
  const reduce = (source: readonly SessionMessageInfo[], event: CoderRupeeEvent): V2SessionReduction | undefined => {
