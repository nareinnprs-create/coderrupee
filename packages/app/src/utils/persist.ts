...
const GLOBAL_STORAGE = "coderrupee.global.dat"
const WINDOW_STORAGE = "coderrupee.window"
const LOCAL_PREFIX = "coderrupee."
...
function workspaceStorage(dir: string) {
  ...
  return `coderrupee.workspace.${head}.${sum}.dat`
}
...
function draftStorage(draftID: string) {
  ...
  return `coderrupee.draft.${head}.${sum}.dat`
}
