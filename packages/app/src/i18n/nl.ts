export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee-documentatie",
  ...
  "desktop.recovery.loadFailed": "CoderRupee kan niet worden geladen",
  "desktop.recovery.terminated": "Het CoderRupee-venster is onverwacht beëindigd",
  "desktop.recovery.unresponsive": "CoderRupee reageert niet",
  ...
  "desktop.wsl.error.installOpencode": "Installatie van CoderRupee is mislukt",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is al toegevoegd",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee is niet geïnstalleerd in deze distributie",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee is geïnstalleerd, maar kan niet worden uitgevoerd",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee is niet geïnstalleerd in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "De CoderRupee-update is voltooid, maar {{distro}} meldt nog steeds {{installed}}; verwacht: {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Samengestelde modellen, waaronder Claude, GPT, Gemini en meer",
  "dialog.provider.coderrupee.tagline": "Betrouwbare geoptimaliseerde modellen",
  "dialog.provider.coderrupeeGo.tagline": "Goedkoop abonnement voor iedereen",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modellen geleverd door CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Voer je {{provider}}-API-sleutel in om je account te koppelen en {{provider}}-modellen in CoderRupee te gebruiken.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen geeft je toegang tot een samengestelde set betrouwbare, geoptimaliseerde modellen voor codeeragenten.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Ga naar ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " om je API-sleutel op te halen.",
  "provider.connect.oauth.code.visit.prefix": "Ga naar ",
  "provider.connect.oauth.code.visit.link": "deze link",
  "provider.connect.oauth.code.visit.suffix":
    " om je autorisatiecode op te halen, je account te koppelen en {{provider}}-modellen in CoderRupee te gebruiken.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " en voer de onderstaande code in om je account te koppelen en {{provider}}-modellen in CoderRupee te gebruiken.",
  ...
  "dialog.plugins.empty": "Plug-ins geconfigureerd in coderrupee.json",
  ...
  "dialog.server.description": "Wijzig met welke CoderRupee-server deze app verbinding maakt.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee controleren...",
  "wsl.onboarding.checkingOpencodeIn": "CoderRupee controleren in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CoderRupee bijwerken...",
  "wsl.onboarding.updatingOpencodeIn": "CoderRupee bijwerken in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Werk CoderRupee bij in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CoderRupee bijwerken",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee is gereed in {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee is klaar.",
  "wsl.onboarding.installOpencodeIn": "Installeer CoderRupee in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installeer CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee niet geïnstalleerd",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows-subsysteem voor Linux) is vereist voordat CoderRupee een WSL-server kan toevoegen",
  "wsl.onboarding.wslUnavailable.title": "WSL niet beschikbaar",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee kan WSL niet verifiëren op deze machine.",
  "wsl.onboarding.installWsl": "Installeer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows opnieuw om de installatie van WSL te voltooien en open vervolgens CoderRupee opnieuw.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop is nu opgebouwd rond tabbladen.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Er is nu een nieuwe versie van CoderRupee ({{version}}) beschikbaar om te installeren.",
  ...
  "error.page.report.prefix": "Rapporteer deze fout aan het CoderRupee-team",
  ...
  "error.chain.checkConfig": "Controleer de provider- en modelnamen in je configuratie (coderrupee.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" is mislukt. Let op: CoderRupee ondersteunt nog geen MCP-authenticatie.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee bevat gratis modellen, zodat je direct aan de slag kunt.",
  ...
  "settings.desktop.wsl.description": "Voer de CoderRupee-server uit in WSL op Windows.",
  ...
  "settings.general.row.language.description": "Wijzig de weergavetaal voor CoderRupee",
  ...
  "settings.general.row.appearance.description": "Pas aan hoe CoderRupee eruitziet op je apparaat",
  "settings.general.row.colorScheme.title": "Kleurenschema",
  "settings.general.row.colorScheme.description":
    "Kies of CoderRupee het systeemthema, het lichte thema of het donkere thema gebruikt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Pas het thema van CoderRupee aan.",
  ...
  "settings.updates.row.startup.description": "Controleer automatisch op updates wanneer CoderRupee wordt gestart",
  ...
  "settings.updates.toast.latest.title": "CoderRupee is bijgewerkt",
  "settings.updates.toast.latest.description": "Je gebruikt de nieuwste versie van CoderRupee.",
