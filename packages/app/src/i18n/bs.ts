export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacija za CoderRupee",
  ...
  "desktop.menu.ariaLabel": "CoderRupee meni",
  ...
  "desktop.recovery.loadFailed": "CoderRupee se nije uspio učitati",
  "desktop.recovery.terminated": "Prozor CoderRupee-a neočekivano je zatvoren",
  "desktop.recovery.unresponsive": "CoderRupee ne reaguje",
  ...
  "desktop.wsl.error.installOpencode": "Instalacija CoderRupee-a nije uspjela",
  "desktop.wsl.error.alreadyAdded": "Distribucija {{distro}} je već dodana",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee nije instaliran u ovoj distribuciji",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee je instaliran, ali se ne može pokrenuti",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee nije instaliran u distribuciji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Ažuriranje CoderRupee-a je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Kurirani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.coderrupee.tagline": "Pouzdani optimizovani modeli",
  "dialog.provider.coderrupeeGo.tagline": "Povoljna pretplata za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatni modeli koje obezbjeđuje CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Unesi svoj {{provider}} API ključ da povežeš račun i koristiš {{provider}} modele u CoderRupee-u.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen ti daje pristup kuriranom skupu pouzdanih, optimizovanih modela za coding agente.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Posjeti ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " da preuzmeš svoj API ključ.",
  "provider.connect.oauth.code.visit.prefix": "Posjeti ",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    " da preuzmeš autorizacijski kod i povežeš račun te koristiš {{provider}} modele u CoderRupee-u.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i unesi kod ispod da povežeš račun i koristiš {{provider}} modele u CoderRupee-u.",
  ...
  "dialog.plugins.empty": "Plugini su konfigurisani u coderrupee.json",
  ...
  "dialog.server.description": "Promijeni na koji se CoderRupee server ova aplikacija povezuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Provjera CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Provjera CoderRupee u distribuciji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CoderRupee u distribuciji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažuriraj CoderRupee u distribuciji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažuriraj CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee je spreman u distribuciji {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instaliraj CoderRupee u distribuciji {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaliraj CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee nije instaliran",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) je potreban da bi CoderRupee mogao dodati WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL nije dostupan",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nije mogao provjeriti WSL na ovom uređaju.",
  "wsl.onboarding.installWsl": "Instaliraj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokreni Windows da završiš instalaciju WSL-a, zatim ponovo otvori CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop sada je organizovan oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CoderRupee-a ({{version}}) je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Molimo prijavi ovu grešku CoderRupee timu",
  ...
  "error.chain.checkConfig": "Provjeri nazive provajdera/modela u konfiguraciji (coderrupee.json)",
  "error.chain.mcpFailed": 'MCP server "{{name}}" nije uspio. Napomena: CoderRupee još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee uključuje besplatne modele, tako da možeš odmah početi.",
  ...
  "settings.desktop.wsl.description": "Pokreni CoderRupee server unutar WSL-a na Windowsu.",
  ...
  "settings.general.row.language.description": "Promijeni jezik prikaza u CoderRupee-u",
  ...
  "settings.general.row.appearance.description": "Prilagodi kako CoderRupee izgleda na tvom uređaju",
  "settings.general.row.colorScheme.title": "Šema boja",
  "settings.general.row.colorScheme.description": "Odaberi da li CoderRupee prati sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodi temu CoderRupee-a.",
  ...
  "settings.updates.row.startup.description": "Automatski provjerava ažuriranja kada se CoderRupee pokrene",
  ...
  "settings.updates.toast.latest.description": "Koristiš najnoviju verziju CoderRupee-a.",
