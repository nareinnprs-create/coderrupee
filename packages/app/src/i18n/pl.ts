export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacja CoderRupee",
  ...
  "desktop.recovery.loadFailed": "Nie udało się wczytać CoderRupee",
  "desktop.recovery.terminated": "Okno CoderRupee zostało nieoczekiwanie zamknięte",
  "desktop.recovery.unresponsive": "CoderRupee nie odpowiada",
  ...
  "desktop.wsl.error.installOpencode": "Nie udało się zainstalować CoderRupee",
  "desktop.wsl.error.alreadyAdded": "Dystrybucja {{distro}} została już dodana",
  "desktop.wsl.error.coderrupeeMissing": "Program coderrupee nie jest zainstalowany w tej dystrybucji",
  "desktop.wsl.error.coderrupeeCannotRun": "Program coderrupee jest zainstalowany, ale nie można go uruchomić",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee nie jest zainstalowany w dystrybucji {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Aktualizacja CoderRupee została ukończona, ale dystrybucja {{distro}} nadal zgłasza wersję {{installed}}; oczekiwano {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Starannie dobrane modele, w tym Claude, GPT, Gemini i inne",
  "dialog.provider.coderrupee.tagline": "Niezawodne, zoptymalizowane modele",
  "dialog.provider.coderrupeeGo.tagline": "Niedroga subskrypcja dla każdego",
  ...
  "dialog.model.unpaid.freeModels.title": "Darmowe modele dostarczane przez CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Wprowadź swój klucz API {{provider}}, aby połączyć konto i używać modeli {{provider}} w CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen daje dostęp do wybranego zestawu niezawodnych, zoptymalizowanych modeli dla agentów programistycznych.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Odwiedź ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": ", aby odebrać swój klucz API.",
  "provider.connect.oauth.code.visit.prefix": "Odwiedź ",
  "provider.connect.oauth.code.visit.link": "ten link",
  "provider.connect.oauth.code.visit.suffix":
    ", aby odebrać kod autoryzacyjny, połączyć konto i używać modeli {{provider}} w CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i wprowadź poniższy kod, aby połączyć konto i używać modeli {{provider}} w CoderRupee.",
  ...
  "dialog.plugins.empty": "Wtyczki są skonfigurowane w pliku coderrupee.json",
  ...
  "dialog.server.description": "Przełącz serwer CoderRupee, z którym łączy się ta aplikacja.",
  ...
  "wsl.onboarding.checkingOpencode": "Sprawdzanie CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Sprawdzanie CoderRupee w dystrybucji {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizowanie CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizowanie CoderRupee w dystrybucji {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Zaktualizuj CoderRupee w dystrybucji {{distro}}.",
  "wsl.onboarding.updateOpencode": "Zaktualizuj CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee jest gotowy w dystrybucji {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee jest gotowy.",
  "wsl.onboarding.installOpencodeIn": "Zainstaluj CoderRupee w dystrybucji {{distro}}.",
  "wsl.onboarding.installOpencode": "Zainstaluj CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee nie jest zainstalowany",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Podsystem Windows dla systemu Linux) jest wymagany, zanim CoderRupee będzie mógł dodać serwer WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL jest niedostępny",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nie mógł zweryfikować WSL na tym komputerze.",
  "wsl.onboarding.installWsl": "Zainstaluj WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Uruchom ponownie system Windows, aby dokończyć instalację WSL, a następnie ponownie otwórz CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop korzysta teraz z układu opartego na kartach.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nowa wersja CoderRupee ({{version}}) jest teraz dostępna do instalacji.",
  ...
  "error.page.report.prefix": "Proszę zgłosić ten błąd do zespołu CoderRupee",
  ...
  "error.chain.checkConfig": "Sprawdź nazwy dostawców i modeli w konfiguracji (coderrupee.json)",
  "error.chain.mcpFailed":
    "Serwer MCP „{{name}}” nie uruchomił się. Uwaga: CoderRupee nie obsługuje jeszcze uwierzytelniania MCP.",
  ...
  "sidebar.gettingStarted.line1": "CoderRupee zawiera darmowe modele, więc możesz zacząć od razu.",
  ...
  "settings.desktop.wsl.description": "Uruchamiaj serwer CoderRupee wewnątrz WSL w systemie Windows.",
  ...
  "settings.general.row.language.description": "Zmień język wyświetlania dla CoderRupee",
  ...
  "settings.general.row.appearance.description": "Dostosuj wygląd CoderRupee na swoim urządzeniu",
  "settings.general.row.colorScheme.title": "Schemat kolorów",
  "settings.general.row.colorScheme.description":
    "Wybierz, czy CoderRupee ma używać motywu systemowego, jasnego czy ciemnego",
  "settings.general.row.theme.title": "Motyw",
  "settings.general.row.theme.description": "Dostosuj motyw CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Automatycznie sprawdzaj aktualizacje podczas uruchamiania CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Korzystasz z najnowszej wersji CoderRupee.",
