export const dict = {
  ...
  "desktop.menu.documentation": "Документація CoderRupee",
  ...
  "desktop.menu.ariaLabel": "Меню CoderRupee",
  ...
  "desktop.recovery.loadFailed": "Не вдалося завантажити CoderRupee",
  "desktop.recovery.terminated": "Роботу вікна CoderRupee несподівано завершено",
  "desktop.recovery.unresponsive": "CoderRupee не відповідає",
  ...
  "desktop.wsl.error.installOpencode": "Не вдалося встановити CoderRupee",
  "desktop.wsl.error.alreadyAdded": "{{distro}} уже додано",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee не встановлено в цьому дистрибутиві",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee встановлено, але його не вдалося запустити",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee не встановлено в {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Оновлення CoderRupee завершено, але {{distro}} усе ще повідомляє про версію {{installed}}; очікувалася {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Відібрані моделі, включаючи Claude, GPT, Gemini та інші",
  "dialog.provider.coderrupee.tagline": "Надійні оптимізовані моделі",
  "dialog.provider.coderrupeeGo.tagline": "Недорога підписка для всіх",
  ...
  "dialog.model.unpaid.freeModels.title": "Безкоштовні моделі від CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Введіть ключ API {{provider}}, щоб підключити обліковий запис і використовувати моделі {{provider}} у CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen надає доступ до відібраного набору надійних оптимізованих моделей для агентів кодування.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Відвідайте ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": ", щоб отримати ключ API.",
  "provider.connect.oauth.code.visit.prefix": "Відвідайте ",
  "provider.connect.oauth.code.visit.link": "це посилання",
  "provider.connect.oauth.code.visit.suffix":
    ", щоб отримати код авторизації, підключити обліковий запис і використовувати моделі {{provider}} у CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " і введіть код нижче, щоб підключити обліковий запис і використовувати моделі {{provider}} у CoderRupee.",
  ...
  "dialog.plugins.empty": "Плагіни налаштовані в coderrupee.json",
  ...
  "dialog.server.description": "Перемкніть сервер CoderRupee, до якого підключається ця програма.",
  ...
  "wsl.onboarding.checkingOpencode": "Перевірка CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Перевірка CoderRupee у {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Оновлення CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Оновлення CoderRupee у {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Оновіть CoderRupee у {{distro}}.",
  "wsl.onboarding.updateOpencode": "Оновити CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee готовий до роботи у {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee готовий до роботи.",
  "wsl.onboarding.installOpencodeIn": "Встановіть CoderRupee у {{distro}}.",
  "wsl.onboarding.installOpencode": "Встановити CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee не встановлено",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Для додавання сервера WSL в CoderRupee потрібна WSL (Підсистема Windows для Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL недоступна",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee не вдалося перевірити WSL на цьому комп'ютері.",
  "wsl.onboarding.installWsl": "Встановити WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Перезапустіть Windows, щоб завершити встановлення WSL, а потім знову відкрийте CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop тепер побудовано навколо вкладок.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Нова версія CoderRupee ({{version}}) тепер доступна для встановлення.",
  ...
  "error.page.report.prefix": "Будь ласка, повідомте про цю помилку команді CoderRupee",
  ...
  "error.chain.checkConfig": "Перевірте назви провайдерів/моделей у конфігурації (coderrupee.json)",
  "error.chain.mcpFailed":
    'Сервер MCP "{{name}}" не працює. Зверніть увагу, CoderRupee ще не підтримує автентифікацію MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee містить безкоштовні моделі, тому ви можете почати негайно.",
  ...
  "settings.desktop.wsl.description": "Запускати сервер CoderRupee всередині WSL на Windows.",
  ...
  "settings.general.row.language.description": "Змінити мову інтерфейсу CoderRupee",
  ...
  "settings.general.row.appearance.description": "Налаштуйте вигляд CoderRupee на вашому пристрої",
  "settings.general.row.colorScheme.title": "Кольорова схема",
  "settings.general.row.colorScheme.description": "Виберіть, чи CoderRupee використовує системну, світлу або темну тему",
  "settings.general.row.theme.title": "Тема",
  "settings.general.row.theme.description": "Налаштуйте тему CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Автоматично перевіряти наявність оновлень під час запуску CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Ви використовуєте останню версію CoderRupee.",
