...
const desktop = [
  ...
  "Laukti toliau",
  "Baigti darbą",
  "CoderRupee įkelti nepavyko",
  "CoderRupee langas netikėtai užsidarė",
  "CoderRupee neatsako",
  ...
  "CoderRupee įdiegti nepavyko",
  "{{distro}} jau pridėtas",
  "coderrupee šiame distributyve neįdiegtas",
  "coderrupee įdiegtas, bet jo paleisti nepavyko",
  "CoderRupee neįdiegtas distributyve {{distro}}",
  "CoderRupee naujinimas baigtas, bet {{distro}} vis dar praneša {{installed}}; tikėtasi {{expected}}",
  "versijos nėra",
...
export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Kuruojami modeliai, įskaitant Claude, GPT, Gemini ir kt.",
  "dialog.provider.coderrupee.tagline": "Patikimi optimizuoti modeliai",
  "dialog.provider.coderrupeeGo.tagline": "Mažos kainos abonementas visiems",
  ...
  "dialog.model.unpaid.freeModels.title": "Nemokami CoderRupee modeliai",
  ...
  "provider.connect.apiKey.description":
    "Įveskite {{provider}} API raktą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius programoje CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen suteikia prieigą prie kuruojamo patikimų optimizuotų kodavimo agentų modelių rinkinio.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Aplankykite",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "norėdami pasiimti savo API raktą.",
  "provider.connect.oauth.code.visit.prefix": "Aplankykite",
  "provider.connect.oauth.code.visit.link": "šią nuorodą",
  "provider.connect.oauth.code.visit.suffix":
    "rinkti prieigos kodą, kad galėtumėte prisijungti prie paskyros ir naudoti {{provider}} modelius CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ir įveskite toliau esantį kodą, kad susietumėte paskyrą ir naudotumėte {{provider}} modelius CoderRupee.",
  ...
  "dialog.plugins.empty": "Papildiniai sukonfigūruoti coderrupee.json",
  ...
  "dialog.server.description": "Perjunkite, prie kurio CoderRupee serverio jungiasi ši programa.",
  ...
  "wsl.onboarding.checkingOpencode": "Tikrinama CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Tikrinama CoderRupee {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atnaujinamas CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Atnaujinamas CoderRupee {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atnaujinkite CoderRupee {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atnaujinkite CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee yra paruoštas {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee yra paruoštas.",
  "wsl.onboarding.installOpencodeIn": "Įdiekite CoderRupee į {{distro}}.",
  "wsl.onboarding.installOpencode": "Įdiekite CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee neįdiegtas",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Kad CoderRupee galėtų pridėti WSL serverį, reikalingas WSL (Windows posistemis, skirtas Linux)",
  "wsl.onboarding.wslUnavailable.title": "WSL nepasiekiamas",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nepavyko patikrinti WSL šiame įrenginyje.",
  "wsl.onboarding.installWsl": "Įdiekite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Iš naujo paleiskite Windows, kad užbaigtumėte WSL diegimą, tada iš naujo atidarykite CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop dabar sukurtas iš skirtukų.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Dabar galima įdiegti naują CoderRupee ({{version}}) versiją.",
  ...
  "error.page.report.prefix": "Praneškite apie šią klaidą CoderRupee komandai",
  ...
  "error.chain.checkConfig": "Patikrinkite konfigūracijos (coderrupee.json) teikėjo / modelio pavadinimus",
  "error.chain.mcpFailed":
    "MCP serveris „{{name}}“ nepavyko. Atminkite, kad CoderRupee dar nepalaiko MCP autentifikavimo.",
  ...
  "sidebar.gettingStarted.line1": "CoderRupee apima nemokamus modelius, todėl galite pradėti iš karto.",
  ...
  "app.name.desktop": "CoderRupee darbalaukis",
  ...
  "settings.desktop.wsl.description": "Paleiskite CoderRupee serverį WSL viduje Windows.",
  ...
  "settings.general.row.language.description": "Pakeiskite CoderRupee ekrano kalbą",
  ...
  "settings.general.row.appearance.description": "Tinkinkite, kaip CoderRupee atrodo jūsų įrenginyje",
  "settings.general.row.colorScheme.title": "Spalvų schema",
  "settings.general.row.colorScheme.description": "Pasirinkite, ar CoderRupee seka sistemos, šviesios ar tamsios temos",
  "settings.general.row.theme.title": "tema",
  "settings.general.row.theme.description": "Tinkinkite CoderRupee temą.",
  ...
  "settings.updates.row.startup.description": "Automatiškai patikrinkite, ar nėra naujinimų, kai paleidžiamas CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Naudojate naujausią CoderRupee versiją.",
