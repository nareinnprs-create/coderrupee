export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Kuratoituja malleja, kuten Claude, GPT, Gemini ja muita",
  "dialog.provider.coderrupee.tagline": "Luotettavat optimoidut mallit",
  "dialog.provider.coderrupeeGo.tagline": "Edullinen tilaus kaikille",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupeen tarjoamat ilmaiset mallit",
  ...
  "provider.connect.apiKey.description":
    "Anna {{provider}}-API-avaimesi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CoderRupeessa.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen antaa sinulle pääsyn kuratoituun joukkoon luotettavia optimoituja malleja koodausagenteille.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Avaa ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " ja hae API-avaimesi.",
  "provider.connect.oauth.code.visit.prefix": "Avaa ",
  "provider.connect.oauth.code.visit.link": "tämä linkki",
  "provider.connect.oauth.code.visit.suffix":
    " ja hae valtuutuskoodi, jolla voit yhdistää tilisi ja käyttää {{provider}}-malleja CoderRupeessa.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja anna alla oleva koodi yhdistääksesi tilisi ja käyttääksesi {{provider}}-malleja CoderRupeessa.",
  ...
  "dialog.plugins.empty": "Laajennukset määritetään coderrupee.json-tiedostossa",
  ...
  "dialog.server.description": "Vaihda CoderRupee-palvelimeen, johon tämä sovellus muodostaa yhteyden.",
  ...
  "wsl.onboarding.checkingOpencode": "Tarkistetaan CoderRupeea...",
  "wsl.onboarding.checkingOpencodeIn": "Tarkistetaan CoderRupeea kohteessa {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Päivitetään CoderRupeea...",
  "wsl.onboarding.updatingOpencodeIn": "Päivitetään CoderRupeea kohteessa {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Päivitä CoderRupee jakelussa {{distro}}.",
  "wsl.onboarding.updateOpencode": "Päivitä CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee on valmis jakelussa {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee on valmis.",
  "wsl.onboarding.installOpencodeIn": "Asenna CoderRupee jakeluun {{distro}}.",
  "wsl.onboarding.installOpencode": "Asenna CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupeea ei ole asennettu",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) vaaditaan ennen kuin CoderRupee voi lisätä WSL-palvelimen",
  "wsl.onboarding.wslUnavailable.title": "WSL ei ole käytettävissä",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee ei voinut vahvistaa WSL:ää tällä koneella.",
  "wsl.onboarding.installWsl": "Asenna WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Viimeistele WSL:n asennus käynnistämällä Windows uudelleen ja avaa sitten CoderRupee uudelleen.",
  ...
  "toast.update.description": "CoderRupeen uusi versio ({{version}}) on nyt saatavana asennettavaksi.",
  ...
  "error.page.report.prefix": "Ilmoita tästä virheestä CoderRupee-tiimille",
  ...
  "error.chain.checkConfig": "Tarkista määritysten (coderrupee.json) palveluntarjoajien ja mallien nimet",
  "error.chain.mcpFailed": 'MCP-palvelin "{{name}}" epäonnistui. Huomaa, että CoderRupee ei vielä tue MCP-todennusta.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee sisältää ilmaisia malleja, joten voit aloittaa heti.",
  ...
  "settings.desktop.wsl.description": "Suorita CoderRupee-palvelin WSL:n sisällä Windowsissa.",
  ...
  "settings.general.row.language.description": "Vaihda CoderRupeen näyttökieli",
  ...
  "settings.general.row.appearance.description": "Mukauta, miltä CoderRupee näyttää laitteellasi",
  "settings.general.row.colorScheme.title": "Värimalli",
  "settings.general.row.colorScheme.description":
    "Valitse, käyttääkö CoderRupee järjestelmän mukaista, vaaleaa vai tummaa teemaa",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Mukauta CoderRupeen teemaa.",
  ...
  "settings.updates.row.startup.description": "Tarkista päivitykset automaattisesti, kun CoderRupee käynnistyy",
  ...
  "settings.updates.toast.latest.description": "Käytät CoderRupeen uusinta versiota.",
  ...
  "desktop.menu.documentation": "CoderRupee-dokumentaatio",
  ...
  "desktop.menu.ariaLabel": "CoderRupee-valikko",
  ...
  "desktop.recovery.loadFailed": "CoderRupeen lataaminen epäonnistui",
  "desktop.recovery.terminated": "CoderRupee-ikkuna sulkeutui odottamatta",
  "desktop.recovery.unresponsive": "CoderRupee ei vastaa",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupeen asennus epäonnistui",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on jo lisätty",
  "desktop.wsl.error.coderrupeeMissing": "coderrupeea ei ole asennettu tähän jakeluun",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee on asennettu, mutta sitä ei voitu suorittaa",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupeea ei ole asennettu jakeluun {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupeen päivitys valmistui, mutta {{distro}} ilmoittaa yhä version {{installed}}; odotettu versio on {{expected}}",
  ...
  "help.tabs.introduction": "CoderRupee Desktop perustuu nyt välilehtiin.",
  "help.tabs.sessions":
