export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee Dokumentace",
  ...
  "desktop.menu.ariaLabel": "Nabídka CoderRupee",
  ...
  "desktop.recovery.loadFailed": "CoderRupee se nepodařilo načíst",
  "desktop.recovery.terminated": "CoderRupee okno bylo neočekávaně ukončeno",
  "desktop.recovery.unresponsive": "CoderRupee nereaguje",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee instalace se nezdařila",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je již přidáno",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee není v této distribuci nainstalováno",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee je nainstalován, ale nelze jej spustit",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee není nainstalován v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupee aktualizace dokončena, ale {{distro}} stále hlásí {{installed}}; očekává se {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Vybrané modely včetně Claude, GPT, Gemini a dalších",
  "dialog.provider.coderrupee.tagline": "Spolehlivé optimalizované modely",
  "dialog.provider.coderrupeeGo.tagline": "Nízkonákladové předplatné pro každého",
  ...
  "provider.connect.apiKey.description":
    "Zadejte klíč API služby {{provider}}, připojte účet a používejte modely {{provider}} v CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen vám poskytuje přístup k upravené sadě spolehlivých optimalizovaných modelů pro kódovací agenty.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Návštěva ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " vyzvedněte svůj klíč API.",
  "provider.connect.oauth.code.visit.prefix": "Návštěva ",
  "provider.connect.oauth.code.visit.link": "tento odkaz",
  "provider.connect.oauth.code.visit.suffix":
    " k vyzvednutí autorizačního kódu pro připojení vašeho účtu a používání {{provider}} modelů v CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " a zadejte níže uvedený kód pro připojení svého účtu a používání {{provider}} modelů v CoderRupee.",
  ...
  "dialog.plugins.empty": "Pluginy nakonfigurované v coderrupee.json",
  ...
  "dialog.server.description": "Přepněte, ke kterému CoderRupee serveru se tato aplikace připojuje.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrola CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrola CoderRupee v {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aktualizace CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Aktualizace CoderRupee v {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aktualizace CoderRupee v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aktualizovat CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee je připraveno v {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee je připraven.",
  "wsl.onboarding.installOpencodeIn": "Nainstalujte CoderRupee do {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalovat CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee není nainstalováno",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystém pro Linux) je vyžadován předtím, než CoderRupee může přidat server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL není k dispozici",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nemohl ověřit WSL na tomto počítači.",
  "wsl.onboarding.installWsl": "Instalovat WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Restartujte Windows pro dokončení instalace WSL a poté znovu otevřete CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Plocha je nyní postavena na kartách.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nyní je k dispozici k instalaci nová verze CoderRupee ({{version}}).",
  ...
  "error.page.report.prefix": "Nahlaste tuto chybu týmu CoderRupee",
  ...
  "error.chain.checkConfig": "Zkontrolujte název poskytovatele/modelu konfigurace (coderrupee.json).",
  "error.chain.mcpFailed": 'MCP server "{{name}}" selhal. Poznámka: CoderRupee zatím nepodporuje ověřování MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee obsahuje bezplatné modely, takže můžete začít okamžitě.",
  ...
  "settings.desktop.wsl.description": "Spusťte server CoderRupee uvnitř WSL na Windows.",
  ...
  "settings.general.row.language.description": "Změnit jazyk zobrazení pro CoderRupee",
  ...
  "settings.general.row.appearance.description": "Přizpůsobte si vzhled CoderRupee na vašem zařízení",
  "settings.general.row.colorScheme.title": "Barevné schéma",
  "settings.general.row.colorScheme.description":
    "Zvolte, zda bude CoderRupee následovat systémové, světlé nebo tmavé téma",
  "settings.general.row.theme.title": "téma",
  "settings.general.row.theme.description": "Přizpůsobte, jak je téma CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Automaticky kontrolovat aktualizace při spuštění CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Používáte nejnovější verzi CoderRupee.",
