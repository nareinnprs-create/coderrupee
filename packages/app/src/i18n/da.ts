export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Udvalgte modeller inklusive Claude, GPT, Gemini og flere",
  "dialog.provider.coderrupee.tagline": "Pålidelige optimerede modeller",
  "dialog.provider.coderrupeeGo.tagline": "Billigt abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller leveret af CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Indtast din API-nøgle til {{provider}} for at forbinde din konto og bruge modeller fra {{provider}} i CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen giver dig adgang til et udvalg af pålidelige optimerede modeller til kodningsagenter.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Besøg ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " for at hente din API-nøgle.",
  "provider.connect.oauth.code.visit.prefix": "Besøg ",
  "provider.connect.oauth.code.visit.link": "dette link",
  "provider.connect.oauth.code.visit.suffix":
    " for at hente din godkendelseskode, forbinde din konto og bruge modeller fra {{provider}} i CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og indtast koden nedenfor for at forbinde din konto og bruge modeller fra {{provider}} i CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugins konfigureret i coderrupee.json",
  ...
  "dialog.server.description": "Skift hvilken CoderRupee-server denne app forbinder til.",
  ...
  "wsl.onboarding.checkingOpencode": "Tjekker CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Tjekker CoderRupee i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Opdaterer CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Opdaterer CoderRupee i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Opdater CoderRupee i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Opdater CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee er ikke installeret",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) er påkrævet, før CoderRupee kan tilføje en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er ikke tilgængelig",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee kunne ikke bekræfte WSL på denne maskine.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Genstart Windows for at fuldføre installationen af WSL, og åbn derefter CoderRupee igen.",
  ...
  "toast.update.description": "En ny version af CoderRupee ({{version}}) er nu tilgængelig til installation.",
  ...
  "error.page.report.prefix": "Rapporter venligst denne fejl til CoderRupee-teamet",
  ...
  "error.chain.checkConfig": "Kontrollér udbyder- og modelnavnene i din konfiguration (coderrupee.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" fejlede. Bemærk, CoderRupee understøtter ikke MCP-godkendelse endnu.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee inkluderer gratis modeller så du kan starte med det samme.",
  ...
  "settings.desktop.wsl.description": "Kør CoderRupee-serveren inde i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ændr visningssproget for CoderRupee",
  ...
  "settings.general.row.appearance.description": "Tilpas hvordan CoderRupee ser ud på din enhed",
  "settings.general.row.colorScheme.title": "Farveskema",
  "settings.general.row.colorScheme.description":
    "Vælg, om CoderRupee skal følge systemtemaet eller bruge et lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpas CoderRupees tema.",
  ...
  "settings.updates.row.startup.description": "Tjek automatisk for opdateringer, når CoderRupee starter",
  ...
  "settings.updates.toast.latest.description": "Du kører den nyeste version af CoderRupee.",
  ...
  "desktop.recovery.loadFailed": "CoderRupee kunne ikke indlæses",
  "desktop.recovery.terminated": "CoderRupee-vinduet blev uventet afsluttet",
  ...
  "desktop.wsl.error.installOpencode": "Installationen af CoderRupee mislykkedes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede tilføjet",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee er ikke installeret i denne distribution",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee er installeret, men kunne ikke køre",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee er ikke installeret i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Opdateringen af CoderRupee er fuldført, men {{distro}} rapporterer stadig {{installed}}. Forventet: {{expected}}",
  ...
  "help.tabs.introduction": "CoderRupee Desktop er nu bygget op omkring faner.",
  "help.tabs.sessions":
