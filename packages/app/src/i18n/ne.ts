export const dict: Record<string, string> = {
  ...
  "desktop.menu.documentation": "CoderRupee कागजात",
  ...
  "desktop.menu.ariaLabel": "CoderRupee मेनु",
  ...
  "desktop.recovery.loadFailed": "CoderRupee लोड हुन सकेन",
  "desktop.recovery.terminated": "CoderRupee विन्डो अप्रत्याशित रूपमा समाप्त भयो",
  "desktop.recovery.unresponsive": "CoderRupee ले प्रतिक्रिया दिइरहेको छैन",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee स्थापना असफल भयो",
  "desktop.wsl.error.alreadyAdded": "{{distro}} पहिले नै थपिएको छ",
  "desktop.wsl.error.coderrupeeMissing": "Opencode यस distro मा स्थापित छैन",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee स्थापित छ तर चलाउन सकिएन",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee {{distro}} मा स्थापित छैन",
  "desktop.wsl.error.updateVersion":
    "CoderRupee अद्यावधिक समाप्त भयो तर {{distro}} ले अझै पनि रिपोर्ट गर्छ {{installed}}; अपेक्षित {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Claude, GPT, Gemini र थप सहित क्युरेट गरिएका मोडेलहरू",
  "dialog.provider.coderrupee.tagline": "भरपर्दो अनुकूलित मोडेलहरू",
  "dialog.provider.coderrupeeGo.tagline": "सबैको लागि कम लागत सदस्यता",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupee द्वारा प्रदान गरिएको नि:शुल्क मोडेलहरू",
  ...
  "provider.connect.apiKey.description":
    "आफ्नो खाता जडान गर्न आफ्नो {{provider}} API कुञ्जी प्रविष्ट गर्नुहोस् र CoderRupee मा {{provider}} मोडेलहरू प्रयोग गर्नुहोस्।",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen ले तपाईंलाई कोडिङ एजेन्टहरूका लागि भरपर्दो अनुकूलित मोडेलहरूको क्युरेट गरिएको सेटमा पहुँच दिन्छ।",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "तपाईँको API कुञ्जी सङ्कलन गर्न।",
  "provider.connect.oauth.code.visit.prefix": "भ्रमण गर्नुहोस्",
  "provider.connect.oauth.code.visit.link": "यो लिङ्क",
  "provider.connect.oauth.code.visit.suffix":
    "आफ्नो खाता जडान गर्न र CoderRupee मा {{provider}} मोडेलहरू प्रयोग गर्न आफ्नो प्राधिकरण कोड सङ्कलन गर्न।",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "र आफ्नो खाता जडान गर्न तलको कोड प्रविष्ट गर्नुहोस् र {{provider}} मोडेलहरू CoderRupee मा प्रयोग गर्नुहोस्।",
  ...
  "dialog.plugins.empty": "coderrupee.json मा कन्फिगर गरिएका प्लगइनहरू",
  ...
  "dialog.server.description": "यो एप जडान भएको CoderRupee सर्भरलाई स्विच गर्नुहोस्।",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee जाँच गर्दै...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} मा CoderRupee जाँच गर्दै...",
  "wsl.onboarding.updatingOpencode": "अद्यावधिक गर्दै CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} मा CoderRupee अद्यावधिक गर्दै...",
  "wsl.onboarding.updateOpencodeIn": "अपडेट गर्नुहोस् CoderRupee {{distro}} मा।",
  "wsl.onboarding.updateOpencode": "अपडेट गर्नुहोस् CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee {{distro}} मा तयार छ।",
  "wsl.onboarding.coderrupeeReady": "CoderRupee तयार छ।",
  "wsl.onboarding.installOpencodeIn": "{{distro}} मा CoderRupee स्थापना गर्नुहोस्।",
  "wsl.onboarding.installOpencode": "CoderRupee स्थापना गर्नुहोस्",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee स्थापित छैन",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Linux को लागि सबसिस्टम) CoderRupee ले WSL सर्भर थप्न अघि आवश्यक छ।",
  "wsl.onboarding.wslUnavailable.title": "WSL उपलब्ध छैन",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee ले यो मेसिनमा WSL प्रमाणित गर्न सकेन।",
  "wsl.onboarding.installWsl": "WSL स्थापना गर्नुहोस्",
  "wsl.onboarding.windowsRestartRequired":
    "WSL स्थापना पूरा गर्न Windows पुन: सुरु गर्नुहोस्, त्यसपछि CoderRupee पुन: खोल्नुहोस्।",
  ...
  "help.tabs.introduction": "CoderRupee डेस्कटप अब ट्याब वरिपरि बनाइएको छ।",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupee ({{version}}) को नयाँ संस्करण अब स्थापना गर्न उपलब्ध छ।",
  ...
  "error.page.report.prefix": "कृपया यो त्रुटि CoderRupee टोलीलाई रिपोर्ट गर्नुहोस्",
  ...
  "error.chain.checkConfig": "आफ्नो कन्फिगरेसन (coderrupee.json) प्रदायक/मोडेल नामहरू जाँच गर्नुहोस्",
  "error.chain.mcpFailed":
    'MCP सर्भर "{{name}}" असफल भयो। नोट गर्नुहोस्, CoderRupee ले अझै पनि MCP प्रमाणीकरणलाई समर्थन गर्दैन।',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee मा नि:शुल्क मोडेलहरू समावेश छन् ताकि तपाईं तुरुन्तै सुरु गर्न सक्नुहुन्छ।",
  ...
  "app.name.desktop": "CoderRupee डेस्कटप",
  ...
  "settings.desktop.wsl.description": "CoderRupee सर्भर भित्र WSL Windows मा चलाउनुहोस्।",
  ...
  "settings.general.row.language.description": "CoderRupee को लागि प्रदर्शन भाषा परिवर्तन गर्नुहोस्",
  ...
  "settings.general.row.appearance.description": "आफ्नो यन्त्रमा CoderRupee कस्तो देखिन्छ अनुकूलित गर्नुहोस्",
  "settings.general.row.colorScheme.title": "रंग योजना",
  "settings.general.row.colorScheme.description":
    "CoderRupee ले प्रणाली, उज्यालो वा गाढा विषयवस्तुलाई फलो गर्छ कि गर्दैन भन्ने छनौट गर्नुहोस्",
  "settings.general.row.theme.title": "विषयवस्तु",
  "settings.general.row.theme.description": "कसरी CoderRupee विषयवस्तुलाई अनुकूलित गर्नुहोस्।",
  ...
  "settings.updates.row.startup.description": "CoderRupee सुरु हुँदा अद्यावधिकहरूको लागि स्वचालित रूपमा जाँच गर्नुहोस्",
  ...
  "settings.updates.toast.latest.description": "तपाईं CoderRupee को नवीनतम संस्करण चलाइरहनुभएको छ।",
