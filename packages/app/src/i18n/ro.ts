export const dict = {
  ...
  "desktop.menu.documentation": "Documentație CoderRupee",
  ...
  "desktop.menu.ariaLabel": "Meniu CoderRupee",
  ...
  "desktop.recovery.loadFailed": "CoderRupee nu a putut fi încărcat",
  "desktop.recovery.terminated": "Fereastra CoderRupee s-a închis neașteptat",
  "desktop.recovery.unresponsive": "CoderRupee nu răspunde",
  ...
  "desktop.wsl.error.installOpencode": "Instalarea CoderRupee a eșuat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} este deja adăugată",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee nu este instalat în această distribuție",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee este instalat, dar nu a putut fi pornit",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee nu este instalat în {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Actualizarea CoderRupee s-a terminat, dar {{distro}} raportează tot {{installed}}; era așteptat {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Modele selectate, inclusiv Claude, GPT, Gemini și altele",
  "dialog.provider.coderrupee.tagline": "Modele optimizate, fiabile",
  "dialog.provider.coderrupeeGo.tagline": "Abonament accesibil pentru toți",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele gratuite oferite de CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Introdu cheia API {{provider}} pentru a-ți conecta contul și a folosi modelele {{provider}} în CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen îți oferă acces la un set selectat de modele optimizate și fiabile pentru agenți de programare.",
  "provider.connect.coderrupeeZen.line2":
    "Cu o singură cheie API ai acces la modele precum Claude, GPT, Gemini, GLM și altele.",
  "provider.connect.coderrupeeZen.visit.prefix": "Vizitează",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "pentru a obține cheia ta API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitează",
  "provider.connect.oauth.code.visit.link": "acest link",
  "provider.connect.oauth.code.visit.suffix":
    " pentru a obține codul de autorizare și a-ți conecta contul ca să folosești modelele {{provider}} în CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " și introdu codul de mai jos pentru a-ți conecta contul și a folosi modelele {{provider}} în CoderRupee.",
  ...
  "dialog.plugins.empty": "Pluginuri configurate în coderrupee.json",
  ...
  "dialog.server.description": "Schimbă serverul CoderRupee la care se conectează aplicația.",
  ...
  "wsl.onboarding.checkingOpencode": "Se verifică CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Se verifică CoderRupee în {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Se actualizează CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Se actualizează CoderRupee în {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualizează CoderRupee în {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizează CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee este gata în {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee este gata.",
  "wsl.onboarding.installOpencodeIn": "Instalează CoderRupee în {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalează CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee nu este instalat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Subsistemul Windows pentru Linux) este necesar înainte ca CoderRupee să poată adăuga un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponibil",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nu a putut verifica WSL pe acest calculator.",
  "wsl.onboarding.installWsl": "Instalează WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Repornește Windows pentru a finaliza instalarea WSL, apoi redeschide CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop este acum construit în jurul filelor.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "O nouă versiune CoderRupee ({{version}}) este disponibilă pentru instalare.",
  ...
  "error.page.report.prefix": "Te rugăm să raportezi această eroare echipei CoderRupee",
  ...
  "error.chain.checkConfig": "Verifică numele provider/model în config (coderrupee.json)",
  "error.chain.mcpFailed": 'Serverul MCP "{{name}}" a eșuat. Atenție, CoderRupee nu suportă încă autentificarea MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee include modele gratuite ca să poți începe imediat.",
  ...
  "settings.desktop.wsl.description": "Rulează serverul CoderRupee în WSL pe Windows.",
  ...
  "settings.general.row.language.description": "Schimbă limba de afișare pentru CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personalizează aspectul CoderRupee pe dispozitivul tău",
  "settings.general.row.colorScheme.title": "Scheamă de culori",
  "settings.general.row.colorScheme.description": "Alege dacă CoderRupee urmează sistemul, tema deschisă sau închisă",
  "settings.general.row.theme.title": "Temă",
  "settings.general.row.theme.description": "Personalizează tema CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Verifică automat actualizările la lansarea CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Folosești cea mai recentă versiune CoderRupee.",
