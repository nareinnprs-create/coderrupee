export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee Dokumentacija",
  ...
  "desktop.recovery.loadFailed": "CoderRupee ni uspelo naložiti",
  "desktop.recovery.terminated": "Okno CoderRupee se je nepričakovano končalo",
  "desktop.recovery.unresponsive": "CoderRupee se ne odziva",
  ...
  "desktop.wsl.error.installOpencode": "Namestitev CoderRupee ni uspela",
  "desktop.wsl.error.alreadyAdded": "{{distro}} je že dodan",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee ni nameščen v tej distribuciji",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee je nameščen, vendar se ne more zagnati",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee ni nameščen v {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Posodobitev CoderRupee je končana, vendar {{distro}} še vedno poroča {{installed}}; pričakovano {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Izbrani modeli, vključno z Claude, GPT, Gemini in drugimi",
  "dialog.provider.coderrupee.tagline": "Zanesljivi optimizirani modeli",
  "dialog.provider.coderrupeeGo.tagline": "Poceni naročnina za vsakogar",
  ...
  "dialog.model.unpaid.freeModels.title": "Brezplačne modele ponuja CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Vnesite ključ API ponudnika {{provider}}, da povežete račun in uporabljate modele {{provider}} v CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen vam omogoča dostop do izbranega nabora zanesljivih optimiziranih modelov za agente za kodiranje.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Obisk ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " za prevzem ključa API.",
  "provider.connect.oauth.code.visit.prefix": "Obisk ",
  "provider.connect.oauth.code.visit.link": "ta povezava",
  "provider.connect.oauth.code.visit.suffix":
    " za zbiranje avtorizacijske kode za povezavo vašega računa in uporabo modelov {{provider}} v CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " in vnesite spodnjo kodo, da povežete svoj račun in uporabite modele {{provider}} v CoderRupee.",
  ...
  "dialog.plugins.empty": "Vtičniki, konfigurirani v coderrupee.json",
  ...
  "dialog.server.description": "Preklopite, s katerim strežnikom CoderRupee se povezuje ta aplikacija.",
  ...
  "wsl.onboarding.checkingOpencode": "Preverjanje CoderRupee ...",
  "wsl.onboarding.checkingOpencodeIn": "Preverjanje CoderRupee v {{distro}} ...",
  "wsl.onboarding.updatingOpencode": "Posodabljanje CoderRupee ...",
  "wsl.onboarding.updatingOpencodeIn": "Posodabljanje CoderRupee v {{distro}} ...",
  "wsl.onboarding.updateOpencodeIn": "Posodobite CoderRupee v {{distro}}.",
  "wsl.onboarding.updateOpencode": "Posodobite CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee je pripravljen v {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee je pripravljen.",
  "wsl.onboarding.installOpencodeIn": "Namestite CoderRupee v {{distro}}.",
  "wsl.onboarding.installOpencode": "Namestite CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee ni nameščen",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (podsistem Windows za Linux) je potreben, preden lahko CoderRupee doda strežnik WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL ni na voljo",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee ni mogel preveriti WSL na tej napravi.",
  "wsl.onboarding.installWsl": "Namestite WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Znova zaženite Windows, da dokončate namestitev WSL, nato znova odprite CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop je zdaj zgrajen okoli zavihkov.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova različica CoderRupee ({{version}}) je zdaj na voljo za namestitev.",
  ...
  "error.page.report.prefix": "Prosimo, prijavite to napako ekipi CoderRupee",
  ...
  "error.chain.checkConfig": "Preverite imena ponudnikov/modelov konfiguracije (coderrupee.json).",
  "error.chain.mcpFailed": 'MCP strežnik "{{name}}" ni uspel. Opomba, CoderRupee še ne podpira avtentikacije MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee vključuje brezplačne modele, tako da lahko začnete takoj.",
  ...
  "settings.desktop.wsl.description": "Zaženite strežnik CoderRupee znotraj WSL na Windows.",
  ...
  "settings.general.row.language.description": "Spremenite jezik prikaza za CoderRupee",
  ...
  "settings.general.row.appearance.description": "Prilagodite, kako CoderRupee izgleda na vaši napravi",
  "settings.general.row.colorScheme.title": "Barvna shema",
  "settings.general.row.colorScheme.description": "Izberite, ali CoderRupee sledi sistemski, svetli ali temni temi",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite temo CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Samodejno preveri posodobitve, ko se zažene CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Uporabljate najnovejšo različico CoderRupee.",
