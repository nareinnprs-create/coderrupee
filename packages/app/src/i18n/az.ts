export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee yüklənə bilmədi",
  "desktop.recovery.terminated": "CoderRupee pəncərəsinin işi gözlənilmədən dayandı",
  "desktop.recovery.unresponsive": "CoderRupee cavab vermir",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee quraşdırılması uğursuz oldu",
  "desktop.wsl.error.alreadyAdded": "{{distro}} artıq əlavə edilib",
  "desktop.wsl.error.coderrupeeMissing": "Bu distribütivdə coderrupee quraşdırılmayıb",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee quraşdırılıb, lakin onu işə salmaq mümkün olmadı",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee {{distro}} distribütivində quraşdırılmayıb",
  "desktop.wsl.error.updateVersion":
    "CoderRupee yeniləməsi tamamlandı, lakin {{distro}} hələ də {{installed}} versiyasını bildirir; gözlənilən versiya: {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Claude, GPT, Gemini və daha çoxu daxil olmaqla seçilmiş modellər",
  "dialog.provider.coderrupee.tagline": "Etibarlı optimallaşdırılmış modellər",
  "dialog.provider.coderrupeeGo.tagline": "Hamı üçün aşağı qiymətli abunəlik",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupee tərəfindən təqdim olunan pulsuz modellər",
  ...
  "provider.connect.apiKey.description":
    "Hesabınızı qoşmaq və CoderRupee-da {{provider}} modellərindən istifadə etmək üçün {{provider}} API açarınızı daxil edin.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen sizə kodlaşdırma agentləri üçün etibarlı optimallaşdırılmış seçilmiş modellər dəstinə giriş verir.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " səhifəsinə daxil olub API açarınızı əldə edin.",
  "provider.connect.oauth.code.visit.prefix": "",
  "provider.connect.oauth.code.visit.link": "Bu linkə",
  "provider.connect.oauth.code.visit.suffix":
    " daxil olub hesabınızı qoşmaq və CoderRupee-da {{provider}} modellərindən istifadə etmək üçün avtorizasiya kodunuzu əldə edin.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " daxil olub aşağıdakı kodu daxil edərək hesabınızı qoşun və CoderRupee-da {{provider}} modellərindən istifadə edin.",
  ...
  "dialog.plugins.empty": "Plaginlər coderrupee.json-da konfiqurasiya edilib",
  ...
  "dialog.server.description": "Bu tətbiqin qoşulduğu CoderRupee serverini dəyişdirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee yoxlanılır...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}-də CoderRupee yoxlanılır...",
  "wsl.onboarding.updatingOpencode": "CoderRupee yenilənir...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-də CoderRupee yenilənir...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}-də CoderRupee-u yeniləyin.",
  "wsl.onboarding.updateOpencode": "CoderRupee-u yeniləyin",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee {{distro}}-də hazırdır.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee hazırdır.",
  "wsl.onboarding.installOpencodeIn": "CoderRupee-u {{distro}}-də quraşdırın.",
  "wsl.onboarding.installOpencode": "CoderRupee quraşdırın",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee quraşdırılmayıb",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CoderRupee WSL serveri əlavə etməzdən əvvəl WSL (Linux üçün Windows alt sistemi) tələb olunur",
  "wsl.onboarding.wslUnavailable.title": "WSL mövcud deyil",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee bu maşında WSL-i doğrulaya bilmədi.",
  "wsl.onboarding.installWsl": "WSL quraşdırın",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-nin quraşdırılmasını başa çatdırmaq üçün Windows-u yenidən başladın, sonra CoderRupee-u yenidən açın.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop indi tablar əsasında qurulub.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupee-un yeni versiyası ({{version}}) quraşdırma üçün mövcuddur.",
  ...
  "error.page.report.prefix": "Bu xətanı CoderRupee komandasına",
  ...
  "error.chain.checkConfig": "Konfiqurasiyanızdakı (coderrupee.json) provayder/model adlarını yoxlayın",
  "error.chain.mcpFailed":
    'MCP server "{{name}}" uğursuz oldu. Qeyd: CoderRupee hələ MCP autentifikasiyasını dəstəkləmir.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee-a pulsuz modellər daxildir, buna görə dərhal başlaya bilərsiniz.",
  ...
  "settings.desktop.wsl.description": "Windows-da WSL daxilində CoderRupee serverini işlət.",
  ...
  "settings.general.row.language.description": "CoderRupee üçün ekran dilini dəyişdirin",
  ...
  "settings.general.row.appearance.description": "CoderRupee-un cihazınızda necə göründüyünü fərdiləşdirin",
  "settings.general.row.colorScheme.title": "Rəng sxemi",
  "settings.general.row.colorScheme.description":
    "CoderRupee-un sistem, açıq və ya tünd mövzudan istifadə etməsini seçin",
  "settings.general.row.theme.title": "Mövzu",
  "settings.general.row.theme.description": "CoderRupee-un mövzusunu fərdiləşdirin.",
  ...
  "settings.updates.row.startup.description": "CoderRupee açıldıqda avtomatik yeniləmələri yoxla",
  ...
  "settings.updates.toast.latest.description": "CoderRupee-un ən son versiyasından istifadə edirsiniz.",
