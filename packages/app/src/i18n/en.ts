...
export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Curated models including Claude, GPT, Gemini and more",
  "dialog.provider.coderrupee.tagline": "Reliable optimized models",
  "dialog.provider.coderrupeeGo.tagline": "Low cost subscription for everyone",
  ...
  "dialog.model.unpaid.freeModels.title": "Free models provided by CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Enter your {{provider}} API key to connect your account and use {{provider}} models in CoderRupee.",
  "provider.connect.apiKey.label": "{{provider}} API key",
  "provider.connect.apiKey.placeholder": "API key",
  "provider.connect.apiKey.required": "API key is required",
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen gives you access to a curated set of reliable optimized models for coding agents.",
  "provider.connect.coderrupeeZen.line2":
    "With a single API key you'll get access to models such as Claude, GPT, Gemini, GLM and more.",
  "provider.connect.coderrupeeZen.visit.prefix": "Visit ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " to collect your API key.",
  "provider.connect.oauth.code.visit.prefix": "Visit ",
  "provider.connect.oauth.code.visit.link": "this link",
  "provider.connect.oauth.code.visit.suffix":
    " to collect your authorization code to connect your account and use {{provider}} models in CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " and enter the code below to connect your account and use {{provider}} models in CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugins configured in coderrupee.json",
  ...
  "dialog.server.description": "Switch which CoderRupee server this app connects to.",
  ...
  "wsl.onboarding.checkingOpencode": "Checking CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Checking CoderRupee in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Updating CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Updating CoderRupee in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Update CoderRupee in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Update CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee is ready in {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee is ready.",
  "wsl.onboarding.installOpencodeIn": "Install CoderRupee in {{distro}}.",
  "wsl.onboarding.installOpencode": "Install CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee not installed",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) is required before CoderRupee can add a WSL server",
  "wsl.onboarding.wslUnavailable.title": "WSL unavailable",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee could not verify WSL on this machine.",
  "wsl.onboarding.installWsl": "Install WSL",
  "wsl.onboarding.windowsRestartRequired": "Restart Windows to finish installing WSL, then reopen CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop is now built around tabs.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A new version of CoderRupee ({{version}}) is now available to install.",
  ...
  "error.page.report.prefix": "Please report this error to the CoderRupee team",
  ...
  "error.chain.checkConfig": "Check your config (coderrupee.json) provider/model names",
  "error.chain.mcpFailed": 'MCP server "{{name}}" failed. Note, CoderRupee does not support MCP authentication yet.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee includes free models so you can start immediately.",
  ...
  "settings.desktop.wsl.description": "Run the CoderRupee server inside WSL on Windows.",
  ...
  "settings.general.row.language.description": "Change the display language for CoderRupee",
  "settings.general.row.shell.title": "Terminal shell",
  "settings.general.row.shell.description": "Shell used by the terminal and agent tools",
  "settings.general.row.shell.autoDefault": "Auto (Default)",
  "settings.general.row.shell.terminalOnly": "terminal only",
  "settings.general.row.appearance.title": "Appearance",
  "settings.general.row.appearance.description": "Customise how CoderRupee looks on your device",
  "settings.general.row.colorScheme.title": "Color scheme",
  "settings.general.row.colorScheme.description": "Choose whether CoderRupee follows the system, light, or dark theme",
  "settings.general.row.theme.title": "Theme",
  "settings.general.row.theme.description": "Customise how CoderRupee is themed.",
  ...
  "settings.updates.row.startup.description": "Automatically check for updates when CoderRupee launches",
  ...
  "settings.updates.toast.latest.description": "You're running the latest version of CoderRupee.",
