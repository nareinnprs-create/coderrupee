...
export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee-dokumentasjon",
  ...
  "desktop.menu.ariaLabel": "CoderRupee-meny",
  ...
  "desktop.recovery.loadFailed": "CoderRupee kunne ikke lastes inn",
  "desktop.recovery.terminated": "CoderRupee-vinduet ble uventet avsluttet",
  "desktop.recovery.unresponsive": "CoderRupee svarer ikke",
  ...
  "desktop.wsl.error.installOpencode": "Installasjonen av CoderRupee mislyktes",
  "desktop.wsl.error.alreadyAdded": "{{distro}} er allerede lagt til",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee er ikke installert i denne distribusjonen",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee er installert, men kunne ikke kjøres",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee er ikke installert i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Oppdateringen av CoderRupee er fullført, men {{distro}} rapporterer fortsatt {{installed}}; forventet {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Utvalgte modeller inkludert Claude, GPT, Gemini og mer",
  "dialog.provider.coderrupee.tagline": "Pålitelige, optimaliserte modeller",
  "dialog.provider.coderrupeeGo.tagline": "Rimelig abonnement for alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller levert av CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Skriv inn API-nøkkelen din for {{provider}} for å koble til kontoen din og bruke {{provider}}-modeller i CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen gir deg tilgang til et utvalg av pålitelige optimaliserte modeller for kodeagenter.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Besøk ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " for å hente API-nøkkelen din.",
  "provider.connect.oauth.code.visit.prefix": "Besøk ",
  "provider.connect.oauth.code.visit.link": "denne lenken",
  "provider.connect.oauth.code.visit.suffix":
    " for å hente autorisasjonskoden din for å koble til kontoen din og bruke {{provider}}-modeller i CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " og skriv inn koden nedenfor for å koble til kontoen din og bruke {{provider}}-modeller i CoderRupee.",
  ...
  "dialog.plugins.empty": "Programtillegg konfigurert i coderrupee.json",
  ...
  "dialog.server.description": "Bytt hvilken CoderRupee-server denne appen kobler til.",
  ...
  "toast.update.description": "En ny versjon av CoderRupee ({{version}}) er nå tilgjengelig for installasjon.",
  ...
  "error.page.report.prefix": "Vennligst rapporter denne feilen til CoderRupee-teamet",
  ...
  "error.chain.checkConfig": "Sjekk leverandør-/modellnavnene i konfigurasjonen din (coderrupee.json)",
  "error.chain.mcpFailed": 'MCP-server "{{name}}" mislyktes. Merk at CoderRupee ikke støtter MCP-autentisering ennå.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee inkluderer gratis modeller så du kan starte umiddelbart.",
  ...
  "settings.desktop.wsl.description": "Kjør CoderRupee-serveren i WSL på Windows.",
  ...
  "settings.general.row.language.description": "Endre visningsspråket for CoderRupee",
  "settings.general.row.appearance.title": "Utseende",
  "settings.general.row.appearance.description": "Tilpass hvordan CoderRupee ser ut på enheten din",
  "settings.general.row.colorScheme.title": "Fargevalg",
  "settings.general.row.colorScheme.description":
    "Velg om CoderRupee skal følge systeminnstillingen eller bruke lyst eller mørkt tema",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Tilpass temaet i CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Se automatisk etter oppdateringer når CoderRupee starter",
  ...
  "settings.updates.toast.latest.title": "CoderRupee er oppdatert",
  "settings.updates.toast.latest.description": "Du bruker den nyeste versjonen av CoderRupee.",
  ...
  "wsl.onboarding.checkingOpencode": "Sjekker CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Sjekker CoderRupee i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Oppdaterer CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Oppdaterer CoderRupee i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Oppdater CoderRupee i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Oppdater CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee er klar i {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee er klar.",
  "wsl.onboarding.installOpencodeIn": "Installer CoderRupee i {{distro}}.",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee er ikke installert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) kreves før CoderRupee kan legge til en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL er utilgjengelig",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee kunne ikke bekrefte WSL på denne maskinen.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Start Windows på nytt for å fullføre installasjonen av WSL, og åpne deretter CoderRupee på nytt.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop er nå bygget rundt faner.",
  "help.tabs.sessions":
