export const dict = {
  ...
  "desktop.menu.documentation": "ເອກະສານ CoderRupee",
  ...
  "desktop.menu.ariaLabel": "ເມນູ CoderRupee",
  ...
  "desktop.recovery.loadFailed": "CoderRupee ລົ້ມເຫລວໃນການໂຫລດ",
  "desktop.recovery.terminated": "ປ່ອງຢ້ຽມ CoderRupee ຖືກປິດໂດຍບໍ່ຄາດຄິດ",
  "desktop.recovery.unresponsive": "CoderRupee ບໍ່ຕອບສະໜອງ",
  ...
  "desktop.wsl.error.installOpencode": "ການຕິດຕັ້ງ CoderRupee ລົ້ມເຫລວ",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ຖືກເພີ່ມແລ້ວ",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ distro ນີ້",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee ຖືກຕິດຕັ້ງແຕ່ບໍ່ສາມາດດໍາເນີນການໄດ້",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee ບໍ່ໄດ້ຕິດຕັ້ງຢູ່ໃນ {{distro}}",
  "desktop.wsl.error.updateVersion":
    "ການປັບປຸງ CoderRupee ສໍາເລັດແລ້ວແຕ່ {{distro}} ຍັງລາຍງານ {{installed}}; ຄາດວ່າ {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "ແບບທີ່ຄັດສັນມາລວມທັງ Claude, GPT, Gemini ແລະອື່ນໆ",
  "dialog.provider.coderrupee.tagline": "ຮູບແບບການເພີ່ມປະສິດທິພາບທີ່ເຊື່ອຖືໄດ້",
  "dialog.provider.coderrupeeGo.tagline": "ການສະໝັກໃຊ້ລາຄາຕໍ່າສຳລັບທຸກຄົນ",
  ...
  "dialog.model.unpaid.freeModels.title": "ແບບຟຣີສະໜອງໃຫ້ໂດຍ CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "ໃສ່ລະຫັດ API {{provider}} ຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen ໃຫ້ທ່ານເຂົ້າເຖິງຊຸດຮູບແບບການປັບແຕ່ງທີ່ໜ້າເຊື່ອຖືໄດ້ສຳລັບຕົວແທນການເຂົ້າລະຫັດ.",
  "provider.connect.coderrupeeZen.line2":
    "ດ້ວຍລະຫັດ API ດຽວເຈົ້າຈະໄດ້ຮັບການເຂົ້າເຖິງຕົວແບບເຊັ່ນ: Claude, GPT, Gemini, GLM ແລະອື່ນໆ.",
  "provider.connect.coderrupeeZen.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "ເພື່ອເກັບກຳລະຫັດ API ຂອງທ່ານ.",
  "provider.connect.oauth.code.visit.prefix": "ຢ້ຽມຢາມ",
  "provider.connect.oauth.code.visit.link": "ລິ້ງນີ້",
  "provider.connect.oauth.code.visit.suffix":
    "ເພື່ອເກັບກຳລະຫັດການອະນຸຍາດຂອງທ່ານເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "ແລະໃສ່ລະຫັດຂ້າງລຸ່ມນີ້ເພື່ອເຊື່ອມຕໍ່ບັນຊີຂອງທ່ານ ແລະໃຊ້ຕົວແບບ {{provider}} ໃນ CoderRupee.",
  ...
  "dialog.plugins.empty": "ປລັກອິນຖືກຕັ້ງຄ່າໃນ coderrupee.json",
  ...
  "dialog.server.description": "ສະຫຼັບເຊີບເວີ CoderRupee ທີ່ແອັບຯນີ້ເຊື່ອມຕໍ່ກັບ.",
  ...
  "wsl.onboarding.checkingOpencode": "ກຳລັງກວດສອບ CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "ກຳລັງກວດສອບ CoderRupee ໃນ {{distro}}...",
  "wsl.onboarding.updatingOpencode": "ກຳລັງອັບເດດ CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "ກຳລັງອັບເດດ CoderRupee ໃນ {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "ອັບເດດ CoderRupee ໃນ {{distro}}.",
  "wsl.onboarding.updateOpencode": "ອັບເດດ CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee ແມ່ນພ້ອມແລ້ວໃນ {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee ພ້ອມແລ້ວ.",
  "wsl.onboarding.installOpencodeIn": "ຕິດຕັ້ງ CoderRupee ໃນ {{distro}}.",
  "wsl.onboarding.installOpencode": "ຕິດຕັ້ງ CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee ບໍ່ໄດ້ຕິດຕັ້ງ",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (ລະບົບຍ່ອຍຂອງ Windows ສໍາລັບ Linux) ກ່ອນທີ່ CoderRupee ສາມາດເພີ່ມເຄື່ອງແມ່ຂ່າຍ WSL ໄດ້",
  "wsl.onboarding.wslUnavailable.title": "WSL ບໍ່ສາມາດໃຊ້ໄດ້",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee ບໍ່ສາມາດກວດສອບ WSL ໃນເຄື່ອງນີ້ໄດ້.",
  "wsl.onboarding.installWsl": "ຕິດຕັ້ງ WSL",
  "wsl.onboarding.windowsRestartRequired": "ຣີສະຕາດ Windows ເພື່ອສຳເລັດການຕິດຕັ້ງ WSL, ຈາກນັ້ນເປີດ CoderRupee ຄືນໃໝ່.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop ຕອນນີ້ຖືກສ້າງຂຶ້ນໃນແຖບຕ່າງໆ.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "ເວີຊັນໃໝ່ຂອງ CoderRupee ({{version}}) ມີໃຫ້ຕິດຕັ້ງແລ້ວ.",
  ...
  "error.page.report.prefix": "ກະລຸນາລາຍງານຄວາມຜິດພາດນີ້ໃຫ້ທີມງານ CoderRupee",
  ...
  "error.chain.checkConfig": "ກວດເບິ່ງການຕັ້ງຄ່າ (coderrupee.json) ຜູ້ໃຫ້ບໍລິການ/ຊື່ແບບຈໍາລອງຂອງທ່ານ",
  "error.chain.mcpFailed": 'ເຊີບເວີ MCP "{{name}}" ລົ້ມເຫລວ. ໝາຍເຫດ, CoderRupee ບໍ່ຮອງຮັບການພິສູດຢືນຢັນ MCP ເທື່ອ.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee ປະກອບມີຮູບແບບຟຣີເພື່ອໃຫ້ທ່ານສາມາດເລີ່ມຕົ້ນໄດ້ທັນທີ.",
  ...
  "settings.desktop.wsl.description": "ແລ່ນເຊີບເວີ CoderRupee ພາຍໃນ WSL ໃນ Windows.",
  ...
  "settings.general.row.language.description": "ປ່ຽນພາສາສະແດງສໍາລັບ CoderRupee",
  ...
  "settings.general.row.appearance.description": "ປັບແຕ່ງວິທີ CoderRupee ເບິ່ງຢູ່ໃນອຸປະກອນຂອງທ່ານ",
  "settings.general.row.colorScheme.title": "ຮູບແບບສີ",
  "settings.general.row.colorScheme.description": "ເລືອກວ່າ CoderRupee ປະຕິບັດຕາມລະບົບ, ແສງສະຫວ່າງ, ຫຼືຮູບແບບຊ້ໍາ",
  "settings.general.row.theme.title": "ຫົວຂໍ້",
  "settings.general.row.theme.description": "ປັບແຕ່ງວິທີ CoderRupee ເປັນຫົວຂໍ້.",
  ...
  "settings.updates.row.startup.description": "ກວດສອບການອັບເດດໂດຍອັດຕະໂນມັດເມື່ອ CoderRupee ເປີດ",
  ...
  "settings.updates.toast.latest.description": "ທ່ານກຳລັງໃຊ້ CoderRupee ເວີຊັນຫຼ້າສຸດ.",
