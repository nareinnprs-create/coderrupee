...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee 載入失敗",
  "desktop.recovery.terminated": "CoderRupee 視窗意外終止",
  "desktop.recovery.unresponsive": "CoderRupee 沒有回應",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee 安裝失敗",
  "desktop.wsl.error.alreadyAdded": "已新增 {{distro}}",
  "desktop.wsl.error.coderrupeeMissing": "此發行版中未安裝 coderrupee",
  "desktop.wsl.error.coderrupeeCannotRun": "已安裝 coderrupee，但無法執行",
  "desktop.wsl.error.coderrupeeNotInstalled": "{{distro}} 中未安裝 CoderRupee",
  "desktop.wsl.error.updateVersion":
    "CoderRupee 更新完成，但 {{distro}} 回報的版本仍為 {{installed}}；預期版本為 {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "精選模型，包含 Claude、GPT、Gemini 等等",
  "dialog.provider.coderrupee.tagline": "經過最佳化的可靠模型",
  "dialog.provider.coderrupeeGo.tagline": "適合所有人的低成本訂閱",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupee 提供的免費模型",
  ...
  "provider.connect.apiKey.description":
    "輸入你的 {{provider}} API 金鑰以連線帳戶，並在 CoderRupee 中使用 {{provider}} 模型。",
  ...
  "provider.connect.coderrupeeZen.line1": "CoderRupee Zen 為你提供一組精選的可靠最佳化模型，用於程式碼代理程式。",
  "provider.connect.coderrupeeZen.line2": "只需一個 API 金鑰，你就能使用 Claude、GPT、Gemini、GLM 等模型。",
  "provider.connect.coderrupeeZen.visit.prefix": "造訪 ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " 取得你的 API 金鑰。",
  "provider.connect.oauth.code.visit.prefix": "造訪 ",
  "provider.connect.oauth.code.visit.link": "此連結",
  "provider.connect.oauth.code.visit.suffix": " 取得授權碼，以連線你的帳戶並在 CoderRupee 中使用 {{provider}} 模型。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " 並輸入以下程式碼，以連線你的帳戶並在 CoderRupee 中使用 {{provider}} 模型。",
  ...
  "dialog.plugins.empty": "在 coderrupee.json 中設定的外掛程式",
  ...
  "dialog.server.description": "切換此應用程式連線的 CoderRupee 伺服器。",
  ...
  "wsl.onboarding.checkingOpencode": "正在檢查 CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "正在檢查 {{distro}} 中的 CoderRupee...",
  ...
  "wsl.onboarding.coderrupeeReadyIn": "{{distro}} 中的 CoderRupee 已就緒。",
  "wsl.onboarding.coderrupeeReady": "CoderRupee 已就緒。",
  "wsl.onboarding.installOpencodeIn": "在 {{distro}} 中安裝 CoderRupee。",
  "wsl.onboarding.installOpencode": "安裝 CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "未安裝 CoderRupee",
  ...
  "wsl.onboarding.wslUnavailable.description": "CoderRupee 無法確認此電腦上的 WSL。",
  "wsl.onboarding.installWsl": "安裝 WSL",
  "wsl.onboarding.windowsRestartRequired": "重新啟動 Windows 以完成 WSL 安裝，然後重新開啟 CoderRupee。",
  ...
  "help.tabs.introduction": "CoderRupee Desktop 現在以分頁為核心。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupee 有新版本 ({{version}}) 可安裝。",
  ...
  "error.page.report.prefix": "請將此錯誤回報給 CoderRupee 團隊",
  ...
  "error.chain.checkConfig": "請檢查你的設定 (coderrupee.json) 中的 provider/model 名稱",
  "error.chain.mcpFailed": "MCP 伺服器「{{name}}」啟動失敗。注意：CoderRupee 尚不支援 MCP 驗證。",
  ...
  "sidebar.gettingStarted.line1": "CoderRupee 提供免費模型，你可以立即開始使用。",
  ...
  "settings.desktop.wsl.description": "在 Windows 上的 WSL 中執行 CoderRupee 伺服器。",
  ...
  "settings.general.row.language.description": "變更 CoderRupee 的顯示語言",
  ...
  "settings.general.row.appearance.description": "自訂 CoderRupee 在你的裝置上的外觀",
  "settings.general.row.colorScheme.title": "配色方案",
  "settings.general.row.colorScheme.description": "選擇 CoderRupee 要跟隨系統、淺色或深色主題",
  "settings.general.row.theme.title": "主題",
  "settings.general.row.theme.description": "自訂 CoderRupee 的主題。",
  ...
  "settings.updates.row.startup.description": "在 CoderRupee 啟動時自動檢查更新",
