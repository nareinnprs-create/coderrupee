export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentacioni CoderRupee",
  ...
  "desktop.menu.ariaLabel": "Menuja CoderRupee",
  ...
  "desktop.recovery.loadFailed": "CoderRupee nuk u ngarkua",
  "desktop.recovery.terminated": "Dritarja CoderRupee u mbyll papritur",
  "desktop.recovery.unresponsive": "CoderRupee nuk po përgjigjet",
  ...
  "desktop.wsl.error.installOpencode": "Instalimi i CoderRupee dështoi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} është shtuar tashmë",
  "desktop.wsl.error.coderrupeeMissing": "Opencode nuk është i instaluar në këtë shpërndarje",
  "desktop.wsl.error.coderrupeeCannotRun": "Opencode është instaluar por nuk mund të ekzekutohet",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee nuk është i instaluar në {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Përditësimi i CoderRupee përfundoi, por {{distro}} ende raporton {{installed}}; pritet {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Modele të kuruara duke përfshirë Claude, GPT, Gemini dhe më shumë",
  "dialog.provider.coderrupee.tagline": "Modele të besueshme të optimizuara",
  "dialog.provider.coderrupeeGo.tagline": "Abonim me kosto të ulët për të gjithë",
  ...
  "dialog.model.unpaid.freeModels.title": "Modele falas të ofruara nga CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Futni çelësin API të {{provider}} për të lidhur llogarinë dhe për të përdorur modelet {{provider}} në CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen ju jep akses në një grup të kuruar modelesh të optimizuara të besueshme për agjentët e kodimit.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Vizitoni ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " për të mbledhur çelësin tuaj API.",
  "provider.connect.oauth.code.visit.prefix": "Vizitoni ",
  "provider.connect.oauth.code.visit.link": "kjo lidhje",
  "provider.connect.oauth.code.visit.suffix":
    " për të mbledhur kodin tuaj të autorizimit për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dhe futni kodin më poshtë për të lidhur llogarinë tuaj dhe për të përdorur modelet {{provider}} në CoderRupee.",
  ...
  "dialog.plugins.empty": "Shtojcat e konfiguruara në coderrupee.json",
  ...
  "dialog.server.description": "Ndrysho me cilin server CoderRupee lidhet ky aplikacion.",
  ...
  "wsl.onboarding.checkingOpencode": "Po kontrollon CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Po kontrollon CoderRupee në {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CoderRupee po përditësohet...",
  "wsl.onboarding.updatingOpencodeIn": "Po përditëson CoderRupee në {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Përditëso CoderRupee në {{distro}}.",
  "wsl.onboarding.updateOpencode": "Përditëso CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee është gati në {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee është gati.",
  "wsl.onboarding.installOpencodeIn": "Instaloni CoderRupee në {{distro}}.",
  "wsl.onboarding.installOpencode": "Instaloni CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee nuk është i instaluar",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Nënsistemi Windows për Linux) kërkohet përpara se CoderRupee të shtojë një server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL i padisponueshëm",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nuk mund ta verifikonte WSL në këtë makinë.",
  "wsl.onboarding.installWsl": "Instaloni WSL",
  "wsl.onboarding.windowsRestartRequired": "Rinis Windows për të përfunduar instalimin e WSL, më pas rihap CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop tani është ndërtuar rreth skedave.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Një version i ri i CoderRupee ({{version}}) është tani i disponueshëm për t'u instaluar.",
  ...
  "error.page.report.prefix": "Ju lutemi raportoni këtë gabim te ekipi i CoderRupee",
  ...
  "error.chain.checkConfig": "Kontrolloni emrat e ofruesit/modelit tuaj të konfigurimit (coderrupee.json).",
  "error.chain.mcpFailed": 'Serveri MCP "{{name}}" dështoi. Shënim, CoderRupee nuk e mbështet ende vërtetimin MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee përfshin modele falas, kështu që mund të filloni menjëherë.",
  ...
  "settings.desktop.wsl.description": "Ekzekutoni serverin CoderRupee brenda WSL në Windows.",
  ...
  "settings.general.row.language.description": "Ndryshoni gjuhën e ekranit për CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personalizojeni se si duket CoderRupee në pajisjen tuaj",
  "settings.general.row.colorScheme.title": "Skema e ngjyrave",
  "settings.general.row.colorScheme.description":
    "Zgjidhni nëse CoderRupee ndjek temën e sistemit, të lehtë ose të errët",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizojeni se si është tema e CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Kontrolloni automatikisht për përditësime kur niset CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Ju jeni duke ekzekutuar versionin më të fundit të CoderRupee.",
