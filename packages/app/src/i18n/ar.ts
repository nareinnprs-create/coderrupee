export const dict = {
  ...
  "desktop.recovery.loadFailed": "فشل تحميل CoderRupee",
  "desktop.recovery.terminated": "توقفت نافذة CoderRupee بشكل غير متوقع",
  "desktop.recovery.unresponsive": "CoderRupee لا يستجيب",
  ...
  "desktop.wsl.error.installOpencode": "فشل تثبيت CoderRupee",
  "desktop.wsl.error.alreadyAdded": "تمت إضافة {{distro}} بالفعل",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee غير مثبت في هذه التوزيعة",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee مثبت، لكن تعذر تشغيله",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee غير مثبت في {{distro}}",
  "desktop.wsl.error.updateVersion":
    "اكتمل تحديث CoderRupee، لكن {{distro}} ما زالت تعرض الإصدار {{installed}}؛ الإصدار المتوقع هو {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "نماذج مختارة تتضمن Claude و GPT و Gemini والمزيد",
  "dialog.provider.coderrupee.tagline": "نماذج موثوقة ومحسنة",
  "dialog.provider.coderrupeeGo.tagline": "اشتراك منخفض التكلفة للجميع",
  ...
  "dialog.model.unpaid.freeModels.title": "نماذج مجانية مقدمة من CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "أدخل مفتاح API الخاص بـ {{provider}} لتوصيل حسابك واستخدام نماذج {{provider}} في CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "يمنحك CoderRupee Zen الوصول إلى مجموعة مختارة من النماذج الموثوقة والمحسنة لوكلاء البرمجة.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "قم بزيارة ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " للحصول على مفتاح API الخاص بك.",
  "provider.connect.oauth.code.visit.prefix": "قم بزيارة ",
  "provider.connect.oauth.code.visit.link": "هذا الرابط",
  "provider.connect.oauth.code.visit.suffix":
    " للحصول على رمز التفويض الخاص بك لتوصيل حسابك واستخدام نماذج {{provider}} في CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " وأدخل الرمز أدناه لتوصيل حسابك واستخدام نماذج {{provider}} في CoderRupee.",
  ...
  "dialog.plugins.empty": "الإضافات المكونة في coderrupee.json",
  ...
  "dialog.server.description": "تبديل خادم CoderRupee الذي يتصل به هذا التطبيق.",
  ...
  "wsl.onboarding.checkingOpencode": "جارٍ التحقق من CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "جارٍ التحقق من CoderRupee في {{distro}}...",
  "wsl.onboarding.updatingOpencode": "جارٍ تحديث CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "جارٍ تحديث CoderRupee في {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "حدّث CoderRupee في {{distro}}.",
  "wsl.onboarding.updateOpencode": "تحديث CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee جاهز في {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee جاهز.",
  "wsl.onboarding.installOpencodeIn": "ثبّت CoderRupee في {{distro}}.",
  "wsl.onboarding.installOpencode": "تثبيت CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee غير مثبت",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "يلزم WSL (نظام Windows الفرعي لـ Linux) قبل أن يتمكن CoderRupee من إضافة خادم WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL غير متاح",
  "wsl.onboarding.wslUnavailable.description": "تعذر على CoderRupee التحقق من WSL على هذا الجهاز.",
  "wsl.onboarding.installWsl": "تثبيت WSL",
  "wsl.onboarding.windowsRestartRequired": "أعد تشغيل Windows لإكمال تثبيت WSL، ثم أعد فتح CoderRupee.",
  ...
  "help.tabs.introduction": "أصبح CoderRupee Desktop الآن قائمًا على علامات التبويب.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "يتوفر الآن إصدار جديد من CoderRupee ({{version}}) للتثبيت.",
  ...
  "error.page.report.prefix": "يرجى الإبلاغ عن هذا الخطأ لفريق CoderRupee",
  ...
  "error.chain.checkConfig": "تحقق من أسماء الموفر/النموذج في التكوين (coderrupee.json)",
  "error.chain.mcpFailed": 'فشل خادم MCP "{{name}}". لاحظ أن CoderRupee لا يدعم مصادقة MCP بعد.',
  ...
  "sidebar.gettingStarted.line1": "يتضمن CoderRupee نماذج مجانية حتى تتمكن من البدء فورًا.",
  ...
  "settings.desktop.wsl.description": "تشغيل خادم CoderRupee داخل WSL على Windows.",
  ...
  "settings.general.row.language.description": "تغيير لغة العرض لـ CoderRupee",
  ...
  "settings.general.row.appearance.description": "تخصيص كيفية ظهور CoderRupee على جهازك",
  "settings.general.row.colorScheme.title": "مخطط الألوان",
  "settings.general.row.colorScheme.description": "اختر ما إذا كان CoderRupee يتبع سمة النظام أو الفاتح أو الداكن",
  "settings.general.row.theme.title": "السمة",
  "settings.general.row.theme.description": "تخصيص سمة CoderRupee.",
  ...
  "settings.updates.row.startup.description": "التحقق تلقائيًا من التحديثات عند تشغيل CoderRupee",
  ...
  "settings.updates.toast.latest.description": "أنت تستخدم أحدث إصدار من CoderRupee.",
