export const dict = {
  ...
  "desktop.menu.documentation": "Documentación de CoderRupee",
  ...
  "desktop.menu.ariaLabel": "Menú de CoderRupee",
  ...
  "desktop.recovery.loadFailed": "No se pudo cargar CoderRupee",
  "desktop.recovery.terminated": "La ventana de CoderRupee se cerró de forma inesperada",
  "desktop.recovery.unresponsive": "CoderRupee no responde",
  ...
  "desktop.wsl.error.installOpencode": "No se pudo instalar CoderRupee",
  "desktop.wsl.error.alreadyAdded": "Ya se ha añadido {{distro}}",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee no está instalado en esta distribución",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee está instalado, pero no se pudo ejecutar",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee no está instalado en {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La actualización de CoderRupee finalizó, pero {{distro}} sigue indicando {{installed}}; se esperaba {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Selección de modelos como Claude, GPT, Gemini y otros",
  "dialog.provider.coderrupee.tagline": "Modelos optimizados y fiables",
  "dialog.provider.coderrupeeGo.tagline": "Suscripción económica para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos proporcionados por CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Introduce tu clave API de {{provider}} para conectar tu cuenta y usar modelos de {{provider}} en CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen te da acceso a un conjunto curado de modelos fiables optimizados para agentes de programación.",
  ...
  "provider.connect.coderrupeeZen.visit.suffix": " para obtener tu clave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "este enlace",
  "provider.connect.oauth.code.visit.suffix":
    " para obtener tu código de autorización para conectar tu cuenta y usar modelos de {{provider}} en CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e introduce el código a continuación para conectar tu cuenta y usar modelos de {{provider}} en CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugins configurados en coderrupee.json",
  ...
  "dialog.server.description": "Cambiar el servidor de CoderRupee al que se conecta esta aplicación.",
  ...
  "wsl.onboarding.checkingOpencode": "Comprobando CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Comprobando CoderRupee en {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Actualizando CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Actualizando CoderRupee en {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualiza CoderRupee en {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualizar CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee está listo en {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee está listo.",
  "wsl.onboarding.installOpencodeIn": "Instala CoderRupee en {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee no está instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Se necesita WSL (Subsistema de Windows para Linux) para que CoderRupee pueda añadir un servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee no pudo comprobar WSL en este equipo.",
  "wsl.onboarding.installWsl": "Instalar WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicia Windows para terminar de instalar WSL y, después, vuelve a abrir CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop ahora se organiza en torno a pestañas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nueva versión de CoderRupee ({{version}}) está disponible para instalar.",
  ...
  "error.page.report.prefix": "Informa de este error al equipo de CoderRupee",
  ...
  "error.chain.checkConfig": "Comprueba los nombres de proveedor/modelo en tu configuración (coderrupee.json)",
  "error.chain.mcpFailed": 'El servidor MCP "{{name}}" falló. Nota: CoderRupee aún no admite la autenticación MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee incluye modelos gratuitos para que puedas empezar inmediatamente.",
  ...
  "settings.desktop.wsl.description": "Ejecutar el servidor CoderRupee dentro de WSL en Windows.",
  ...
  "settings.general.row.language.description": "Cambiar el idioma de visualización para CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personaliza cómo se ve CoderRupee en tu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de color",
  "settings.general.row.colorScheme.description": "Elige si CoderRupee sigue el tema del sistema, claro u oscuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personaliza el tema de CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Buscar actualizaciones automáticamente cuando se inicia CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Estás usando la última versión de CoderRupee.",
