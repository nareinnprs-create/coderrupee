export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Modelli selezionati tra cui Claude, GPT, Gemini e altri",
  "dialog.provider.coderrupee.tagline": "Modelli affidabili e ottimizzati",
  "dialog.provider.coderrupeeGo.tagline": "Abbonamento economico per tutti",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelli gratuiti forniti da CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Inserisci la chiave API di {{provider}} per connettere il tuo account e utilizzare i modelli {{provider}} in CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen offre l'accesso a una selezione di modelli affidabili e ottimizzati per gli agenti di programmazione.",
  "provider.connect.coderrupeeZen.line2":
    "Con una sola chiave API avrai accesso a modelli come Claude, GPT, Gemini, GLM e altri.",
  "provider.connect.coderrupeeZen.visit.prefix": "Visita ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " per ottenere la tua chiave API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "questo collegamento",
  "provider.connect.oauth.code.visit.suffix":
    " per ottenere il codice di autorizzazione, connettere il tuo account e usare i modelli {{provider}} in CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e inserisci il codice qui sotto per connettere il tuo account e usare i modelli {{provider}} in CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugin configurati in coderrupee.json",
  ...
  "dialog.server.description": "Cambia il server CoderRupee a cui si connette l'app.",
  ...
  "wsl.onboarding.checkingOpencode": "Controllo CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Controllo CoderRupee in {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Aggiornamento CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Aggiornamento CoderRupee in {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Aggiorna CoderRupee in {{distro}}.",
  "wsl.onboarding.updateOpencode": "Aggiorna CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee è pronto in {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee è pronto.",
  "wsl.onboarding.installOpencodeIn": "Installa CoderRupee in {{distro}}.",
  "wsl.onboarding.installOpencode": "Installa CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee non installato",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Sottosistema Windows per Linux) è necessario prima che CoderRupee possa aggiungere un server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL non disponibile",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee non ha potuto verificare WSL su questa macchina.",
  "wsl.onboarding.installWsl": "Installa WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Riavvia Windows per completare l'installazione WSL, quindi riapri CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop ora è incentrato sulle schede.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nuova versione di CoderRupee ({{version}}) è ora disponibile per l'installazione.",
  ...
  "error.page.report.prefix": "Segnala questo errore al team CoderRupee",
  ...
  "error.chain.checkConfig": "Controlla i nomi di provider e modelli nella configurazione (coderrupee.json)",
  "error.chain.mcpFailed":
    'Il server MCP "{{name}}" non ha funzionato. Nota: CoderRupee non supporta ancora l\'autenticazione MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee include modelli gratuiti così puoi iniziare immediatamente.",
  ...
  "settings.desktop.wsl.description": "Esegui il server CoderRupee all'interno di WSL su Windows.",
  ...
  "settings.general.row.language.description": "Cambia la lingua di visualizzazione per CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personalizza l'aspetto di CoderRupee sul tuo dispositivo",
  "settings.general.row.colorScheme.title": "Combinazione di colori",
  "settings.general.row.colorScheme.description": "Scegli se CoderRupee segue il tema di sistema, chiaro o scuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalizza il tema di CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Controlla automaticamente gli aggiornamenti all'avvio di CoderRupee",
  ...
  "settings.updates.toast.latest.title": "CoderRupee è aggiornato",
  "settings.updates.toast.latest.description": "Stai utilizzando l'ultima versione di CoderRupee.",
  ...
  "desktop.menu.documentation": "Documentazione di CoderRupee",
  ...
  "desktop.menu.ariaLabel": "Menu CoderRupee",
  ...
  "desktop.recovery.loadFailed": "Impossibile caricare CoderRupee",
  "desktop.recovery.terminated": "La finestra di CoderRupee si è chiusa in modo imprevisto",
  "desktop.recovery.unresponsive": "CoderRupee non risponde",
  ...
  "desktop.wsl.error.installOpencode": "Installazione di CoderRupee non riuscita",
  "desktop.wsl.error.alreadyAdded": "{{distro}} è già stata aggiunta",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee non è installato in questa distribuzione",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee è installato, ma non è stato possibile eseguirlo",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee non è installato in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "L'aggiornamento di CoderRupee è terminato, ma {{distro}} segnala ancora la versione {{installed}}; era prevista la versione {{expected}}",
