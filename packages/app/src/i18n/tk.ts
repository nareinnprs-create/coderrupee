export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee Resminamalar",
  ...
  "desktop.menu.ariaLabel": "CoderRupee menýusy",
  ...
  "desktop.recovery.loadFailed": "CoderRupee ýükläp bilmedi",
  "desktop.recovery.terminated": "CoderRupee penjiresi garaşylmadyk ýagdaýda bes edildi",
  "desktop.recovery.unresponsive": "CoderRupee jogap berenok",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee gurmak şowsuz",
  "desktop.wsl.error.alreadyAdded": "{{distro}} eýýäm goşuldy",
  "desktop.wsl.error.coderrupeeMissing": "açyk kod bu distroda gurlanok",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee guruldy, ýöne işledip bilmedi",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee {{distro}} gurulmady",
  "desktop.wsl.error.updateVersion":
    "CoderRupee täzelenmesi gutardy, ýöne {{distro}} henizem {{installed}} habar berýär; garaşylýan {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Claude, GPT, Gemini we ş.m.",
  "dialog.provider.coderrupee.tagline": "Ygtybarly optimal modeller",
  "dialog.provider.coderrupeeGo.tagline": "Hemmeler üçin arzan bahaly abuna",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupee tarapyndan mugt modeller",
  ...
  "provider.connect.apiKey.description":
    "Hasabyňyzy birikdirmek we CoderRupee-da {{provider}} modellerini ulanmak üçin {{provider}} API açaryňyzy giriziň.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen kodlaşdyrmak serişdeleri üçin ygtybarly optimallaşdyrylan modelleriň toplumyna girmäge mümkinçilik berýär.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Sapar ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " API açaryňyzy ýygnamak.",
  "provider.connect.oauth.code.visit.prefix": "Sapar ",
  "provider.connect.oauth.code.visit.link": "Bu baglanyşyk",
  "provider.connect.oauth.code.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini CoderRupee-de ulanmak üçin ygtyýarnama koduňyzy ýygnamak.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " hasabyňyzy birikdirmek we {{provider}} modellerini CoderRupee-de ulanmak üçin aşakdaky kody giriziň.",
  ...
  "dialog.plugins.empty": "coderrupee.json-de düzülen pluginler",
  ...
  "dialog.server.description": "Bu programmanyň haýsy CoderRupee serwerine birikýändigini üýtgediň.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee barlamak ...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CoderRupee barlanýar...",
  "wsl.onboarding.updatingOpencode": "CoderRupee täzelenmek ...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}-de CoderRupee täzelenmek ...",
  "wsl.onboarding.updateOpencodeIn": "CoderRupee-ni {{distro}}-de täzeläň.",
  "wsl.onboarding.updateOpencode": "CoderRupee täzeläň",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee {{distro}}-de taýýar.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee taýýar.",
  "wsl.onboarding.installOpencodeIn": "{{distro}}-de CoderRupee guruň.",
  "wsl.onboarding.installOpencode": "CoderRupee guruň",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee gurulmady",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Linux üçin Windows kiçi ulgamy) CoderRupee WSL serwerini goşmazdan ozal talap edilýär",
  "wsl.onboarding.wslUnavailable.title": "WSL elýeterli däl",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee bu enjamda WSL barlap bilmedi.",
  "wsl.onboarding.installWsl": "WSL guruň",
  "wsl.onboarding.windowsRestartRequired": "WSL gurnamagy gutarmak üçin Windows-i täzeden açyň, soňra CoderRupee açyň.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop indi goýmalaryň töwereginde guruldy.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Indi gurmak üçin CoderRupee ({{version}}) -iň täze wersiýasy bar.",
  ...
  "error.page.report.prefix": "Bu ýalňyşlygy CoderRupee toparyna habar bermegiňizi haýyş edýäris",
  ...
  "error.chain.checkConfig": "Konfigurasiýaňyzy (coderrupee.json) üpjün edijiniň / model atlaryny barlaň",
  "error.chain.mcpFailed": 'MCP serweri "{{name}}" şowsuz. Üns beriň, CoderRupee entek MCP tassyklamasyny goldamaýar.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee mugt modelleri öz içine alýar, derrew başlap bilersiňiz.",
  ...
  "settings.desktop.wsl.description": "CoderRupee serwerini WSL-de Windows-de işlediň.",
  ...
  "settings.general.row.language.description": "CoderRupee üçin displeý dilini üýtgediň",
  ...
  "settings.general.row.appearance.description": "CoderRupee enjamyňyzda nähili görünýändigini düzüň",
  "settings.general.row.colorScheme.title": "Reňk shemasy",
  "settings.general.row.colorScheme.description":
    "CoderRupee ulgamy, ýagtylygy ýa-da garaňky temany yzarlaýandygyny saýlaň",
  "settings.general.row.theme.title": "Mowzuk",
  "settings.general.row.theme.description": "CoderRupee-iň mowzuklydygyny düzüň.",
  ...
  "settings.updates.row.startup.description": "CoderRupee işe başlanda täzelenmeleri awtomatiki barlaň",
  ...
  "settings.updates.toast.latest.description": "CoderRupee-iň iň soňky wersiýasyny işleýärsiňiz.",
