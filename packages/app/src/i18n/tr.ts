...
export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee yüklenemedi",
  "desktop.recovery.terminated": "CoderRupee penceresi beklenmedik şekilde sonlandırıldı",
  "desktop.recovery.unresponsive": "CoderRupee yanıt vermiyor",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee kurulamadı",
  "desktop.wsl.error.alreadyAdded": "{{distro}} zaten eklendi",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee bu dağıtımda kurulu değil",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee kurulu ancak çalıştırılamadı",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee, {{distro}} içinde kurulu değil",
  "desktop.wsl.error.updateVersion":
    "CoderRupee güncellemesi tamamlandı ancak {{distro}} hâlâ {{installed}} sürümünü bildiriyor; beklenen sürüm: {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Claude, GPT, Gemini ve daha fazlasını içeren seçilmiş modeller",
  "dialog.provider.coderrupee.tagline": "Güvenilir, optimize edilmiş modeller",
  "dialog.provider.coderrupeeGo.tagline": "Herkes için düşük maliyetli abonelik",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupee tarafından sunulan ücretsiz modeller",
  ...
  "provider.connect.apiKey.description":
    "{{provider}} hesabınızı bağlamak ve CoderRupee'da {{provider}} modellerini kullanmak için API anahtarınızı girin.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen, kodlama ajanları için seçilmiş güvenilir optimize edilmiş modellere erişim sağlar.",
  ...
  "provider.connect.coderrupeeZen.visit.suffix": " adresini ziyaret ederek API anahtarınızı alın.",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " gidin; ardından hesabınızı bağlayarak CoderRupee'da {{provider}} modellerini kullanın.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " tıklayarak aşağıdaki kodu girin ve hesabınızı bağlayarak CoderRupee'da {{provider}} modellerini kullanın.",
  ...
  "dialog.plugins.empty": "Eklentiler coderrupee.json içinde yapılandırılır",
  ...
  "dialog.server.description": "Bu uygulamanın hangi CoderRupee sunucusuna bağlanacağını değiştirin.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee kontrol ediliyor...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}} içinde CoderRupee kontrol ediliyor...",
  "wsl.onboarding.updatingOpencode": "CoderRupee güncelleniyor...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}} içinde CoderRupee güncelleniyor...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}} içindeki CoderRupee'u güncelleyin.",
  "wsl.onboarding.updateOpencode": "CoderRupee'u güncelle",
  "wsl.onboarding.coderrupeeReadyIn": "{{distro}} içinde CoderRupee hazır.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee hazır.",
  "wsl.onboarding.installOpencodeIn": "CoderRupee'u {{distro}} içine kurun.",
  "wsl.onboarding.installOpencode": "CoderRupee'u kur",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee kurulu değil",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CoderRupee'un WSL sunucusu ekleyebilmesi için önce WSL (Linux için Windows Alt Sistemi) kurulmalıdır",
  "wsl.onboarding.wslUnavailable.title": "WSL kullanılamıyor",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee bu makinede WSL'yi doğrulayamadı.",
  "wsl.onboarding.installWsl": "WSL'yi kur",
  "wsl.onboarding.windowsRestartRequired":
    "WSL kurulumunu tamamlamak için Windows'u yeniden başlatın, ardından CoderRupee'u tekrar açın.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop artık sekmeler üzerine kurulu.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupee'un yeni bir sürümü ({{version}}) yüklemeye hazır.",
  ...
  "error.page.report.prefix": "Lütfen bu hatayı CoderRupee ekibine",
  ...
  "error.chain.checkConfig": "Yapılandırma dosyanızdaki (coderrupee.json) sağlayıcı/model adlarını kontrol edin",
  "error.chain.mcpFailed":
    'MCP sunucusu "{{name}}" çalıştırılamadı. Not: CoderRupee henüz MCP kimlik doğrulamasını desteklemiyor.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee ücretsiz modeller içerir, böylece hemen başlayabilirsiniz.",
  ...
  "app.name.desktop": "CoderRupee Masaüstü",
  ...
  "settings.desktop.wsl.description": "CoderRupee sunucusunu Windows'ta WSL içinde çalıştırın.",
  ...
  "settings.general.row.language.description": "CoderRupee'un görünüm dilini değiştirin",
  ...
  "settings.general.row.appearance.description": "CoderRupee'un cihazınızdaki görünümünü özelleştirin",
  "settings.general.row.colorScheme.title": "Renk şeması",
  "settings.general.row.colorScheme.description":
    "CoderRupee'un sistem, açık veya koyu temayı takip etip etmeyeceğini seçin",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "CoderRupee'un temasını özelleştirin.",
  ...
  "settings.updates.row.startup.description": "CoderRupee başladığında otomatik güncelleme kontrolü yap",
  ...
  "settings.updates.toast.latest.description": "CoderRupee'un en son sürümünü kullanıyorsunuz.",
