export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee መጫን አልቻለም",
  "desktop.recovery.terminated": "CoderRupee መስኮት በድንገት ተቋርጧል",
  "desktop.recovery.unresponsive": "CoderRupee ምላሽ እየሰጠ አይደለም",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupeeመጫኑ አልተሳካም",
  "desktop.wsl.error.alreadyAdded": "{{distro}} አስቀድሞ ታክሏል",
  "desktop.wsl.error.coderrupeeMissing": "ክፍት ኮድ በዚህ ዲስትሪ ውስጥ አልተጫነም",
  "desktop.wsl.error.coderrupeeCannotRun": "ክፍት ኮድ ተጭኗል ግን ማሄድ አልቻለም",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee በ{{distro}}] ውስጥ አልተጫነም",
  "desktop.wsl.error.updateVersion":
    "CoderRupee ዝማኔ አልቋል ግን {{distro}} አሁንም ሪፖርት ያደርጋል {{installed}}; የሚጠበቀው {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Claude፣ GPT፣ Gemini እና ሌሎችንም ጨምሮ የተስተካከሉ ሞዴሎች",
  "dialog.provider.coderrupee.tagline": "ታማኝ የተመቻቹ ሞዴሎች",
  "dialog.provider.coderrupeeGo.tagline": "ዝቅተኛ ወጪ ለሁሉም ሰው",
  ...
  "dialog.model.unpaid.freeModels.title": "ነጻ ሞዴሎች በCoderRupee",
  ...
  "provider.connect.apiKey.description":
    "መለያዎን ለማገናኘት የ{{provider}} API ቁልፍዎን ያስገቡ እና {{provider}} ሞዴሎችን በCoderRupee ይጠቀሙ።",
  ...
  "provider.connect.coderrupeeZen.line1": "CoderRupee ዜን ለኮድ ወኪሎች የተመቻቹ አስተማማኝ ሞዴሎች ስብስብ መዳረሻ ይሰጥዎታል።",
  "provider.connect.coderrupeeZen.line2": "በአንድ የAPI ቁልፍ እንደ Claude፣ GPT፣ Gemini፣ GLM እና ሌሎችም ያሉ ሞዴሎችን መድረስ ይችላሉ።",
  "provider.connect.coderrupeeZen.visit.prefix": "ጎብኝ ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " የእርስዎን API ቁልፍ ለመሰብሰብ።",
  "provider.connect.oauth.code.visit.prefix": "ጎብኝ ",
  "provider.connect.oauth.code.visit.link": "ይህ ሊንክ",
  "provider.connect.oauth.code.visit.suffix":
    " መለያዎን ለማገናኘት የፈቀዳ ኮድዎን ለመሰብሰብ እና {{provider}} ሞዴሎችን በCoderRupee ውስጥ ይጠቀሙ።",
  ...
  "provider.connect.oauth.auto.visit.suffix": " እና መለያዎን ለማገናኘት ከታች ያለውን ኮድ ያስገቡ እና {{provider}} ሞዴሎችን በCoderRupee ይጠቀሙ።",
  ...
  "dialog.plugins.empty": "plugins በ coderrupee.json የተዋቀሩ",
  ...
  "dialog.server.description": "ይህ መተግበሪያ ከየትኛው CoderRupee አገልጋይ ጋር እንደሚገናኝ ይቀይሩ።",
  ...
  "wsl.onboarding.checkingOpencode": "መፈተሽ CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "CoderRupeeን በ{{distro}} ውስጥ በመፈተሽ ላይ...",
  "wsl.onboarding.updatingOpencode": "በማዘመን ላይ CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "በማዘመን ላይ CoderRupee በ{{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "አዘምን CoderRupee በ{{distro}}።",
  "wsl.onboarding.updateOpencode": "አዘምን CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee በ{{distro}} ውስጥ ዝግጁ ነው።",
  "wsl.onboarding.coderrupeeReady": "CoderRupee ዝግጁ ነው።",
  "wsl.onboarding.installOpencodeIn": "መጫን CoderRupee በ{{distro}} ውስጥ።",
  "wsl.onboarding.installOpencode": "ጫን CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupeeአልተጫነም",
  ...
  "wsl.onboarding.wslNotInstalled.description": "WSL (Windowsንዑስ ስርዓት ለLinux) CoderRupee WSL አገልጋይ ከመጨመራቸው በፊት ያስፈልጋል",
  "wsl.onboarding.wslUnavailable.title": "WSL አይገኝም",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee በዚህ ማሽን ላይ WSLን ማረጋገጥ አልቻለም።",
  "wsl.onboarding.installWsl": "ጫን WSL",
  "wsl.onboarding.windowsRestartRequired": "WSLን መጫኑን ለመጨረስ Windows እንደገና ያስጀምሩ እና ከዚያ እንደገና ይክፈቱ CoderRupee።",
  ...
  "help.tabs.introduction": "CoderRupee ዴስክቶፕ አሁን በትሮች ዙሪያ ነው የተሰራው።",
  "help.tabs.sessions":
  ...
  "toast.update.description": "አዲሱ የCoderRupee ({{version}}) ስሪት አሁን ለመጫን አለ።",
  ...
  "error.page.report.prefix": "እባክዎ ይህንን ስህተት ለCoderRupee ቡድን ያሳውቁ",
  ...
  "error.chain.checkConfig": "የእርስዎን ውቅር (coderrupee.json) አቅራቢ/የሞዴል ስሞችን ያረጋግጡ",
  "error.chain.mcpFailed": 'MCP አገልጋይ "{{name}}" አልተሳካም። ማስታወሻ፣ CoderRupee እስካሁን MCP ማረጋገጫን አይደግፍም።',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee ነፃ ሞዴሎችን ያካትታል ስለዚህ ወዲያውኑ መጀመር ይችላሉ።",
  ...
  "app.name.desktop": "CoderRupee ዴስክቶፕ",
  ...
  "settings.desktop.wsl.description": "የCoderRupee አገልጋዩን በWSL ውስጥ በWindows ላይ ያሂዱ።",
  ...
  "settings.general.row.language.description": "የማሳያ ቋንቋውን ለCoderRupee",
  ...
  "settings.general.row.appearance.description": "CoderRupeeበመሣሪያዎ ላይ እንዴት እንደሚታይ ብጁ ያድርጉ",
  "settings.general.row.colorScheme.title": "የቀለም ንድፍ",
  "settings.general.row.colorScheme.description": "CoderRupee ስርዓቱን፣ ብርሃንን ወይም ጨለማውን ገጽታ የሚከተል እንደሆነ ምረጥ",
  "settings.general.row.theme.title": "ገጽታ",
  "settings.general.row.theme.description": "CoderRupee ገጽታ እንዴት እንደሆነ አብጅ።",
  ...
  "settings.updates.row.startup.description": "CoderRupee ሲጀመር ዝማኔዎችን በራስ-ሰር ያረጋግጡ",
  ...
  "settings.updates.toast.latest.description": "የቅርብ ጊዜውን የCoderRupee እትም እያሄዱ ነው።",
