export const dict = {
  ...
  "desktop.menu.documentation": "Documentação do CoderRupee",
  ...
  "desktop.menu.ariaLabel": "Menu do CoderRupee",
  ...
  "desktop.recovery.loadFailed": "Falha ao carregar o CoderRupee",
  "desktop.recovery.terminated": "A janela do CoderRupee foi encerrada inesperadamente",
  "desktop.recovery.unresponsive": "O CoderRupee não está respondendo",
  ...
  "desktop.wsl.error.installOpencode": "Falha na instalação do CoderRupee",
  "desktop.wsl.error.alreadyAdded": "{{distro}} já foi adicionada",
  "desktop.wsl.error.coderrupeeMissing": "O coderrupee não está instalado nesta distribuição",
  "desktop.wsl.error.coderrupeeCannotRun": "O coderrupee está instalado, mas não pôde ser executado",
  "desktop.wsl.error.coderrupeeNotInstalled": "O CoderRupee não está instalado em {{distro}}",
  "desktop.wsl.error.updateVersion":
    "A atualização do CoderRupee foi concluída, mas {{distro}} ainda informa a versão {{installed}}; a versão esperada é {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Modelos selecionados incluindo Claude, GPT, Gemini e mais",
  "dialog.provider.coderrupee.tagline": "Modelos otimizados e confiáveis",
  "dialog.provider.coderrupeeGo.tagline": "Assinatura de baixo custo para todos",
  ...
  "dialog.model.unpaid.freeModels.title": "Modelos gratuitos fornecidos pelo CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Digite sua chave de API do {{provider}} para conectar sua conta e usar modelos do {{provider}} no CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen oferece acesso a um conjunto selecionado de modelos confiáveis otimizados para agentes de código.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Visite ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " para obter sua chave de API.",
  "provider.connect.oauth.code.visit.prefix": "Visite ",
  "provider.connect.oauth.code.visit.link": "este link",
  "provider.connect.oauth.code.visit.suffix":
    " para obter seu código de autorização e conectar sua conta para usar modelos do {{provider}} no CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " e digite o código abaixo para conectar sua conta e usar modelos do {{provider}} no CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugins configurados em coderrupee.json",
  ...
  "dialog.server.description": "Trocar para qual servidor CoderRupee este aplicativo se conecta.",
  ...
  "wsl.onboarding.checkingOpencode": "Verificando o CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Verificando o CoderRupee em {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Atualizando o CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Atualizando o CoderRupee em {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Atualize o CoderRupee em {{distro}}.",
  "wsl.onboarding.updateOpencode": "Atualizar o CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "O CoderRupee está pronto em {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "O CoderRupee está pronto.",
  "wsl.onboarding.installOpencodeIn": "Instale o CoderRupee em {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalar o CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee não instalado",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "O WSL (Windows Subsystem for Linux) é necessário para que o CoderRupee possa adicionar um servidor WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponível",
  "wsl.onboarding.wslUnavailable.description": "O CoderRupee não conseguiu verificar o WSL neste computador.",
  "wsl.onboarding.installWsl": "Instalar o WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicie o Windows para concluir a instalação do WSL e abra o CoderRupee novamente.",
  ...
  "help.tabs.introduction": "Agora, o CoderRupee Desktop é organizado em abas.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Uma nova versão do CoderRupee ({{version}}) está disponível para instalação.",
  ...
  "error.page.report.prefix": "Por favor, reporte este erro para a equipe do CoderRupee",
  ...
  "error.chain.checkConfig": "Verifique os nomes de provedor/modelo na sua configuração (coderrupee.json)",
  "error.chain.mcpFailed": 'Servidor MCP "{{name}}" falhou. Nota: CoderRupee ainda não suporta autenticação MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee inclui modelos gratuitos para você começar imediatamente.",
  ...
  "settings.desktop.wsl.description": "Executar o servidor CoderRupee dentro do WSL no Windows.",
  ...
  "settings.general.row.language.description": "Alterar o idioma de exibição do CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personalize como o CoderRupee aparece no seu dispositivo",
  "settings.general.row.colorScheme.title": "Esquema de cores",
  "settings.general.row.colorScheme.description": "Escolha se o CoderRupee segue o tema do sistema, claro ou escuro",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalize como o CoderRupee é tematizado.",
  ...
  "settings.updates.row.startup.description": "Verificar atualizações automaticamente quando o CoderRupee iniciar",
  ...
  "settings.updates.toast.latest.description": "Você está usando a versão mais recente do CoderRupee.",
