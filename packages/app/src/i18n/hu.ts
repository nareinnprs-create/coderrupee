...
const desktop = [
  ...
  "Kilépés",
  "Az CoderRupee betöltése sikertelen",
  "Az CoderRupee ablaka váratlanul leállt",
  "Az CoderRupee nem válaszol",
  ...
  "Az CoderRupee telepítése sikertelen",
  "A(z) {{distro}} már hozzá van adva",
  "Az coderrupee nincs telepítve ebben a disztribúcióban",
  "Az coderrupee telepítve van, de nem futtatható",
  "Az CoderRupee nincs telepítve ebben: {{distro}}",
  "Az CoderRupee frissítése befejeződött, de a(z) {{distro}} továbbra is ezt jelenti: {{installed}}; a várt érték: {{expected}}",
  "nincs verzió",
...
export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Összeválogatott modellek, köztük Claude, GPT, Gemini és még sok más",
  "dialog.provider.coderrupee.tagline": "Megbízható optimalizált modellek",
  "dialog.provider.coderrupeeGo.tagline": "Olcsó előfizetés mindenki számára",
  ...
  "dialog.model.unpaid.freeModels.title": "A CoderRupee ingyenes modelljei",
  ...
  "provider.connect.apiKey.description":
    "Enter az Ön {{provider}} API kulcsa fiókja összekapcsolásához és a {{provider}} modellek használatához a CoderRupee-ben.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "A CoderRupee Zen hozzáférést biztosít a kódoló ügynökök számára megbízható, optimalizált modellek válogatott készletéhez.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Látogatás",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "hogy átvegye a API kulcsát.",
  "provider.connect.oauth.code.visit.prefix": "Látogatás",
  "provider.connect.oauth.code.visit.link": "ezt a linket",
  "provider.connect.oauth.code.visit.suffix":
    "az engedélyezési kód összegyűjtéséhez fiókja összekapcsolásához és a {{provider}} modellek használatához a CoderRupee-ben.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "és írja be az alábbi kódot fiókja összekapcsolásához, és használja a {{provider}} modelleket a CoderRupee-ben.",
  ...
  "dialog.plugins.empty": "Az coderrupee.json fájlban konfigurált beépülő modulok",
  ...
  "dialog.server.description": "Állítsa be, hogy ez az alkalmazás melyik CoderRupee szerverhez csatlakozzon.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee ellenőrzése...",
  "wsl.onboarding.checkingOpencodeIn": "CoderRupee ellenőrzése a {{distro}}-ben...",
  "wsl.onboarding.updatingOpencode": "CoderRupee frissítése...",
  "wsl.onboarding.updatingOpencodeIn": "CoderRupee frissítése a {{distro}}-ben...",
  "wsl.onboarding.updateOpencodeIn": "Frissítse a CoderRupee-t a {{distro}}-ben.",
  "wsl.onboarding.updateOpencode": "Frissítse a CoderRupee-t",
  "wsl.onboarding.coderrupeeReadyIn": "A CoderRupee készen áll a {{distro}}-ben.",
  "wsl.onboarding.coderrupeeReady": "A CoderRupee készen áll.",
  "wsl.onboarding.installOpencodeIn": "Telepítse a CoderRupee-t a {{distro}}-be.",
  "wsl.onboarding.installOpencode": "Telepítse a CoderRupee-t",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "A CoderRupee nincs telepítve",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "A WSL (Windows alrendszer a Linux számára) szükséges ahhoz, hogy a CoderRupee hozzáadhasson egy WSL szervert",
  "wsl.onboarding.wslUnavailable.title": "A WSL nem elérhető",
  "wsl.onboarding.wslUnavailable.description": "A CoderRupee nem tudta ellenőrizni a WSL jelet ezen a gépen.",
  "wsl.onboarding.installWsl": "Telepítse a WSL-t",
  "wsl.onboarding.windowsRestartRequired":
    "Indítsa újra a Windows programot a WSL telepítésének befejezéséhez, majd nyissa meg újra a CoderRupee programot.",
  ...
  "help.tabs.introduction": "A CoderRupee Desktop mostantól lapokra épül.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "A CoderRupee ({{version}}) új verziója már telepíthető.",
  ...
  "error.page.report.prefix": "Kérjük, jelentse ezt a hibát a CoderRupee csapatának",
  ...
  "error.chain.checkConfig": "Ellenőrizze a konfigurációs (coderrupee.json) szolgáltató/modell nevét",
  "error.chain.mcpFailed":
    'A "{{name}}" MCP szerver meghibásodott. Megjegyzés: a CoderRupee még nem támogatja a MCP hitelesítést.',
  ...
  "sidebar.gettingStarted.line1": "A CoderRupee ingyenes modelleket tartalmaz, így azonnal elkezdheti.",
  ...
  "app.name.desktop": "CoderRupee asztali számítógép",
  ...
  "settings.desktop.wsl.description": "Futtassa a CoderRupee szervert a WSL belsejében a Windows rendszeren.",
  ...
  "settings.general.row.language.description": "Módosítsa a CoderRupee kijelző nyelvét",
  ...
  "settings.general.row.appearance.description": "Szabja személyre, hogyan néz ki a CoderRupee az eszközén",
  "settings.general.row.colorScheme.title": "Színséma",
  "settings.general.row.colorScheme.description":
    "Válassza ki, hogy a CoderRupee a rendszer, a világos vagy a sötét témát követi-e",
  "settings.general.row.theme.title": "Téma",
  "settings.general.row.theme.description": "Szabja személyre a CoderRupee témáját.",
  ...
  "settings.updates.row.startup.description": "A CoderRupee indításakor automatikusan ellenőrizze a frissítéseket",
  ...
  "settings.updates.toast.latest.description": "Ön a CoderRupee legújabb verzióját futtatja.",
