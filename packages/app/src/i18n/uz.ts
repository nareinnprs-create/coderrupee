export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee hujjatlari",
  ...
  "desktop.menu.ariaLabel": "CoderRupee menyusi",
  ...
  "desktop.recovery.loadFailed": "CoderRupee yuklanmadi",
  "desktop.recovery.terminated": "CoderRupee oynasi kutilmaganda tugatildi",
  "desktop.recovery.unresponsive": "CoderRupee javob bermayapti",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee oʻrnatilmadi",
  "desktop.wsl.error.alreadyAdded": "{{distro}} allaqachon qo'shilgan",
  "desktop.wsl.error.coderrupeeMissing": "Opencode ushbu tarqatishda o'rnatilmagan",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee o'rnatilgan, lekin ishga tushirilmadi",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee {{distro}} da o'rnatilmagan",
  "desktop.wsl.error.updateVersion":
    "CoderRupee yangilanishi tugallandi, lekin {{distro}} hali ham {{installed}} haqida xabar beradi; kutilgan {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Tanlangan modellar, jumladan Claude, GPT, Gemini va boshqalar",
  "dialog.provider.coderrupee.tagline": "Ishonchli optimallashtirilgan modellar",
  "dialog.provider.coderrupeeGo.tagline": "Hamma uchun arzon obuna",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupee tomonidan taqdim etilgan bepul modellar",
  ...
  "provider.connect.apiKey.description":
    "Hisobingizni ulash va CoderRupee’da {{provider}} modellaridan foydalanish uchun {{provider}} API kalitini kiriting.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen sizga kodlash agentlari uchun ishonchli optimallashtirilgan modellar to'plamiga kirish imkonini beradi.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Tashrif buyuring ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " API kalitingizni olish uchun.",
  "provider.connect.oauth.code.visit.prefix": "Tashrif buyuring ",
  "provider.connect.oauth.code.visit.link": "bu havola",
  "provider.connect.oauth.code.visit.suffix":
    " hisobingizni ulash va CoderRupee da {{provider}} modellaridan foydalanish uchun avtorizatsiya kodingizni yig'ish.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " va hisobingizni ulash uchun quyidagi kodni kiriting va CoderRupee da {{provider}} modellaridan foydalaning.",
  ...
  "dialog.plugins.empty": "coderrupee.json da sozlangan plaginlar",
  ...
  "dialog.server.description": "Ushbu ilova qaysi CoderRupee serveriga ulanishini almashtiring.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee tekshirilmoqda...",
  "wsl.onboarding.checkingOpencodeIn": "CoderRupee {{distro}} da tekshirilmoqda...",
  "wsl.onboarding.updatingOpencode": "CoderRupee yangilanmoqda...",
  "wsl.onboarding.updatingOpencodeIn": "CoderRupee {{distro}} da yangilanmoqda...",
  "wsl.onboarding.updateOpencodeIn": "CoderRupee-ni {{distro}}-da yangilang.",
  "wsl.onboarding.updateOpencode": "CoderRupee-ni yangilang",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee {{distro}} da tayyor.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee tayyor.",
  "wsl.onboarding.installOpencodeIn": "CoderRupee-ni {{distro}}-ga o'rnating.",
  "wsl.onboarding.installOpencode": "CoderRupee-ni o'rnating",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee o'rnatilmagan",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CoderRupee WSL serverini qoʻshishdan oldin WSL (Linux uchun Windows quyi tizimi) talab qilinadi.",
  "wsl.onboarding.wslUnavailable.title": "WSL mavjud emas",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee WSL ni ushbu mashinada tasdiqlay olmadi.",
  "wsl.onboarding.installWsl": "WSL-ni o'rnating",
  "wsl.onboarding.windowsRestartRequired":
    "WSL-ni o'rnatishni tugatish uchun Windows-ni qayta ishga tushiring, so'ngra CoderRupee-ni qayta oching.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop endi yorliqlar atrofida qurilgan.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupee ({{version}}) yangi versiyasi endi oʻrnatish mumkin.",
  ...
  "error.page.report.prefix": "Iltimos, ushbu xato haqida CoderRupee jamoasiga xabar bering",
  ...
  "error.chain.checkConfig": "Konfiguratsiya (coderrupee.json) provayder/model nomlarini tekshiring",
  "error.chain.mcpFailed":
    "MCP \"{{name}}\" serveri muvaffaqiyatsiz tugadi. E'tibor bering, CoderRupee hali MCP autentifikatsiyasini qo'llab-quvvatlamaydi.",
  ...
  "sidebar.gettingStarted.line1":
    "CoderRupee bepul modellarni o'z ichiga oladi, shuning uchun siz darhol boshlashingiz mumkin.",
  ...
  "settings.desktop.wsl.description": "Windows da WSL ichidagi CoderRupee serverini ishga tushiring.",
  ...
  "settings.general.row.language.description": "CoderRupee uchun ekran tilini o'zgartiring",
  ...
  "settings.general.row.appearance.description": "CoderRupee qurilmangizda qanday koʻrinishini sozlang",
  "settings.general.row.colorScheme.title": "Rang sxemasi",
  "settings.general.row.colorScheme.description":
    "CoderRupee tizimga, yorugʻlik yoki qorongʻi mavzuga amal qilishini tanlang",
  "settings.general.row.theme.title": "Mavzu",
  "settings.general.row.theme.description": "CoderRupee mavzusini sozlash.",
  ...
  "settings.updates.row.startup.description": "CoderRupee ishga tushganda avtomatik ravishda yangilanishlarni tekshiring",
  ...
  "settings.updates.toast.latest.description": "Siz CoderRupee oxirgi versiyasini ishga tushiryapsiz.",
