...
export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Kuratierte Modelle inklusive Claude, GPT, Gemini und mehr",
  "dialog.provider.coderrupee.tagline": "Zuverlässige, optimierte Modelle",
  "dialog.provider.coderrupeeGo.tagline": "Kostengünstiges Abo für alle",
  ...
  "dialog.model.unpaid.freeModels.title": "Kostenlose Modelle von CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Geben Sie Ihren API-Schlüssel für {{provider}} ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CoderRupee zu nutzen.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen bietet Ihnen Zugriff auf eine kuratierte Auswahl zuverlässiger, optimierter Modelle für Coding-Agenten.",
  "provider.connect.coderrupeeZen.line2":
    "Mit einem einzigen API-Schlüssel erhalten Sie Zugriff auf Modelle wie Claude, GPT, Gemini, GLM und mehr.",
  "provider.connect.coderrupeeZen.visit.prefix": "Besuchen Sie ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": ", um Ihren API-Schlüssel zu erhalten.",
  "provider.connect.oauth.code.visit.prefix": "Besuchen Sie ",
  "provider.connect.oauth.code.visit.link": "diesen Link",
  "provider.connect.oauth.code.visit.suffix":
    ", um Ihren Autorisierungscode zu erhalten, Ihr Konto zu verbinden und {{provider}}-Modelle in CoderRupee zu nutzen.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " und geben Sie den untenstehenden Code ein, um Ihr Konto zu verbinden und {{provider}}-Modelle in CoderRupee zu nutzen.",
  ...
  "dialog.plugins.empty": "In coderrupee.json konfigurierte Plugins",
  ...
  "dialog.server.description": "Wechseln Sie den CoderRupee-Server, mit dem sich diese App verbindet.",
  ...
  "wsl.onboarding.step.coderrupee": "CoderRupee",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee wird geprüft…",
  "wsl.onboarding.checkingOpencodeIn": "CoderRupee in {{distro}} wird geprüft…",
  "wsl.onboarding.updatingOpencode": "CoderRupee wird aktualisiert…",
  "wsl.onboarding.updatingOpencodeIn": "CoderRupee in {{distro}} wird aktualisiert…",
  "wsl.onboarding.updateOpencodeIn": "Aktualisieren Sie CoderRupee in {{distro}}.",
  "wsl.onboarding.updateOpencode": "CoderRupee aktualisieren",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee ist in {{distro}} bereit.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee ist bereit.",
  "wsl.onboarding.installOpencodeIn": "Installieren Sie CoderRupee in {{distro}}.",
  "wsl.onboarding.installOpencode": "CoderRupee installieren",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee nicht installiert",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) ist erforderlich, bevor CoderRupee einen WSL-Server hinzufügen kann",
  "wsl.onboarding.wslUnavailable.title": "WSL nicht verfügbar",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee konnte WSL auf diesem Computer nicht überprüfen.",
  "wsl.onboarding.installWsl": "WSL installieren",
  "wsl.onboarding.windowsRestartRequired":
    "Starten Sie Windows neu, um die WSL-Installation abzuschließen, und öffnen Sie dann CoderRupee erneut.",
  ...
  "toast.update.description": "Eine neue Version von CoderRupee ({{version}}) ist zur Installation verfügbar.",
  ...
  "error.page.report.prefix": "Bitte melden Sie diesen Fehler dem CoderRupee-Team",
  ...
  "error.chain.checkConfig": "Überprüfen Sie die Anbieter- und Modellnamen in Ihrer Konfiguration (coderrupee.json)",
  "error.chain.mcpFailed":
    'MCP-Server "{{name}}" fehlgeschlagen. Hinweis: CoderRupee unterstützt noch keine MCP-Authentifizierung.',
  ...
  "home.providerTip":
    "CoderRupee mit über 75 Anbietern verbinden, um weitere Modelle wie Claude, GPT, Gemini und andere zu nutzen",
  ...
  "sidebar.gettingStarted.line1": "CoderRupee enthält kostenlose Modelle, damit Sie sofort loslegen können.",
  ...
  "app.name.desktop": "CoderRupee Desktop",
  ...
  "settings.desktop.wsl.description": "CoderRupee-Server innerhalb von WSL unter Windows ausführen.",
  ...
  "settings.general.row.language.description": "Die Anzeigesprache für CoderRupee ändern",
  ...
  "settings.general.row.appearance.description": "Anpassen, wie CoderRupee auf Ihrem Gerät aussieht",
  "settings.general.row.colorScheme.title": "Farbschema",
  "settings.general.row.colorScheme.description":
    "Wählen Sie, ob CoderRupee dem System-, hellen oder dunklen Thema folgt",
  "settings.general.row.theme.title": "Thema",
  "settings.general.row.theme.description": "Das Thema von CoderRupee anpassen.",
  ...
  "settings.updates.row.startup.description": "Beim Start von CoderRupee automatisch nach Updates suchen",
  ...
  "settings.updates.toast.latest.title": "CoderRupee ist auf dem neuesten Stand",
  "settings.updates.toast.latest.description": "Die aktuelle Version von CoderRupee wird verwendet.",
  ...
  "desktop.recovery.loadFailed": "CoderRupee konnte nicht geladen werden",
  "desktop.recovery.terminated": "Das CoderRupee-Fenster wurde unerwartet beendet",
  "desktop.recovery.unresponsive": "CoderRupee reagiert nicht",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee-Installation fehlgeschlagen",
  "desktop.wsl.error.alreadyAdded": "{{distro}} wurde bereits hinzugefügt",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee ist in dieser Distribution nicht installiert",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee ist installiert, konnte aber nicht ausgeführt werden",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee ist in {{distro}} nicht installiert",
  "desktop.wsl.error.updateVersion":
    "Das CoderRupee-Update wurde abgeschlossen, aber {{distro}} meldet weiterhin {{installed}}; erwartet wurde {{expected}}",
  ...
  "help.tabs.introduction": "CoderRupee Desktop basiert jetzt auf Tabs.",
  "help.tabs.sessions":
