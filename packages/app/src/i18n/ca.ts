export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee Documentació",
  ...
  "desktop.menu.ariaLabel": "menú CoderRupee.",
  ...
  "desktop.recovery.loadFailed": "CoderRupee no s'ha pogut carregar",
  "desktop.recovery.terminated": "La finestra CoderRupee s'ha acabat inesperadament",
  "desktop.recovery.unresponsive": "CoderRupee no respon",
  ...
  "desktop.wsl.error.installOpencode": "La instal·lació de CoderRupee ha fallat",
  "desktop.wsl.error.alreadyAdded": "{{distro}} ja està afegit",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee no està instal·lat en aquesta distribució",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee està instal·lat però no s'ha pogut executar",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee no està instal·lat a {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupee actualització acabada però {{distro}} encara informa {{installed}}; esperat {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Models seleccionats que inclouen Claude, GPT, Gemini i més",
  "dialog.provider.coderrupee.tagline": "Models optimitzats fiables",
  "dialog.provider.coderrupeeGo.tagline": "Subscripció de baix cost per a tothom",
  ...
  "dialog.model.unpaid.freeModels.title": "Models gratuïts proporcionats per CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Introduïu la clau API de {{provider}} per connectar el compte i utilitzar els models de {{provider}} a CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen us ofereix accés a un conjunt seleccionat de models optimitzats fiables per a agents de codificació.",
  ...
  "provider.connect.coderrupeeZen.visit.suffix": " per recollir la teva clau API.",
  "provider.connect.oauth.code.visit.prefix": "Visita ",
  "provider.connect.oauth.code.visit.link": "aquest enllaç",
  "provider.connect.oauth.code.visit.suffix":
    " per recollir el vostre codi d'autorització per connectar el vostre compte i utilitzar {{provider}} models a CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " i introduïu el codi següent per connectar el vostre compte i utilitzar {{provider}} models a CoderRupee.",
  ...
  "dialog.plugins.empty": "Connectors configurats a coderrupee.json",
  ...
  "dialog.server.description": "Canvia a quin CoderRupee servidor es connecta aquesta aplicació.",
  ...
  "wsl.onboarding.checkingOpencode": "S'està comprovant CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "S'està registrant CoderRupee a {{distro}}...",
  "wsl.onboarding.updatingOpencode": "S'està actualitzant CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "S'està actualitzant CoderRupee a {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Actualitza CoderRupee a {{distro}}.",
  "wsl.onboarding.updateOpencode": "Actualització CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee està llest a {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee està llest.",
  "wsl.onboarding.installOpencodeIn": "Instal·leu CoderRupee a {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal·la CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee no instal·lat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsistema per a Linux) és necessari abans que CoderRupee pugui afegir un WSL servidor",
  "wsl.onboarding.wslUnavailable.title": "WSL no disponible",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee no ha pogut verificar WSL en aquesta màquina.",
  "wsl.onboarding.installWsl": "Instal·la WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Reinicieu Windows per acabar d'instal·lar WSL i, a continuació, torneu a obrir CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee L'escriptori ara està construït al voltant de pestanyes.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Una nova versió de CoderRupee ({{version}}) ja està disponible per instal·lar-la.",
  ...
  "error.page.report.prefix": "Informeu aquest error a l'equip CoderRupee.",
  ...
  "error.chain.checkConfig": "Comproveu els noms del vostre proveïdor/model de configuració (coderrupee.json).",
  "error.chain.mcpFailed":
    'El servidor MCP "{{name}}" ha fallat. Tingueu en compte que CoderRupee encara no admet l\'autenticació MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee inclou models gratuïts perquè pugueu començar immediatament.",
  ...
  "app.name.desktop": "CoderRupee Escriptori",
  ...
  "settings.desktop.wsl.description": "Executeu el servidor CoderRupee dins de WSL a Windows.",
  ...
  "settings.general.row.language.description": "Canvia l'idioma de visualització per a CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personalitza com es veu CoderRupee al teu dispositiu",
  "settings.general.row.colorScheme.title": "Esquema de colors",
  "settings.general.row.colorScheme.description": "Trieu si CoderRupee segueix el tema del sistema, clar o fosc",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Personalitza la temàtica de CoderRupee.",
  ...
  "settings.updates.row.startup.description":
    "Comprova automàticament si hi ha actualitzacions quan s'iniciï CoderRupee.",
  ...
  "settings.updates.toast.latest.description": "Esteu executant la darrera versió de CoderRupee.",
