export const dict = {
  ...
  "desktop.menu.documentation": "Dokumentasi CoderRupee",
  ...
  "desktop.recovery.loadFailed": "CoderRupee gagal dimuatkan",
  "desktop.recovery.terminated": "Tetingkap CoderRupee ditamatkan secara tidak dijangka",
  "desktop.recovery.unresponsive": "CoderRupee tidak memberi respons",
  ...
  "desktop.wsl.error.installOpencode": "Pemasangan CoderRupee gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} telah pun ditambah",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee tidak dipasang dalam distro ini",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee dipasang tetapi tidak dapat dijalankan",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee tidak dipasang dalam {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Kemas kini CoderRupee selesai tetapi {{distro}} masih melaporkan {{installed}}; sepatutnya {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Model terpilih termasuk Claude, GPT, Gemini dan banyak lagi",
  "dialog.provider.coderrupee.tagline": "Model dioptimumkan yang boleh dipercayai",
  "dialog.provider.coderrupeeGo.tagline": "Langganan kos rendah untuk semua",
  ...
  "dialog.model.unpaid.freeModels.title": "Model percuma yang disediakan oleh CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} anda untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen memberi anda akses kepada set model terpilih yang boleh dipercayai dan dioptimumkan untuk ejen pengekodan.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Layari",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "untuk mendapatkan kunci API anda.",
  "provider.connect.oauth.code.visit.prefix": "Layari",
  "provider.connect.oauth.code.visit.link": "pautan ini",
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kod kebenaran anda bagi menghubungkan akaun dan menggunakan model {{provider}} dalam CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kod di bawah untuk menghubungkan akaun anda dan menggunakan model {{provider}} dalam CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi dalam coderrupee.json",
  ...
  "dialog.server.description": "Tukar pelayan CoderRupee yang disambungkan oleh aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Sedang menyemak CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Sedang menyemak CoderRupee dalam {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Sedang mengemas kini CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Sedang mengemas kini CoderRupee dalam {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Kemas kini CoderRupee dalam {{distro}}.",
  "wsl.onboarding.updateOpencode": "Kemas kini CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee sedia digunakan dalam {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee sedia digunakan.",
  "wsl.onboarding.installOpencodeIn": "Pasang CoderRupee dalam {{distro}}.",
  "wsl.onboarding.installOpencode": "Pasang CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee belum dipasang",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CoderRupee boleh menambah pelayan WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee tidak dapat mengesahkan WSL pada mesin ini.",
  "wsl.onboarding.installWsl": "Pasang WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulakan semula Windows untuk menyiapkan pemasangan WSL, kemudian buka semula CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop kini dibina berasaskan tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baharu CoderRupee ({{version}}) kini tersedia untuk dipasang.",
  ...
  "error.page.report.prefix": "Sila laporkan ralat ini kepada pasukan CoderRupee",
  ...
  "error.chain.checkConfig": "Semak konfigurasi anda (coderrupee.json) nama penyedia/model",
  "error.chain.mcpFailed": 'Pelayan MCP "{{name}}" gagal. Nota, CoderRupee belum menyokong pengesahan MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee merangkumi model percuma supaya anda boleh bermula serta-merta.",
  ...
  "settings.desktop.wsl.description": "Jalankan pelayan CoderRupee dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Tukar bahasa paparan untuk CoderRupee",
  ...
  "settings.general.row.appearance.description": "Sesuaikan rupa CoderRupee pada peranti anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih sama ada CoderRupee mengikut sistem, tema cerah, atau gelap",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Sesuaikan tema CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Semak kemas kini secara automatik apabila CoderRupee dilancarkan",
  ...
  "settings.updates.toast.latest.description": "Anda sedang menggunakan versi terkini CoderRupee.",
