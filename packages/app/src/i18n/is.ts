...
const desktop = [
  ...
  "Bíða áfram",
  "Hætta",
  "Ekki tókst að hlaða CoderRupee",
  "CoderRupee-glugganum var óvænt lokað",
  "CoderRupee svarar ekki",
  ...
  "Uppsetning CoderRupee mistókst",
  "{{distro}} hefur þegar verið bætt við",
  "coderrupee er ekki uppsett í þessari dreifingu",
  "coderrupee er uppsett en ekki var hægt að keyra það",
  "CoderRupee er ekki uppsett í {{distro}}",
  "Uppfærslu CoderRupee lauk en {{distro}} tilkynnir enn {{installed}}; vænt var {{expected}}",
  "engin útgáfa",
...
export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Sýndar gerðir þar á meðal Claude, GPT, Gemini og fleira",
  "dialog.provider.coderrupee.tagline": "Áreiðanleg bjartsýni módel",
  "dialog.provider.coderrupeeGo.tagline": "Lággjaldaáskrift fyrir alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Ókeypis gerðir frá CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Sláðu inn API-lykilinn þinn fyrir {{provider}} til að tengja reikninginn og nota líkön frá {{provider}} í CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen veitir þér aðgang að safni af áreiðanlegum og fínstilltum gerðum fyrir kóðunarmiðla.",
  "provider.connect.coderrupeeZen.line2":
    "Með einum API lykli færðu aðgang að gerðum eins og Claude, GPT, Gemini, GLM og fleira.",
  "provider.connect.coderrupeeZen.visit.prefix": "Heimsókn",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "til að safna API lykilnum þínum.",
  "provider.connect.oauth.code.visit.prefix": "Heimsókn",
  "provider.connect.oauth.code.visit.link": "þennan hlekk",
  "provider.connect.oauth.code.visit.suffix":
    "til að safna heimildarkóðanum þínum til að tengja reikninginn þinn og nota {{provider}} gerðir í CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "og sláðu inn kóðann hér að neðan til að tengja reikninginn þinn og nota {{provider}} gerðir í CoderRupee.",
  ...
  "dialog.plugins.empty": "Viðbætur stilltar í coderrupee.json",
  ...
  "dialog.server.description": "Skiptu um hvaða CoderRupee miðlara þetta app tengist.",
  ...
  "wsl.onboarding.checkingOpencode": "Athugar CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Athugar CoderRupee í {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppfærir CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Uppfærir CoderRupee í {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppfærðu CoderRupee í {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppfærðu CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee er tilbúið í {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee er tilbúinn.",
  "wsl.onboarding.installOpencodeIn": "Settu upp CoderRupee í {{distro}}.",
  "wsl.onboarding.installOpencode": "Settu upp CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee ekki uppsett",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows undirkerfi fyrir Linux) þarf áður en CoderRupee getur bætt við WSL netþjóni",
  "wsl.onboarding.wslUnavailable.title": "WSL ekki í boði",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee gat ekki staðfest WSL á þessari vél.",
  "wsl.onboarding.installWsl": "Settu upp WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Endurræstu Windows til að klára að setja upp WSL, opnaðu síðan CoderRupee aftur.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop er nú byggt í kringum flipa.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Ný útgáfa af CoderRupee ({{version}}) er nú fáanleg til uppsetningar.",
  ...
  "error.page.report.prefix": "Vinsamlegast tilkynnið þessa villu til CoderRupee teymisins",
  ...
  "error.chain.checkConfig": "Athugaðu stillingar (coderrupee.json) þjónustuveitu/módelheiti",
  "error.chain.mcpFailed": "MCP þjónn „{{name}}“ mistókst. Athugið, CoderRupee styður ekki MCP auðkenningu ennþá.",
  ...
  "sidebar.gettingStarted.line1": "CoderRupee inniheldur ókeypis gerðir svo þú getir byrjað strax.",
  ...
  "app.name.desktop": "CoderRupee skjáborð",
  ...
  "settings.desktop.wsl.description": "Keyrðu CoderRupee netþjóninn inni í WSL á Windows.",
  ...
  "settings.general.row.language.description": "Breyttu skjátungumálinu fyrir CoderRupee",
  ...
  "settings.general.row.appearance.description": "Sérsníddu hvernig CoderRupee lítur út á tækinu þínu",
  "settings.general.row.colorScheme.title": "Litasamsetning",
  "settings.general.row.colorScheme.description": "Veldu hvort CoderRupee fylgir kerfis-, ljósu eða dökku þema",
  "settings.general.row.theme.title": "Þema",
  "settings.general.row.theme.description": "Sérsníddu hvernig CoderRupee er þema.",
  ...
  "settings.updates.row.startup.description": "Athugaðu sjálfkrafa fyrir uppfærslur þegar CoderRupee ræsir",
  ...
  "settings.updates.toast.latest.description": "Þú ert að keyra nýjustu útgáfuna af CoderRupee.",
