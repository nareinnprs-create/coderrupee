export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupeeを読み込めませんでした",
  "desktop.recovery.terminated": "CoderRupeeのウインドウが予期せず終了しました",
  "desktop.recovery.unresponsive": "CoderRupeeが応答していません",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupeeのインストールに失敗しました",
  "desktop.wsl.error.alreadyAdded": "{{distro}}はすでに追加されています",
  "desktop.wsl.error.coderrupeeMissing": "このディストリビューションにはcoderrupeeがインストールされていません",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupeeはインストールされていますが、実行できませんでした",
  "desktop.wsl.error.coderrupeeNotInstalled": "{{distro}}にはCoderRupeeがインストールされていません",
  "desktop.wsl.error.updateVersion":
    "CoderRupeeのアップデートは完了しましたが、{{distro}}から報告されたバージョンはまだ{{installed}}です。想定されるバージョンは{{expected}}です",
  ...
  "dialog.provider.coderrupee.note": "Claude, GPT, Geminiなどを含む厳選されたモデル",
  "dialog.provider.coderrupee.tagline": "信頼性の高い最適化モデル",
  "dialog.provider.coderrupeeGo.tagline": "すべての人に低価格のサブスクリプション",
  ...
  "dialog.model.unpaid.freeModels.title": "CoderRupeeが提供する無料モデル",
  ...
  "provider.connect.apiKey.description":
    "{{provider}}のAPIキーを入力してアカウントを接続し、CoderRupeeで{{provider}}モデルを使用します。",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zenは、コーディングエージェント向けに最適化された信頼性の高いモデルへのアクセスを提供します。",
  "provider.connect.coderrupeeZen.line2": "1つのAPIキーで、Claude、GPT、Gemini、GLMなどのモデルにアクセスできます。",
  "provider.connect.coderrupeeZen.visit.prefix": " ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " にアクセスしてAPIキーを取得してください。",
  "provider.connect.oauth.code.visit.prefix": " ",
  "provider.connect.oauth.code.visit.link": "このリンク",
  "provider.connect.oauth.code.visit.suffix":
    " にアクセスして認証コードを取得し、アカウントを接続してCoderRupeeで{{provider}}モデルを使用してください。",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " にアクセスし、以下のコードを入力してアカウントを接続し、CoderRupeeで{{provider}}モデルを使用してください。",
  ...
  "dialog.plugins.empty": "coderrupee.jsonで設定されたプラグイン",
  ...
  "dialog.server.description": "このアプリが接続するCoderRupeeサーバーを切り替えます。",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupeeを確認中...",
  "wsl.onboarding.checkingOpencodeIn": "{{distro}}内のCoderRupeeを確認中...",
  "wsl.onboarding.updatingOpencode": "CoderRupeeを更新中...",
  "wsl.onboarding.updatingOpencodeIn": "{{distro}}内のCoderRupeeを更新中...",
  "wsl.onboarding.updateOpencodeIn": "{{distro}}内のCoderRupeeを更新してください。",
  "wsl.onboarding.updateOpencode": "CoderRupeeを更新",
  "wsl.onboarding.coderrupeeReadyIn": "{{distro}}内のCoderRupeeの準備ができました。",
  "wsl.onboarding.coderrupeeReady": "CoderRupeeの準備ができました。",
  "wsl.onboarding.installOpencodeIn": "{{distro}}にCoderRupeeをインストールしてください。",
  "wsl.onboarding.installOpencode": "CoderRupeeをインストール",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupeeがインストールされていません",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "CoderRupeeでWSLサーバーを追加するには、WSL (Windows Subsystem for Linux) が必要です",
  ...
  "wsl.onboarding.windowsRestartRequired":
    "WSLのインストールを完了するにはWindowsを再起動し、CoderRupeeをもう一度開いてください。",
  ...
  "help.tabs.introduction": "CoderRupee Desktopでタブを中心とした操作ができるようになりました。",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupeeの新しいバージョン ({{version}}) がインストール可能です。",
  ...
  "error.page.report.prefix": "このエラーをCoderRupeeチームに報告してください: ",
  ...
  "error.chain.checkConfig": "config (coderrupee.json) のプロバイダー/モデル名を確認してください",
  "error.chain.mcpFailed": 'MCPサーバー "{{name}}" が失敗しました。注意: CoderRupeeはまだMCP認証をサポートしていません。',
  ...
  "sidebar.gettingStarted.line1": "CoderRupeeには無料モデルが含まれているため、すぐに開始できます。",
  ...
  "settings.desktop.wsl.description": "WindowsのWSL環境でCoderRupeeサーバーを実行します。",
  ...
  "settings.general.row.language.description": "CoderRupeeの表示言語を変更します",
  ...
  "settings.general.row.appearance.description": "デバイスでのCoderRupeeの表示をカスタマイズします",
  "settings.general.row.colorScheme.title": "配色",
  "settings.general.row.colorScheme.description": "CoderRupeeがシステム、ライト、またはダークテーマに従うかを選択します",
  "settings.general.row.theme.title": "テーマ",
  "settings.general.row.theme.description": "CoderRupeeのテーマをカスタマイズします。",
  ...
  "settings.updates.row.startup.description": "CoderRupee の起動時に自動でアップデートを確認します",
  ...
  "settings.updates.toast.latest.description": "CoderRupee は最新バージョンです。",
