...
export const DESKTOP_NATIVE_ENGLISH = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee failed to load",
  "desktop.recovery.terminated": "CoderRupee window terminated unexpectedly",
  "desktop.recovery.unresponsive": "CoderRupee is not responding",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee installation failed",
  "desktop.wsl.error.alreadyAdded": "{{distro}} is already added",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee is not installed in this distro",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee is installed but could not run",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee is not installed in {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupee update finished but {{distro}} still reports {{installed}}; expected {{expected}}",
