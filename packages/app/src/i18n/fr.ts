export const dict = {
  ...
  "desktop.menu.documentation": "Documentation d'CoderRupee",
  ...
  "desktop.recovery.loadFailed": "Échec du chargement d'CoderRupee",
  "desktop.recovery.terminated": "La fenêtre CoderRupee s'est arrêtée de manière inattendue",
  "desktop.recovery.unresponsive": "CoderRupee ne répond pas",
  ...
  "desktop.wsl.error.installOpencode": "Échec de l'installation d'CoderRupee",
  "desktop.wsl.error.alreadyAdded": "{{distro}} a déjà été ajoutée",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee n'est pas installé dans cette distribution",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee est installé, mais n'a pas pu s'exécuter",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee n'est pas installé dans {{distro}}",
  "desktop.wsl.error.updateVersion":
    "La mise à jour d'CoderRupee est terminée, mais {{distro}} indique toujours {{installed}} au lieu de {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Modèles sélectionnés incluant Claude, GPT, Gemini et plus",
  "dialog.provider.coderrupee.tagline": "Modèles optimisés et fiables",
  "dialog.provider.coderrupeeGo.tagline": "Abonnement abordable pour tous",
  ...
  "dialog.model.unpaid.freeModels.title": "Modèles gratuits fournis par CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Entrez votre clé API {{provider}} pour connecter votre compte et utiliser les modèles {{provider}} dans CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen vous donne accès à un ensemble sélectionné de modèles fiables et optimisés pour les agents de codage.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Visitez ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " pour récupérer votre clé API.",
  "provider.connect.oauth.code.visit.prefix": "Visitez ",
  "provider.connect.oauth.code.visit.link": "ce lien",
  "provider.connect.oauth.code.visit.suffix":
    " pour récupérer votre code d'autorisation afin de connecter votre compte et utiliser les modèles {{provider}} dans CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " et entrez le code ci-dessous pour connecter votre compte et utiliser les modèles {{provider}} dans CoderRupee.",
  ...
  "dialog.plugins.empty": "Extensions configurées dans coderrupee.json",
  ...
  "dialog.server.description": "Changez le serveur CoderRupee auquel cette application se connecte.",
  ...
  "wsl.onboarding.checkingOpencode": "Vérification d'CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Vérification d'CoderRupee dans {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Mise à jour d'CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Mise à jour d'CoderRupee dans {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Mettez à jour CoderRupee dans {{distro}}.",
  "wsl.onboarding.updateOpencode": "Mettre à jour CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee est prêt dans {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee est prêt.",
  "wsl.onboarding.installOpencodeIn": "Installez CoderRupee dans {{distro}}.",
  "wsl.onboarding.installOpencode": "Installer CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee non installé",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) est requis avant qu'CoderRupee puisse ajouter un serveur WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL indisponible",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee n'a pas pu vérifier WSL sur cet appareil.",
  "wsl.onboarding.installWsl": "Installer WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Redémarrez Windows pour terminer l'installation de WSL, puis rouvrez CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop s'articule désormais autour d'onglets.",
  "help.tabs.sessions":
  ...
  "toast.update.description":
    "Une nouvelle version d'CoderRupee ({{version}}) est maintenant disponible pour installation.",
  ...
  "error.page.report.prefix": "Veuillez signaler cette erreur à l'équipe CoderRupee",
  ...
  "error.chain.checkConfig": "Vérifiez les noms de fournisseur et de modèle dans votre configuration (coderrupee.json)",
  "error.chain.mcpFailed":
    "Le serveur MCP \"{{name}}\" a échoué. Notez qu'CoderRupee ne prend pas encore en charge l'authentification MCP.",
  ...
  "sidebar.gettingStarted.line1":
    "CoderRupee inclut des modèles gratuits pour que vous puissiez commencer immédiatement.",
  ...
  "settings.desktop.wsl.description": "Exécuter le serveur CoderRupee dans WSL sur Windows.",
  ...
  "settings.general.row.language.description": "Changer la langue d'affichage pour CoderRupee",
  ...
  "settings.general.row.appearance.description": "Personnaliser l'apparence d'CoderRupee sur votre appareil",
  "settings.general.row.colorScheme.title": "Schéma de couleurs",
  "settings.general.row.colorScheme.description": "Choisissez si CoderRupee suit le thème système, clair ou sombre",
  "settings.general.row.theme.title": "Thème",
  "settings.general.row.theme.description": "Personnaliser le thème d'CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Vérifier automatiquement les mises à jour au lancement d'CoderRupee",
  ...
  "settings.updates.toast.latest.description": "Vous utilisez la dernière version d'CoderRupee.",
