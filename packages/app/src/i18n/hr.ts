...
const desktop = [
  ...
  "Nastavi čekati",
  "Izađi",
  "CoderRupee se nije uspio učitati",
  "Prozor aplikacije CoderRupee neočekivano je zatvoren",
  "CoderRupee ne reagira",
  ...
  "Instalacija aplikacije CoderRupee nije uspjela",
  "Distribucija {{distro}} već je dodana",
  "coderrupee nije instaliran u ovoj distribuciji",
  "coderrupee je instaliran, ali se ne može pokrenuti",
  "CoderRupee nije instaliran u distribuciji {{distro}}",
  "Ažuriranje aplikacije CoderRupee je završeno, ali {{distro}} i dalje prijavljuje {{installed}}; očekivano je {{expected}}",
  "nema verzije",
...
export const dict = {
  ...
  "dialog.provider.coderrupee.note": "Odabrani modeli uključujući Claude, GPT, Gemini i druge",
  "dialog.provider.coderrupee.tagline": "Pouzdani optimizirani modeli",
  "dialog.provider.coderrupeeGo.tagline": "Niska cijena pretplate za sve",
  ...
  "dialog.model.unpaid.freeModels.title": "Besplatne modele nudi CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Enter vaš {{provider}} API ključ za povezivanje vašeg računa i korištenje {{provider}} modela u CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen vam daje pristup odabranom skupu pouzdanih optimiziranih modela za agente za kodiranje.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Posjetiti",
  "provider.connect.coderrupeeZen.visit.link": "otvoreni kod.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": "da preuzmete svoj ključ API.",
  "provider.connect.oauth.code.visit.prefix": "Posjetiti",
  "provider.connect.oauth.code.visit.link": "ovaj link",
  "provider.connect.oauth.code.visit.suffix":
    "za prikupljanje vašeg autorizacijskog koda za povezivanje vašeg računa i korištenje {{provider}} modela u CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    "i unesite kod ispod kako biste povezali svoj račun i koristili {{provider}} modele u CoderRupee.",
  ...
  "dialog.plugins.empty": "Dodaci konfigurirani u coderrupee.json",
  ...
  "dialog.server.description": "Promijenite na koji se CoderRupee poslužitelj povezuje ova aplikacija.",
  ...
  "wsl.onboarding.checkingOpencodeIn": "Provjera CoderRupee u {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Ažuriranje CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Ažuriranje CoderRupee u {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Ažurirajte CoderRupee u {{distro}}.",
  "wsl.onboarding.updateOpencode": "Ažurirajte CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee je spreman u {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee je spreman.",
  "wsl.onboarding.installOpencodeIn": "Instalirajte CoderRupee u {{distro}}.",
  "wsl.onboarding.installOpencode": "Instalirajte CoderRupee",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows podsustav za Linux) je potreban prije nego što CoderRupee može dodati WSL poslužitelj",
  "wsl.onboarding.wslUnavailable.title": "WSL nedostupan",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee nije mogao potvrditi WSL na ovom stroju.",
  "wsl.onboarding.installWsl": "Instalirajte WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Ponovo pokrenite Windows da dovršite instalaciju WSL, zatim ponovno otvorite CoderRupee.",
  ...
  "help.tabs.introduction": "Radna površina CoderRupee sada je izgrađena oko kartica.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Nova verzija CoderRupee ({{version}}) sada je dostupna za instalaciju.",
  ...
  "error.page.report.prefix": "Prijavite ovu grešku CoderRupee timu",
  ...
  "error.chain.checkConfig": "Provjerite nazive dobavljača/modela svoje konfiguracije (coderrupee.json).",
  "error.chain.mcpFailed":
    'MCP poslužitelj "{{name}}" nije uspio. Napomena, CoderRupee još ne podržava MCP autentifikaciju.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee uključuje besplatne modele tako da možete odmah početi.",
  ...
  "app.name.desktop": "CoderRupee Radna površina",
  ...
  "settings.desktop.wsl.description": "Pokrenite CoderRupee poslužitelj unutar WSL na Windows.",
  ...
  "settings.general.row.language.description": "Promijenite jezik prikaza za CoderRupee",
  ...
  "settings.general.row.appearance.description": "Prilagodite kako CoderRupee izgleda na vašem uređaju",
  "settings.general.row.colorScheme.title": "Shema boja",
  "settings.general.row.colorScheme.description":
    "Odaberite hoće li CoderRupee slijediti sistemsku, svijetlu ili tamnu temu",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Prilagodite način na koji je CoderRupee tematiziran.",
  ...
  "settings.updates.row.startup.description": "Automatski provjeri ima li ažuriranja kada se CoderRupee pokrene",
  ...
  "settings.updates.toast.latest.description": "Imate najnoviju verziju CoderRupee.",
