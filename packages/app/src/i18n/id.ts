export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee gagal dimuat",
  "desktop.recovery.terminated": "Jendela CoderRupee berhenti secara tidak terduga",
  "desktop.recovery.unresponsive": "CoderRupee tidak merespons",
  ...
  "desktop.wsl.error.installOpencode": "Instalasi CoderRupee gagal",
  "desktop.wsl.error.alreadyAdded": "{{distro}} sudah ditambahkan",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee belum terinstal di distro ini",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee telah terinstal, tetapi tidak dapat dijalankan",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee belum terinstal di {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Pembaruan CoderRupee selesai, tetapi {{distro}} masih melaporkan {{installed}}; seharusnya {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Model pilihan, termasuk Claude, GPT, Gemini, dan lainnya",
  "dialog.provider.coderrupee.tagline": "Model andal yang dioptimalkan",
  "dialog.provider.coderrupeeGo.tagline": "Langganan terjangkau untuk semua orang",
  ...
  "dialog.model.unpaid.freeModels.title": "Model gratis disediakan oleh CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Masukkan kunci API {{provider}} untuk menghubungkan akun Anda dan gunakan model {{provider}} di CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen memberi Anda akses ke serangkaian model andal yang dioptimalkan untuk agen pengodean.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Kunjungi ",
  ...
  "provider.connect.oauth.code.visit.suffix":
    " untuk mendapatkan kode otorisasi guna menghubungkan akun Anda dan menggunakan model {{provider}} di CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " dan masukkan kode di bawah untuk menghubungkan akun dan menggunakan model {{provider}} di CoderRupee.",
  ...
  "dialog.plugins.empty": "Plugin dikonfigurasi di coderrupee.json",
  ...
  "dialog.server.description": "Ganti server CoderRupee mana yang terhubung dengan aplikasi ini.",
  ...
  "wsl.onboarding.checkingOpencode": "Memeriksa CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Memeriksa CoderRupee di {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Memperbarui CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Memperbarui CoderRupee di {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Perbarui CoderRupee di {{distro}}.",
  "wsl.onboarding.updateOpencode": "Perbarui CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee siap di {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee siap.",
  "wsl.onboarding.installOpencodeIn": "Instal CoderRupee di {{distro}}.",
  "wsl.onboarding.installOpencode": "Instal CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee belum terinstal",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) diperlukan sebelum CoderRupee dapat menambahkan server WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL tidak tersedia",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee tidak dapat memverifikasi WSL di komputer ini.",
  "wsl.onboarding.installWsl": "Instal WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Mulai ulang Windows untuk menyelesaikan instalasi WSL, lalu buka kembali CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop kini dirancang dengan tab sebagai pusatnya.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Versi baru CoderRupee ({{version}}) sekarang tersedia untuk diinstal.",
  ...
  "error.page.report.prefix": "Harap laporkan kesalahan ini ke tim CoderRupee",
  ...
  "error.chain.checkConfig": "Periksa nama penyedia/model di konfigurasi Anda (coderrupee.json)",
  "error.chain.mcpFailed": 'Server MCP "{{name}}" gagal. Catatan: CoderRupee belum mendukung autentikasi MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee menyertakan model gratis sehingga Anda dapat memulai dengan segera.",
  ...
  "settings.desktop.wsl.description": "Jalankan server CoderRupee di dalam WSL di Windows.",
  ...
  "settings.general.row.language.description": "Ubah bahasa tampilan untuk CoderRupee",
  ...
  "settings.general.row.appearance.description": "Sesuaikan tampilan CoderRupee di perangkat Anda",
  "settings.general.row.colorScheme.title": "Skema warna",
  "settings.general.row.colorScheme.description": "Pilih apakah CoderRupee mengikuti tema sistem, terang, atau gelap",
  ...
  "settings.updates.row.startup.description": "Secara otomatis memeriksa pembaruan saat CoderRupee diluncurkan",
  ...
  "settings.updates.toast.latest.description": "Anda menjalankan versi terbaru CoderRupee.",
