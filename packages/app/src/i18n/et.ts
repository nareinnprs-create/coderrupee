export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee laadimine ebaõnnestus",
  "desktop.recovery.terminated": "CoderRupee aken suleti ootamatult",
  "desktop.recovery.unresponsive": "CoderRupee ei vasta",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee installimine ebaõnnestus",
  "desktop.wsl.error.alreadyAdded": "{{distro}} on juba lisatud",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee pole sellesse distrosse installitud",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee on installitud, kuid seda ei saa käivitada",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee pole installitud asukohta {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupee värskendus on lõpetatud, kuid {{distro}} teatab endiselt {{installed}}; oodata {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Kureeritud mudelid, sealhulgas Claude, GPT, Gemini ja palju muud",
  "dialog.provider.coderrupee.tagline": "Usaldusväärsed optimeeritud mudelid",
  "dialog.provider.coderrupeeGo.tagline": "Madala hinnaga tellimus kõigile",
  ...
  "dialog.model.unpaid.freeModels.title": "Tasuta mudeleid pakub CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Sisestage {{provider}} API võti, et ühendada konto ja kasutada {{provider}} mudeleid CoderRupee'is.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen annab teile juurdepääsu kodeerimisagentide usaldusväärsete optimeeritud mudelite kureeritud komplektile.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Külastage ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " API võtme kättesaamiseks.",
  "provider.connect.oauth.code.visit.prefix": "Külastage ",
  "provider.connect.oauth.code.visit.link": "see link",
  "provider.connect.oauth.code.visit.suffix":
    " konto ühendamiseks autoriseerimiskoodi kogumiseks ja {{provider}} mudeli kasutamiseks jaotises CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " ja sisestage allolev kood, et ühendada oma konto ja kasutada {{provider}} mudelit jaotises CoderRupee.",
  ...
  "dialog.plugins.empty": "Pluginad on konfigureeritud failis coderrupee.json",
  ...
  "dialog.server.description": "Lülitage, millise CoderRupee serveriga see rakendus ühenduse loob.",
  ...
  "wsl.onboarding.checkingOpencode": "CoderRupee kontrollimine...",
  "wsl.onboarding.checkingOpencodeIn": "CoderRupee kontrollimine asukohas {{distro}}...",
  "wsl.onboarding.updatingOpencode": "CoderRupee värskendamine...",
  "wsl.onboarding.updatingOpencodeIn": "CoderRupee värskendamine asukohas {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Värskenda CoderRupee jaotises {{distro}}.",
  "wsl.onboarding.updateOpencode": "Värskenda CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee on valmis {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee on valmis.",
  "wsl.onboarding.installOpencodeIn": "Installige CoderRupee asukohta {{distro}}.",
  "wsl.onboarding.installOpencode": "Installige CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee pole installitud",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows alamsüsteem Linux jaoks) on nõutav, enne kui CoderRupee saab lisada WSL serveri",
  "wsl.onboarding.wslUnavailable.title": "WSL pole saadaval",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee ei saanud selles masinas kontrollida WSL.",
  "wsl.onboarding.installWsl": "Installige WSL",
  "wsl.onboarding.windowsRestartRequired": "Taaskäivitage Windows, et installida WSL, seejärel avage uuesti CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Töölaud on nüüd üles ehitatud vahekaartide ümber.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Rakenduse CoderRupee ({{version}}) uus versioon on nüüd installimiseks saadaval.",
  ...
  "error.page.report.prefix": "Teatage sellest veast CoderRupee meeskonnale",
  ...
  "error.chain.checkConfig": "Kontrollige oma konfiguratsiooni (coderrupee.json) pakkuja/mudeli nimesid",
  "error.chain.mcpFailed": 'MCP server "{{name}}" ebaõnnestus. Pange tähele, CoderRupee ei toeta veel MCP autentimist.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee sisaldab tasuta mudeleid, nii et saate kohe alustada.",
  ...
  "app.name.desktop": "CoderRupee Töölaud",
  ...
  "settings.desktop.wsl.description": "Käivitage CoderRupee server sees WSL saidil Windows.",
  ...
  "settings.general.row.language.description": "Muutke CoderRupee kuvakeelt",
  ...
  "settings.general.row.appearance.description": "Kohandage, kuidas CoderRupee teie seadmes välja näeb",
  "settings.general.row.colorScheme.title": "Värvilahendus",
  "settings.general.row.colorScheme.description": "Valige, kas CoderRupee järgib süsteemi, heledat või tumedat teemat",
  "settings.general.row.theme.title": "Teema",
  "settings.general.row.theme.description": "Kohandage, kuidas CoderRupee on teemastatud.",
  ...
  "settings.updates.row.startup.description": "Kontrollige automaatselt värskendusi, kui CoderRupee käivitub",
  ...
  "settings.updates.toast.latest.description": "Kasutate rakenduse CoderRupee uusimat versiooni.",
