export const dict = {
  ...
  "desktop.menu.documentation": "CoderRupee დოკუმენტაცია",
  ...
  "desktop.menu.ariaLabel": "CoderRupee მენიუ",
  ...
  "desktop.recovery.loadFailed": "CoderRupee ვერ ჩაიტვირთა",
  "desktop.recovery.terminated": "CoderRupee ფანჯარა მოულოდნელად შეწყდა",
  "desktop.recovery.unresponsive": "CoderRupee არ პასუხობს",
  ...
  "desktop.wsl.error.installOpencode": "CoderRupee ინსტალაცია ვერ მოხერხდა",
  "desktop.wsl.error.alreadyAdded": "{{distro}} უკვე დამატებულია",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee არ არის დაინსტალირებული ამ დისტროში",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee დაინსტალირებულია, მაგრამ ვერ გაშვება",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee არ არის დაინსტალირებული {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupee განახლება დასრულდა, მაგრამ {{distro}} კვლავ იუწყება {{installed}}; მოსალოდნელია {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "კურირებული მოდელები, მათ შორის Claude, GPT, Gemini და სხვა",
  "dialog.provider.coderrupee.tagline": "სანდო ოპტიმიზებული მოდელები",
  "dialog.provider.coderrupeeGo.tagline": "დაბალფასიანი გამოწერა ყველასთვის",
  ...
  "dialog.model.unpaid.freeModels.title": "უფასო მოდელები მოწოდებულია CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "შეიყვანეთ თქვენი {{provider}} API გასაღები თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები CoderRupee-ში.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen გაძლევთ წვდომას კოდირების აგენტებისთვის საიმედო ოპტიმიზირებული მოდელების კურირებულ კომპლექტზე.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "ეწვიეთ ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " თქვენი API გასაღების შესაგროვებლად.",
  "provider.connect.oauth.code.visit.prefix": "ეწვიეთ ",
  "provider.connect.oauth.code.visit.link": "ეს ბმული",
  "provider.connect.oauth.code.visit.suffix":
    " შეაგროვეთ თქვენი ავტორიზაციის კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენოთ {{provider}} მოდელები CoderRupee-ში.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " და შეიყვანეთ ქვემოთ კოდი თქვენი ანგარიშის დასაკავშირებლად და გამოიყენეთ {{provider}} მოდელები CoderRupee-ში.",
  ...
  "dialog.plugins.empty": "პლაგინები კონფიგურირებულია coderrupee.json-ში",
  ...
  "dialog.server.description": "გადართეთ რომელ CoderRupee სერვერს უკავშირდება ეს აპი.",
  ...
  "wsl.onboarding.checkingOpencode": "შემოწმებულია CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "შემოწმებულია CoderRupee-ში {{distro}}...",
  "wsl.onboarding.updatingOpencode": "განახლება CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "CoderRupee განახლება ხდება {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "განახლება CoderRupee {{distro}}-ში.",
  "wsl.onboarding.updateOpencode": "განახლება CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee მზად არის {{distro}}-ში.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee მზად არის.",
  "wsl.onboarding.installOpencodeIn": "დააინსტალირეთ CoderRupee {{distro}}-ში.",
  "wsl.onboarding.installOpencode": "დააინსტალირეთ CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee არ არის დაინსტალირებული",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows ქვესისტემა Linux-ისთვის) საჭიროა, სანამ CoderRupee შეძლებს WSL სერვერის დამატებას",
  "wsl.onboarding.wslUnavailable.title": "WSL მიუწვდომელია",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee ვერ დაადასტურა WSL ამ მოწყობილობაზე.",
  "wsl.onboarding.installWsl": "დააინსტალირეთ WSL",
  "wsl.onboarding.windowsRestartRequired":
    "გადატვირთეთ Windows WSL-ის ინსტალაციის დასასრულებლად, შემდეგ ხელახლა გახსენით CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee სამუშაო მაგიდა ახლა აგებულია ჩანართების გარშემო.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "CoderRupee-ის ({{version}}) ახალი ვერსია ახლა ხელმისაწვდომია დასაინსტალირებლად.",
  ...
  "error.page.report.prefix": "გთხოვთ, შეატყობინოთ ეს შეცდომა CoderRupee გუნდს",
  ...
  "error.chain.checkConfig": "შეამოწმეთ თქვენი კონფიგურაცია (coderrupee.json) პროვაიდერის/მოდელების სახელები",
  "error.chain.mcpFailed":
    'MCP სერვერი "{{name}}" ვერ მოხერხდა. შენიშვნა, CoderRupee ჯერ არ უჭერს მხარს MCP ავთენტიფიკაციას.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee მოიცავს უფასო მოდელებს, ასე რომ თქვენ შეგიძლიათ დაუყოვნებლივ დაიწყოთ.",
  ...
  "app.name.desktop": "CoderRupee სამუშაო მაგიდა",
  ...
  "settings.desktop.wsl.description": "გაუშვით CoderRupee სერვერი WSL-ში Windows-ზე.",
  ...
  "settings.general.row.language.description": "შეცვალეთ ჩვენების ენა CoderRupee",
  ...
  "settings.general.row.appearance.description": "მორგეთ, როგორ გამოიყურება CoderRupee თქვენს მოწყობილობაზე",
  "settings.general.row.colorScheme.title": "ფერთა სქემა",
  "settings.general.row.colorScheme.description": "აირჩიეთ, მიჰყვება თუ არა CoderRupee სისტემას, ღია თუ ბნელ თემას",
  "settings.general.row.theme.title": "თემა",
  "settings.general.row.theme.description": "მორგება, თუ როგორ არის CoderRupee თემატური.",
  ...
  "settings.updates.row.startup.description": "ავტომატურად შეამოწმეთ განახლებები, როდესაც CoderRupee გაშვება",
  ...
  "settings.updates.toast.latest.description": "თქვენ იყენებთ CoderRupee-ის უახლეს ვერსიას.",
