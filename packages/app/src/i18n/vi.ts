export const dict = {
  ...
  "desktop.menu.documentation": "Tài liệu CoderRupee",
  ...
  "desktop.recovery.loadFailed": "Không tải được CoderRupee",
  "desktop.recovery.terminated": "Cửa sổ CoderRupee đã bị đóng đột ngột",
  "desktop.recovery.unresponsive": "CoderRupee không phản hồi",
  ...
  "desktop.wsl.error.installOpencode": "Không cài đặt được CoderRupee",
  "desktop.wsl.error.alreadyAdded": "{{distro}} đã được thêm",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee chưa được cài đặt trong bản phân phối này",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee đã được cài đặt nhưng không thể chạy",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee chưa được cài đặt trong {{distro}}",
  "desktop.wsl.error.updateVersion":
    "Đã cập nhật CoderRupee nhưng {{distro}} vẫn báo phiên bản {{installed}}; phiên bản dự kiến là {{expected}}",
  ...
  "dialog.provider.coderrupee.note": "Các mô hình được tuyển chọn, gồm Claude, GPT, Gemini và nhiều mô hình khác",
  "dialog.provider.coderrupee.tagline": "Các mô hình tối ưu hóa đáng tin cậy",
  "dialog.provider.coderrupeeGo.tagline": "Đăng ký chi phí thấp cho mọi người",
  ...
  "dialog.model.unpaid.freeModels.title": "Các mô hình miễn phí do CoderRupee cung cấp",
  ...
  "provider.connect.apiKey.description":
    "Nhập khóa API {{provider}} để kết nối tài khoản và sử dụng các mô hình {{provider}} trong CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen cho phép bạn truy cập một bộ mô hình được tuyển chọn, tối ưu hóa và đáng tin cậy dành cho tác nhân lập trình.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Truy cập ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " để lấy khóa API của bạn.",
  "provider.connect.oauth.code.visit.prefix": "Truy cập ",
  "provider.connect.oauth.code.visit.link": "liên kết này",
  "provider.connect.oauth.code.visit.suffix":
    " để lấy mã ủy quyền, kết nối tài khoản và sử dụng các mô hình {{provider}} trong CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " và nhập mã bên dưới để kết nối tài khoản của bạn và sử dụng các mô hình {{provider}} trong CoderRupee.",
  ...
  "dialog.plugins.empty": "Các plugin được định cấu hình trong coderrupee.json",
  ...
  "dialog.server.description": "Chuyển máy chủ CoderRupee mà ứng dụng này kết nối tới.",
  ...
  "wsl.onboarding.checkingOpencode": "Đang kiểm tra CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Đang kiểm tra CoderRupee trong {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Đang cập nhật CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Đang cập nhật CoderRupee trong {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Cập nhật CoderRupee trong {{distro}}.",
  "wsl.onboarding.updateOpencode": "Cập nhật CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee đã sẵn sàng trong {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee đã sẵn sàng.",
  "wsl.onboarding.installOpencodeIn": "Cài đặt CoderRupee trong {{distro}}.",
  "wsl.onboarding.installOpencode": "Cài đặt CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee chưa được cài đặt",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "Cần có WSL (Hệ thống con Windows dành cho Linux) trước khi CoderRupee có thể thêm máy chủ WSL",
  "wsl.onboarding.wslUnavailable.title": "WSL không có sẵn",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee không thể xác minh WSL trên máy này.",
  "wsl.onboarding.installWsl": "Cài đặt WSL",
  "wsl.onboarding.windowsRestartRequired": "Khởi động lại Windows để hoàn tất cài đặt WSL, sau đó mở lại CoderRupee.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop nay được xây dựng xoay quanh các tab.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "Hiện đã có phiên bản mới của CoderRupee ({{version}}) để cài đặt.",
  ...
  "error.page.report.prefix": "Vui lòng báo cáo lỗi này cho nhóm CoderRupee",
  ...
  "error.chain.checkConfig": "Kiểm tra tên nhà cung cấp/mô hình cấu hình (coderrupee.json) của bạn",
  "error.chain.mcpFailed": 'Máy chủ MCP "{{name}}" gặp lỗi. Lưu ý: CoderRupee chưa hỗ trợ xác thực MCP.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee bao gồm các mô hình miễn phí để bạn có thể bắt đầu ngay lập tức.",
  ...
  "settings.desktop.wsl.description": "Chạy máy chủ CoderRupee bên trong WSL trên Windows.",
  ...
  "settings.general.row.language.description": "Thay đổi ngôn ngữ hiển thị cho CoderRupee",
  ...
  "settings.general.row.appearance.description": "Tùy chỉnh giao diện của CoderRupee trên thiết bị",
  "settings.general.row.colorScheme.title": "Cách phối màu",
  "settings.general.row.colorScheme.description": "Chọn xem CoderRupee tuân theo hệ thống, chủ đề sáng hay tối",
  "settings.general.row.theme.title": "Chủ đề",
  "settings.general.row.theme.description": "Tùy chỉnh chủ đề của CoderRupee.",
  ...
  "settings.updates.row.startup.description": "Tự động kiểm tra các bản cập nhật khi CoderRupee khởi chạy",
  ...
  "settings.updates.toast.latest.description": "Bạn đang chạy phiên bản mới nhất của CoderRupee.",
