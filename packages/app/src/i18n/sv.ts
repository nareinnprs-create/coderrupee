export const dict = {
  ...
  "desktop.recovery.loadFailed": "CoderRupee kunde inte läsas in",
  "desktop.recovery.terminated": "CoderRupee-fönstret avslutades oväntat",
  "desktop.recovery.unresponsive": "CoderRupee svarar inte",
  ...
  "desktop.wsl.error.installOpencode": "Installationen av CoderRupee misslyckades",
  "desktop.wsl.error.alreadyAdded": "{{distro}} har redan lagts till",
  "desktop.wsl.error.coderrupeeMissing": "coderrupee är inte installerat i den här distributionen",
  "desktop.wsl.error.coderrupeeCannotRun": "coderrupee är installerat men kunde inte köras",
  "desktop.wsl.error.coderrupeeNotInstalled": "CoderRupee är inte installerat i {{distro}}",
  "desktop.wsl.error.updateVersion":
    "CoderRupee-uppdateringen slutfördes, men {{distro}} rapporterar fortfarande {{installed}}. {{expected}} förväntades",
  ...
  "dialog.provider.coderrupee.note": "Kurerade modeller inklusive Claude, GPT, Gemini och mer",
  "dialog.provider.coderrupee.tagline": "Pålitliga optimerade modeller",
  "dialog.provider.coderrupeeGo.tagline": "Lågprisprenumeration för alla",
  ...
  "dialog.model.unpaid.freeModels.title": "Gratis modeller tillhandahålls av CoderRupee",
  ...
  "provider.connect.apiKey.description":
    "Ange din {{provider}}-API-nyckel för att ansluta ditt konto och använda {{provider}}-modeller i CoderRupee.",
  ...
  "provider.connect.coderrupeeZen.line1":
    "CoderRupee Zen ger dig tillgång till en utvald uppsättning pålitliga optimerade modeller för kodningsagenter.",
  ...
  "provider.connect.coderrupeeZen.visit.prefix": "Besök ",
  "provider.connect.coderrupeeZen.visit.link": "coderrupee.ai/zen",
  "provider.connect.coderrupeeZen.visit.suffix": " för att hämta din API-nyckel.",
  "provider.connect.oauth.code.visit.prefix": "Besök ",
  "provider.connect.oauth.code.visit.link": "denna länk",
  "provider.connect.oauth.code.visit.suffix":
    " för att hämta auktoriseringskoden som ansluter ditt konto och låter dig använda {{provider}}-modeller i CoderRupee.",
  ...
  "provider.connect.oauth.auto.visit.suffix":
    " och ange koden nedan för att ansluta ditt konto och använda {{provider}}-modeller i CoderRupee.",
  ...
  "dialog.plugins.empty": "Insticksprogram konfigurerade i coderrupee.json",
  ...
  "dialog.server.description": "Växla vilken CoderRupee-server som denna app ansluter till.",
  ...
  "wsl.onboarding.checkingOpencode": "Kontrollerar CoderRupee...",
  "wsl.onboarding.checkingOpencodeIn": "Kontrollerar CoderRupee i {{distro}}...",
  "wsl.onboarding.updatingOpencode": "Uppdaterar CoderRupee...",
  "wsl.onboarding.updatingOpencodeIn": "Uppdaterar CoderRupee i {{distro}}...",
  "wsl.onboarding.updateOpencodeIn": "Uppdatera CoderRupee i {{distro}}.",
  "wsl.onboarding.updateOpencode": "Uppdatera CoderRupee",
  "wsl.onboarding.coderrupeeReadyIn": "CoderRupee är redo i {{distro}}.",
  "wsl.onboarding.coderrupeeReady": "CoderRupee är redo.",
  "wsl.onboarding.installOpencodeIn": "Installera CoderRupee i {{distro}}.",
  "wsl.onboarding.installOpencode": "Installera CoderRupee",
  ...
  "wsl.onboarding.distroStatus.coderrupeeMissing": "CoderRupee är inte installerat",
  ...
  "wsl.onboarding.wslNotInstalled.description":
    "WSL (Windows Subsystem for Linux) krävs innan CoderRupee kan lägga till en WSL-server",
  "wsl.onboarding.wslUnavailable.title": "WSL är inte tillgängligt",
  "wsl.onboarding.wslUnavailable.description": "CoderRupee kunde inte verifiera WSL på den här maskinen.",
  "wsl.onboarding.installWsl": "Installera WSL",
  "wsl.onboarding.windowsRestartRequired":
    "Starta om Windows för att slutföra installationen av WSL och öppna sedan CoderRupee igen.",
  ...
  "help.tabs.introduction": "CoderRupee Desktop är nu uppbyggt kring flikar.",
  "help.tabs.sessions":
  ...
  "toast.update.description": "En ny version av CoderRupee ({{version}}) är nu tillgänglig att installera.",
  ...
  "error.page.report.prefix": "Rapportera det här felet till CoderRupee-teamet",
  ...
  "error.chain.checkConfig": "Kontrollera leverantörs- och modellnamnen i konfigurationen (coderrupee.json)",
  "error.chain.mcpFailed": 'MCP-servern "{{name}}" misslyckades. Obs, CoderRupee stöder inte MCP-autentisering ännu.',
  ...
  "sidebar.gettingStarted.line1": "CoderRupee innehåller gratis modeller så att du kan börja direkt.",
  ...
  "settings.desktop.wsl.description": "Kör CoderRupee-servern inuti WSL på Windows.",
  ...
  "settings.general.row.language.description": "Ändra visningsspråket för CoderRupee",
  ...
  "settings.general.row.appearance.description": "Anpassa hur CoderRupee ser ut på din enhet",
  "settings.general.row.colorScheme.title": "Färgschema",
  "settings.general.row.colorScheme.description": "Välj om CoderRupee följer system-, ljus- eller mörktemat",
  "settings.general.row.theme.title": "Tema",
  "settings.general.row.theme.description": "Anpassa CoderRupees tema.",
  ...
  "settings.updates.row.startup.description": "Sök automatiskt efter uppdateringar när CoderRupee startas",
  ...
  "settings.updates.toast.latest.description": "Du kör den senaste versionen av CoderRupee.",
