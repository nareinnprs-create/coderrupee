...
beforeAll(async () => {
  ...
  mock.module("@coderrupee/ui/collapsible", () => ({
    Collapsible: {
      Trigger: (props: { children?: unknown }) => props.children,
      Content: (props: { children?: unknown }) => props.children,
    },
  }))
  mock.module("@coderrupee/ui/file-icon", () => ({ FileIcon: () => null }))
  mock.module("@coderrupee/ui/icon", () => ({ Icon: () => null }))
  mock.module("@coderrupee/ui/tooltip", () => ({ Tooltip: (props: { children?: unknown }) => props.children }))
