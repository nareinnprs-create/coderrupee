...
const featuredProviders = ["coderrupee", "coderrupee-go", "openai", "anthropic", "google", "github-copilot"]
...
export const DialogSelectModelUnpaidV2: Component<{ model?: ModelState }> = (props) => {
  ...
  const isFree = (item: ReturnType<ModelState["list"]>[number]) =>
    item.provider.id === "coderrupee" && (!item.cost || item.cost.input === 0)
