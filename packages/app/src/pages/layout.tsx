...
import { Session } from "@coderrupee/sdk/v2/client"
...
import { retry } from "@coderrupee/core/util/retry"
...
import { useTheme, type ColorScheme } from "@coderrupee/ui/theme/context"
...
export default function LegacyLayout(props: ParentProps) {
  ...
  const sidebarContent = (mobile?: boolean) => (
    <SidebarContent
      ...
      onOpenHelp={() => platform.openExternal("https://coderrupee.ai/desktop-feedback")}
      renderPanel={() =>
