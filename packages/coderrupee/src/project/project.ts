...
import { ProjectDirectoryTable, ProjectTable } from "@coderrupee/core/project/sql"
import { ProjectDirectories } from "@coderrupee/core/project/directories"
...
import { which } from "@coderrupee/core/util/which"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Project") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const fakeVcs = Schema.decodeUnknownSync(Schema.optional(Project.Vcs))(Flag.CODERRUPEE_FAKE_VCS)
