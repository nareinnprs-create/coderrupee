...
import { AccountStateTable, AccountTable } from "@coderrupee/core/account/sql"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/AccountRepo") {}
