...
import { gitlabAuthPlugin as GitlabAuthPlugin } from "coderrupee-gitlab-auth"
import { PoeAuthPlugin } from "coderrupee-poe-auth"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Plugin") {}
