import type { Hooks, PluginInput } from "@coderrupee/plugin"
import type { Model } from "@coderrupee/sdk/v2"
import { InstallationVersion } from "@coderrupee/core/installation/version"
import { OauthCallbackPage } from "@coderrupee/core/oauth/page"
      ...
      methods: [
        {
          ...
          async authorize() {
            ...
            return {
              url,
              instructions:
                "Sign in to DigitalOcean in your browser. CoderRupee will use your DigitalOcean API token directly for inference and load your Inference Routers. Re-run /connect to refresh routers later.",
