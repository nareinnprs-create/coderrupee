...
import { path } from "@coderrupee/core/effect/app-node-platform"
...
import type { ProjectV2 } from "@coderrupee/core/project"
...
import { WorktreeEvent } from "@coderrupee/schema/worktree-event"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Worktree") {}
  ...
  Effect.gen(function* () {
    ...
    const candidate = Effect.fn("Worktree.candidate")(function* (input: {
      ...
      for (const attempt of Array.from({ length: MAX_NAME_ATTEMPTS }, (_, i) => i)) {
        ...
        const branch = input.detached ? undefined : `coderrupee/${name}`
