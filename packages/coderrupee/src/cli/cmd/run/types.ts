// Shared type vocabulary for the direct interactive mode (`coderrupee --mini`).
//
...
import type { OpencodeClient, PermissionRequest, QuestionRequest, ToolPart } from "@coderrupee/sdk/v2"
