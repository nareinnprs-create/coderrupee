...
import { normalizePromptContent } from "@coderrupee/tui/editor"
...
import { CODERRUPEE_BASE_MODE, useBindings } from "@coderrupee/tui/keymap"
...
export function createPromptState(input: PromptInput): PromptState {
  ...
  const slashOptions = createMemo<SlashOption[]>(() => {
    const builtins = [
      ...
      { kind: "slash", name: "exit", display: "/exit", description: "close CoderRupee" } satisfies SlashOption,
    ]
