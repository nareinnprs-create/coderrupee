...
import type { Event, GlobalEvent, OpencodeClient } from "@coderrupee/sdk/v2"
...
class Service extends Context.Service<Service, TransportService>()("@coderrupee/RunStreamTransport") {}
