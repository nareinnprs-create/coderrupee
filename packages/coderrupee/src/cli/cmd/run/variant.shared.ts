...
//
// The saved variant persists across sessions in ~/.local/state/coderrupee/model.json
...
class Service extends Context.Service<Service, VariantService>()("@coderrupee/RunVariant") {}
