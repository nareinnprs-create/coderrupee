 ...
 *   "@coderrupee/ServerAuthConfig",
 *   {
 *     password: Config.string("CODERRUPEE_SERVER_PASSWORD").pipe(Config.option),
 *     username: Config.string("CODERRUPEE_SERVER_USERNAME").pipe(Config.withDefault("coderrupee")),
 *   },
 * ) {}
 *
