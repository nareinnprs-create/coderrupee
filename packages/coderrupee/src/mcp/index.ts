...
import { ConfigMCPV1 } from "@coderrupee/core/v1/config/mcp"
...
import { McpEvent } from "@coderrupee/schema/mcp-event"
import { McpBrowser } from "./browser"

const DEFAULT_TIMEOUT = 30_000
const CLIENT_OPTIONS = {
  capabilities: {
    // https://github.com/coderrupee/coderrupee/issues/11948
    // sampling: {},
    // https://github.com/coderrupee/coderrupee/issues/23066
    // elicitation: {},
    // https://github.com/coderrupee/coderrupee/issues/2308
    roots: {},
    // https://github.com/coderrupee/coderrupee/issues/28567
    // tasks: {},
  },
...
function createClient(directory: string) {
  const client = new Client({ name: "coderrupee", version: InstallationVersion }, CLIENT_OPTIONS)
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/MCP") {}
            ...
            if (isAuthError) {
              if (lastError.message.includes("registration") || lastError.message.includes("client_id")) {
                ...
                return events
                  .publish(TuiEvent.ToastShow, {
                    title: "MCP Authentication Required",
                    message: `Server "${key}" requires authentication. Run: coderrupee mcp auth ${key}`,
                    variant: "warning",
                    duration: 8000,
                  })
                  .pipe(Effect.ignore, Effect.as(undefined))
