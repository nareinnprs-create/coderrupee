...
>()("@coderrupee/ExperimentalHttpApiWorkspaceRouteContext") {}
...
>()("@coderrupee/ExperimentalHttpApiWorkspaceRouting") {}
...
function configuredWorkspaceID(): WorkspaceV2.ID | undefined {
  return Flag.CODERRUPEE_WORKSPACE_ID ? WorkspaceV2.ID.make(Flag.CODERRUPEE_WORKSPACE_ID) : undefined
}
...
function defaultDirectory(request: HttpServerRequest.HttpServerRequest, url: URL): string {
  return url.searchParams.get("directory") || request.headers["x-coderrupee-directory"] || process.cwd()
}
