...
import { AbsolutePath, type DeepMutable } from "@coderrupee/core/schema"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Agent") {}
          ...
          plan: {
            ...
            permission: Permission.merge(
              ...
              Permission.fromConfig({
                ...
                edit: {
                  "*": "deny",
                  [path.join(".coderrupee", "plans", "*.md")]: "allow",
