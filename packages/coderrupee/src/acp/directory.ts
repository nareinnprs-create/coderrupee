...
export class Loader extends Context.Service<Loader, LoaderInterface>()("@coderrupee/ACPDirectoryLoader") {}

export class Service extends Context.Service<Service, Interface>()("@coderrupee/ACPDirectory") {}
