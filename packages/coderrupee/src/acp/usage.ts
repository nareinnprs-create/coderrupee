...
import type { AssistantMessage as CoderRupeeAssistantMessage, Message } from "@coderrupee/sdk/v2"
import { InstanceRef } from "@/effect/instance-ref"
import { InstanceBootstrap } from "@/project/bootstrap"
import { InstanceStore } from "@/project/instance-store"
import { makeGlobalNode, Node } from "@coderrupee/core/effect/app-node"
...
export type AssistantTokenCost = Pick<CoderRupeeAssistantMessage, "cost" | "tokens">

export type AssistantMessage = AssistantTokenCost &
  Pick<CoderRupeeAssistantMessage, "role"> &
  Partial<Pick<CoderRupeeAssistantMessage, "providerID" | "modelID">>
...
export class MessageLoader extends Context.Service<MessageLoader, MessageLoaderInterface>()(
  "@coderrupee/ACPUsageMessageLoader",
) {}

export class ContextLimitLoader extends Context.Service<ContextLimitLoader, ContextLimitLoaderInterface>()(
  "@coderrupee/ACPUsageContextLimitLoader",
) {}

export class Service extends Context.Service<Service, Interface>()("@coderrupee/ACPUsage") {}
