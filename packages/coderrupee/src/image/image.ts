...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Image") {}
  ...
  Effect.gen(function* () {
    ...
    const loadPhoton = yield* Effect.cached(
      Effect.sync(() => {
        ...
        ;(globalThis as typeof globalThis & { __CODERRUPEE_PHOTON_WASM_PATH?: string }).__CODERRUPEE_PHOTON_WASM_PATH =
