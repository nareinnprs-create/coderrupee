...
import { buildPrompt } from "@coderrupee/core/session/compaction"
import { SessionCompactionEvent } from "@coderrupee/schema/session-compaction-event"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/SessionCompaction") {}
