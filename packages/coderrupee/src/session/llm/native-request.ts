import type { JsonSchema, LLMRequest, ProviderMetadata } from "@coderrupee/llm"
import { LLM, Message, SystemPart, ToolCallPart, ToolDefinition, ToolResultPart } from "@coderrupee/llm"
import {
  AmazonBedrock,
  Anthropic,
  Azure,
...
export const request = (input: RequestInput) => {
  ...
  // @coderrupee/llm request objects from coderrupee's session/AI SDK-shaped data.
  return LLM.request({
