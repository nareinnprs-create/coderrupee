...
import { Slug } from "@coderrupee/core/util/slug"
...
import type { ProviderMetadata, Usage } from "@coderrupee/llm"
...
import { locationServiceMapLayer } from "@coderrupee/core/location-services"
...
import { PartTable, SessionTable } from "@coderrupee/core/session/sql"
...
import { NonNegativeInt, optional } from "@coderrupee/core/schema"
...
export function plan(input: { slug: string; time: { created: number } }, instance: InstanceContext) {
  const base = instance.project.vcs
    ? path.join(instance.worktree, ".coderrupee", "plans")
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Session") {}
