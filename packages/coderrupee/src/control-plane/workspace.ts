...
import { EventSequenceTable, EventTable } from "@coderrupee/core/event/sql"
...
import { WorkspaceEvent } from "@coderrupee/schema/workspace-event"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Workspace") {}
...
const layer = Layer.effect(
  ...
  Effect.gen(function* () {
    ...
    const create = Effect.fn("Workspace.create")(function* (input: CreateInput) {
      ...
      const env = {
        CODERRUPEE_AUTH_CONTENT: JSON.stringify(yield* auth.all()),
        CODERRUPEE_WORKSPACE_ID: config.id,
        CODERRUPEE_EXPERIMENTAL_WORKSPACES: "true",
