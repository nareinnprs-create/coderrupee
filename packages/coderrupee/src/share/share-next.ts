...
import type * as SDK from "@coderrupee/sdk/v2"
...
import { SessionShareTable } from "@coderrupee/core/share/sql"
...
const disabled = process.env["CODERRUPEE_DISABLE_SHARE"] === "true" || process.env["CODERRUPEE_DISABLE_SHARE"] === "1"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/ShareNext") {}
