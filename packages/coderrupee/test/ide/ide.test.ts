...
describe("ide", () => {
  ...
  test("should recognize vscode-insiders CODERRUPEE_CALLER", () => {
    process.env["CODERRUPEE_CALLER"] = "vscode-insiders"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should recognize vscode CODERRUPEE_CALLER", () => {
    process.env["CODERRUPEE_CALLER"] = "vscode"

    expect(Ide.alreadyInstalled()).toBe(true)
  })

  test("should return false for unknown CODERRUPEE_CALLER", () => {
    process.env["CODERRUPEE_CALLER"] = "unknown"
