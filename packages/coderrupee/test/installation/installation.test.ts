...
import { makeGlobalNode } from "@coderrupee/core/effect/app-node"
...
import { InstallationChannel } from "@coderrupee/core/installation/version"
  ...
  describe("latest", () => {
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(npmCalls).toContain(`https://registry.npmjs.org/coderrupee-ai/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(bunCalls).toContain(`https://registry.npmjs.org/coderrupee-ai/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      ...
      Effect.gen(function* () {
        ...
        expect(pnpmCalls).toContain(`https://registry.npmjs.org/coderrupee-ai/${InstallationChannel}`)
      }),
    )
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          ...
          if (cmd === "brew" && args.includes("--formula") && args.includes("nareinnprs-create/tap/coderrupee")) return ""
          if (cmd === "brew" && args.includes("--formula") && args.includes("coderrupee")) return "coderrupee"
          return ""
        },
      ),
    ...
    testEffect(
      testLayer(
        ...
        (cmd, args) => {
          if (cmd === "brew" && args.includes("nareinnprs-create/tap/coderrupee") && args.includes("--formula")) return "coderrupee"
