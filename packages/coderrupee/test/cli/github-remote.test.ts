...
test("parses https URL with .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/coderrupee.git")).toEqual({ owner: "sst", repo: "coderrupee" })
})

test("parses https URL without .git suffix", () => {
  expect(parseGitHubRemote("https://github.com/sst/coderrupee")).toEqual({ owner: "sst", repo: "coderrupee" })
})

test("parses git@ URL with .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/coderrupee.git")).toEqual({ owner: "sst", repo: "coderrupee" })
})

test("parses git@ URL without .git suffix", () => {
  expect(parseGitHubRemote("git@github.com:sst/coderrupee")).toEqual({ owner: "sst", repo: "coderrupee" })
})

test("parses ssh:// URL with .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/coderrupee.git")).toEqual({ owner: "sst", repo: "coderrupee" })
})

test("parses ssh:// URL without .git suffix", () => {
  expect(parseGitHubRemote("ssh://git@github.com/sst/coderrupee")).toEqual({ owner: "sst", repo: "coderrupee" })
})
