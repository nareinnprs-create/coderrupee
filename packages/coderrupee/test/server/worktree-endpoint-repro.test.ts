...
const stateLayer = Layer.effectDiscard(
  Effect.gen(function* () {
    const original = {
      CODERRUPEE_EXPERIMENTAL_WORKSPACES: Flag.CODERRUPEE_EXPERIMENTAL_WORKSPACES,
    }
    ...
    yield* Effect.addFinalizer(() =>
      Effect.promise(async () => {
        Flag.CODERRUPEE_EXPERIMENTAL_WORKSPACES = original.CODERRUPEE_EXPERIMENTAL_WORKSPACES
        await resetDatabase()
      }),
    )
  }),
