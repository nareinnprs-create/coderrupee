...
describe("ProxyUtil", () => {
  ...
  describe("headers", () => {
    ...
    test("strips coderrupee-specific headers", () => {
      const req = new Request("http://localhost", {
        headers: {
          "x-coderrupee-directory": "/home/user/project",
      ...
      const result = ProxyUtil.headers(req)
      expect(result.get("x-coderrupee-directory")).toBeNull()
      expect(result.get("x-coderrupee-workspace")).toBeNull()
