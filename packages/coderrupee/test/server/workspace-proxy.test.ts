...
describe("HttpApi workspace proxy", () => {
  ...
  it.live("strips coderrupee-internal headers and merges extra headers", () =>
    Effect.gen(function* () {
      ...
      expect(forwarded["x-coderrupee-directory"]).toBeUndefined()
      expect(forwarded["x-coderrupee-workspace"]).toBeUndefined()
