...
Practical reference for the current tool-migration state in `packages/coderrupee`.
...
Tool tests should use the existing Effect helpers in `packages/coderrupee/test/lib/effect.ts`:
