...
test("renders links with application attributes", async () => {
  expect(await parser.parse("[CoderRupee](https://coderrupee.ai)")).toBe(
    '<p><a href="https://coderrupee.ai" class="external-link" target="_blank" rel="noopener noreferrer">CoderRupee</a></p>\n',
  )
})
