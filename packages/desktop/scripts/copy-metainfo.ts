...
const appId = channel === "prod" ? "ai.coderrupee.desktop" : `ai.coderrupee.desktop.${channel}`
const productName = channel === "prod" ? "CoderRupee" : `CoderRupee ${channel.charAt(0).toUpperCase() + channel.slice(1)}`
...
<component type="desktop-application">
  ...
  <description>
    <p>
      CoderRupee is an open source agent that helps you write and run code with any AI model.
    </p>
  </description>
