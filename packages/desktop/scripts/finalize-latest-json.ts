...
const releaseId = process.env.CODERRUPEE_RELEASE
if (!releaseId) throw new Error("CODERRUPEE_RELEASE is required")

const version = process.env.CODERRUPEE_VERSION
if (!version) throw new Error("CODERRUPEE_VERSION is required")
...
const macxTarGz = "coderrupee-desktop-mac-x64.app.tar.gz"
const macaTarGz = "coderrupee-desktop-mac-arm64.app.tar.gz"
