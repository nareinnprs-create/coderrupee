...
const desktopStateNames = ["ai.coderrupee.desktop.dev", "ai.coderrupee.desktop.beta", "ai.coderrupee.desktop"]
...
function executableName() {
  return process.platform === "win32" ? "coderrupee-cli.exe" : "coderrupee-cli"
}
