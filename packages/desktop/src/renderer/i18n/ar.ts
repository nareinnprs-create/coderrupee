export const dict = {
  ...
  "desktop.updater.none.message": "أنت تستخدم بالفعل أحدث إصدار من CoderRupee",
  ...
  "desktop.updater.downloaded.prompt":
    "تم تنزيل الإصدار {{version}} من CoderRupee. هل ترغب في تثبيته وإعادة تشغيل التطبيق؟",
