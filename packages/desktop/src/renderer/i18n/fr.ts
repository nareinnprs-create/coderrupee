export const dict = {
  ...
  "desktop.updater.none.message": "Vous utilisez déjà la dernière version d'CoderRupee",
  ...
  "desktop.updater.downloaded.prompt":
    "La version {{version}} d'CoderRupee a été téléchargée. Voulez-vous l'installer et relancer l'application ?",
  ...
  "desktop.cli.installed.message":
    "Interface en ligne de commande installée dans {{path}}\n\nRedémarrez votre terminal pour utiliser la commande 'coderrupee'.",
