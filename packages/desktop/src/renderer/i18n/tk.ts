export const dict = {
  ...
  "desktop.updater.none.message": "CoderRupee-iň iň soňky wersiýasyny eýýäm ulanýarsyňyz",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee-iň {{version}} wersiýasy göçürildi, ony gurup täzeden işletmek isleýärsiňizmi?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} salgysyna guruldy\n\n'coderrupee' buýrugyny ulanmak üçin terminalyňyzy täzeden açyň.",
