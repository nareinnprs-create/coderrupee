export const dict = {
  ...
  "desktop.updater.none.message": "Anda sudah menggunakan versi terbaru CoderRupee",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee versi {{version}} telah diunduh. Apakah Anda ingin menginstalnya dan menjalankan ulang aplikasi?",
  ...
  "desktop.cli.installed.message":
    "CLI terinstal di {{path}}\n\nMulai ulang terminal Anda untuk menggunakan perintah 'coderrupee'.",
