export const dict = {
  ...
  "desktop.updater.none.message": "Käytät jo CoderRupeen uusinta versiota",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupeen versio {{version}} on ladattu. Haluatko asentaa sen ja käynnistää CoderRupeen uudelleen?",
  ...
  "desktop.cli.installed.message":
    "CLI on asennettu polkuun {{path}}\n\nKäynnistä terminaali uudelleen, jotta voit käyttää 'coderrupee'-komentoa.",
