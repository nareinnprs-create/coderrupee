export const dict = {
  ...
  "desktop.updater.none.message": "Դուք արդեն օգտագործում եք CoderRupee-ի վերջին տարբերակը",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee-ի {{version}} տարբերակը ներբեռնվել է: Ցանկանու՞մ եք տեղադրել այն և վերագործարկել:",
  ...
  "desktop.cli.installed.message":
    "CLI-ն տեղադրված է {{path}}-ում\n\nՎերագործարկեք ձեր տերմինալը՝ «coderrupee» հրամանն օգտագործելու համար:",
