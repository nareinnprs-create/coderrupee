export const dict = {
  ...
  "desktop.updater.none.message": "이미 최신 버전의 CoderRupee를 사용하고 있습니다",
  ...
  "desktop.updater.downloaded.prompt": "CoderRupee {{version}} 버전을 다운로드했습니다. 설치하고 다시 실행할까요?",
  ...
  "desktop.cli.installed.message":
    "CLI가 {{path}}에 설치되었습니다\n\n터미널을 다시 시작하여 'coderrupee' 명령을 사용하세요.",
