export const dict = {
  ...
  "desktop.updater.none.message": "Je gebruikt al de nieuwste versie van CoderRupee",
  ...
  "desktop.updater.downloaded.prompt":
    "Versie {{version}} van CoderRupee is gedownload. Wil je deze installeren en CoderRupee opnieuw starten?",
  ...
  "desktop.cli.installed.message":
    "CLI geïnstalleerd op {{path}}\n\nStart je terminal opnieuw om de opdracht 'coderrupee' te gebruiken.",
