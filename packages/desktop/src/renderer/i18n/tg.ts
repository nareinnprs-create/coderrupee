export const dict = {
  ...
  "desktop.updater.none.message": "Шумо аллакай версияи охирини CoderRupee-ро истифода мебаред",
  ...
  "desktop.updater.downloaded.prompt":
    "Версияи {{version}} аз CoderRupee зеркашӣ карда шуд, оё шумо мехоҳед онро насб кунед ва аз нав оғоз кунед?",
  ...
  "desktop.cli.installed.message":
    "CLI ба {{path}} насб карда шудааст\n\nБарои истифодаи фармони 'coderrupee' терминали худро аз нав оғоз кунед.",
