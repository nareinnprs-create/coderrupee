export const dict = {
  ...
  "desktop.updater.none.message": "Siz allaqachon CoderRupee ning oxirgi versiyasidan foydalanyapsiz",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupeening {{version}} versiyasi yuklab olindi, uni oʻrnatib, qayta ishga tushirmoqchimisiz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} manziliga o'rnatildi\n\n'coderrupee' buyrug'ini ishlatish uchun terminalni qayta ishga tushiring.",
