export const dict = {
  ...
  "desktop.updater.none.message": "Ви вже використовуєте найновішу версію CoderRupee",
  ...
  "desktop.updater.downloaded.prompt":
    "Версію {{version}} CoderRupee завантажено. Бажаєте встановити її та перезапустити?",
  ...
  "desktop.cli.installed.message":
    "CLI встановлено за шляхом {{path}}\n\nПерезапустіть термінал, щоб використовувати команду 'coderrupee'.",
