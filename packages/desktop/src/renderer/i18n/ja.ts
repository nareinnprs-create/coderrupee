export const dict = {
  ...
  "desktop.updater.none.message": "すでに最新バージョンの CoderRupee を使用しています",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee のバージョン {{version}} がダウンロードされました。インストールして再起動しますか？",
  ...
  "desktop.cli.installed.message":
    "CLI を {{path}} にインストールしました\n\nターミナルを再起動して 'coderrupee' コマンドを使用してください。",
