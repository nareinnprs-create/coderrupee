export const dict = {
  ...
  "desktop.updater.none.message": "თქვენ უკვე იყენებთ CoderRupee-ის უახლეს ვერსიას",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee-ის {{version}} ვერსია ჩამოტვირთულია, გსურთ მისი ინსტალაცია და ხელახლა გაშვება?",
  ...
  "desktop.cli.installed.message":
    "CLI დაინსტალირებულია {{path}}-ზე\n\nგადატვირთეთ ტერმინალი „coderrupee“ ბრძანების გამოსაყენებლად.",
