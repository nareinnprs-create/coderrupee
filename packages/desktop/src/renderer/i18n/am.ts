export const dict = {
  ...
  "desktop.updater.none.message": "አሁን የቅርብ ጊዜውን የCoderRupee ስሪት እየተጠቀሙ ነው",
  ...
  "desktop.updater.downloaded.prompt": "ስሪት {{version}} ከCoderRupee ወርዷል፣ መጫን እና እንደገና ማስጀመር ይፈልጋሉ?",
