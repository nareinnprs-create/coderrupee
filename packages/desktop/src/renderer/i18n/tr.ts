export const dict = {
  ...
  "desktop.updater.none.message": "CoderRupee'un en son sürümünü zaten kullanıyorsunuz",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee'un {{version}} sürümü indirildi. Şimdi yükleyip yeniden başlatmak ister misiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} konumuna yüklendi\n\n'coderrupee' komutunu kullanmak için terminalinizi yeniden başlatın.",
