export const dict = {
  ...
  "desktop.updater.none.message": "Artıq CoderRupee-un ən son versiyasından istifadə edirsiniz",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee-un {{version}} versiyası yüklənib. Onu quraşdırıb tətbiqi yenidən başlatmaq istəyirsiniz?",
  ...
  "desktop.cli.installed.message":
    "CLI {{path}} ünvanına quraşdırıldı\n\n'coderrupee' əmrindən istifadə etmək üçün terminalı yenidən başladın.",
