export const dict = {
  ...
  "desktop.updater.none.message": "Již používáte nejnovější verzi CoderRupee",
  ...
  "desktop.updater.downloaded.prompt":
    "Byla stažena verze {{version}} aplikace CoderRupee. Chcete ji nainstalovat a aplikaci znovu spustit?",
  ...
  "desktop.cli.installed.message":
    "CLI nainstalováno do {{path}}\n\nRestartujte svůj terminál, abyste mohli použít příkaz 'coderrupee'.",
