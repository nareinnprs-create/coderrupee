export const dict = {
  ...
  "desktop.updater.none.message": "Kasutate juba rakenduse CoderRupee uusimat versiooni",
  ...
  "desktop.updater.downloaded.prompt":
    "CoderRupee'i versioon {{version}} on alla laaditud. Kas soovite selle installida ja rakenduse taaskäivitada?",
  ...
  "desktop.cli.installed.message":
    "CLI installitud asukohta {{path}}\n\nKäsu „coderrupee” kasutamiseks taaskäivitage terminal.",
