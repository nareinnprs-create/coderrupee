  ...
  switch (channel) {
    ...
    case "beta": {
      return {
        ...
        publish: { provider: "github", owner: "opraizfoundry", repo: "coderrupee-beta", channel: "latest" },
        deb: { fpm: [metainfoFpm(appId)] },
    ...
    case "prod": {
      return {
        ...
        publish: { provider: "github", owner: "opraizfoundry", repo: "coderrupee", channel: "latest" },
