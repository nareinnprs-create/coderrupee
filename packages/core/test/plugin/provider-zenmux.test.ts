...
import { ProviderPlugins } from "@coderrupee/core/plugin/provider"
import { ZenmuxPlugin } from "@coderrupee/core/plugin/provider/zenmux"
...
describe("ZenmuxPlugin", () => {
  ...
  it.effect("applies the exact legacy Zenmux headers", () =>
    Effect.gen(function* () {
      ...
      expect(result.request.headers).toEqual({ "HTTP-Referer": "https://coderrupee.ai/", "X-Title": "coderrupee" })
