...
import { GoogleVertexPlugin } from "@coderrupee/core/plugin/provider/google-vertex"
      ...
      yield* catalog.transform((catalog) =>
        catalog.provider.update(ProviderV2.ID.coderrupee, (provider) => {
          provider.api = {
            ...
            url: "https://coderrupee.ai/zen/v1",
          }
        }),
      )
      yield* addPlugin()

      const provider = required(yield* catalog.provider.get(ProviderV2.ID.coderrupee))
