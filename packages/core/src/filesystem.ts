...
import { Entry, FileSystem, FindInput, Match } from "@coderrupee/schema/filesystem"
export { Entry, Match, Submatch } from "@coderrupee/schema/filesystem"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/v2/FileSystem") {}
