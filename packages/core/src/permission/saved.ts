...
import { PermissionSaved } from "@coderrupee/schema/permission-saved"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/v2/PermissionSaved") {}
