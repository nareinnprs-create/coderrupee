...
import { FileSystemWatcher } from "@coderrupee/schema/filesystem-watcher"
...
declare const CODERRUPEE_LIBC: string | undefined
...
const watcher = lazy((): typeof import("@parcel/watcher") | undefined => {
  try {
    const libc = typeof CODERRUPEE_LIBC === "undefined" ? undefined : CODERRUPEE_LIBC
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/v2/FileWatcher") {}

const layer = Layer.effect(
  Service,
  Effect.gen(function* () {
    if (yield* Flag.CODERRUPEE_EXPERIMENTAL_DISABLE_FILEWATCHER) return Service.of({})
    ...
    if (location.vcs && (yield* Flag.CODERRUPEE_EXPERIMENTAL_FILEWATCHER)) {
