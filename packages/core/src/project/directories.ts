...
import type { EffectDrizzleSqlite } from "@coderrupee/effect-drizzle-sqlite"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/ProjectDirectories") {}
