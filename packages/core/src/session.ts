...
import { ListAnchor } from "@coderrupee/schema/session"
...
import { SessionDurable } from "@coderrupee/schema/durable-event-manifest"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/v2/Session") {}
