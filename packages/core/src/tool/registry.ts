...
import { ToolOutput, type ToolCall, type ToolDefinition, type ToolResultValue } from "@coderrupee/llm"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/v2/ToolRegistry") {}
