...
import type { Data, Definition, Payload } from "@coderrupee/schema/event"
...
import { Durable } from "@coderrupee/schema/durable-event-manifest"

export const ID = Event.ID
export type ID = import("@coderrupee/schema/event").ID
export type { Data, Definition, Payload } from "@coderrupee/schema/event"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/Event") {}
