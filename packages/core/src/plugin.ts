...
import type { Plugin as PluginRuntime } from "@coderrupee/plugin/v2/effect"
...
export class Service extends Context.Service<Service, Interface>()("@coderrupee/v2/Plugin") {}
