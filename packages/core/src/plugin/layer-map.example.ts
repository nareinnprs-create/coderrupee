...
export class RequestContextRef extends Context.Service<RequestContextRef, RequestContext>()(
  "@coderrupee/example/RequestContextRef",
) {}
...
export class ConfigService extends Context.Service<ConfigService, ConfigServiceShape>()(
  "@coderrupee/example/ConfigService",
) {}
...
export class ConfigServiceMap extends LayerMap.Service<ConfigServiceMap>()("@coderrupee/example/ConfigServiceMap", {
