...
- Effect plugins import `@coderrupee/plugin/v2/effect`, not `@coderrupee/core`.
- Public domain values use generated `@coderrupee/sdk` types.
...
- Define `PluginHost` domain capabilities in `@coderrupee/plugin/v2/effect`.
