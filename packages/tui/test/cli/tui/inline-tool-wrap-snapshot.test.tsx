...
const tools: readonly ToolFixture[] = [
  {
    icon: "✱",
    label:
      'Grep "OPENCODE.*DB|database|sqlite|drizzle|dev.*db|data.*dir|xdg|APPDATA" in packages/coderrupee/src (151 matches)',
  },
  {
    icon: "✱",
    label: 'Glob "**/*db*" in packages/coderrupee (6 matches)',
  },
  {
    icon: "→",
    label: "Read packages/coderrupee/src/storage/db.ts [offset=1, limit=130]",
  },
  {
    icon: "→",
    label: "Read packages/coderrupee/src/index.ts [offset=1, limit=100]",
    error: "No LSP server available for this file type.",
  },
  {
    icon: "✱",
    label:
      'Grep "export const CODERRUPEE_DB|CODERRUPEE_DB|CODERRUPEE_DEV|Global\\.Path\\.data|data =" in packages/coderrupee/src (115 matches)',
  },
] as const
