...
Generates UPCOMING_CHANGELOG.md by running the coderrupee changelog command.

Options:
  -f, --from <version>   Starting version (default: latest non-draft GitHub release)
  -t, --to <ref>         Ending ref (default: HEAD)
      --variant <name>   Thinking variant for coderrupee run (default: low)
      --quiet            Suppress coderrupee command output unless it fails
