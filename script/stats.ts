...
async function fetchReleases(): Promise<Release[]> {
  ...
  while (true) {
    const url = `https://api.github.com/repos/nareinnprs-create/coderrupee/releases?page=${page}&per_page=${per}`
...
console.log("Fetching GitHub releases for nareinnprs-create/coderrupee...\n")
...
console.log("Fetching npm all-time downloads for coderrupee-ai...\n")
const npmDownloads = await fetchNpmDownloads("coderrupee-ai")
